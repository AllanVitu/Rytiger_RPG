import{g as f,C as W,P as ft,s as je,m as He,a as Ne,b as Ge,x as qe}from"./game-engine-p5c4dfXO.js";import{C as L,Z as j,e as Ve,F as se,f as K,c as lt,I as _,h as H,i as Xe,j as Ye,R as We}from"./game-data-BOrsUA7a.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const s of n.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function e(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(r){if(r.ep)return;r.ep=!0;const n=e(r);fetch(r.href,n)}})();class Ze{constructor(){this.routes={},this.currentRoute=null,this.params={},window.addEventListener("hashchange",()=>this.handleRoute())}on(t,e){return this.routes[t]=e,this}navigate(t,e={}){this.params=e,window.location.hash=t}handleRoute(){const t=window.location.hash.slice(1)||"home",e=t.split("?")[0],i=t.split("?")[1];i&&i.split("&").forEach(r=>{const[n,s]=r.split("=");this.params[n]=decodeURIComponent(s)}),this.routes[e]?(this.currentRoute=e,this.routes[e](this.params),this.params={}):this.routes.home&&(this.currentRoute="home",this.routes.home({}))}start(){this.handleRoute()}}const w=new Ze;function J(a){const t={guerrier:"./assets/characters/guerrier.png",mage:"./assets/characters/mage.png",arche:"./assets/characters/arche.png",assassin:"./assets/characters/assassin.png"};return t[a]||t.guerrier}const le={};function C(a,t=null,e="rare"){return t&&le[t]?le[t]:J(a)}function Qt(a=!1){return a?new URL("data:image/png;base64,",import.meta.url).href:"./assets/characters/boss.png"}function Kt(){return"./assets/characters/minion.png"}function Qe(a){return Promise.all(a.map(t=>new Promise(e=>{const i=new Image;i.src=t,i.onload=e,i.onerror=e})))}function Ke(){return[J("guerrier"),J("mage"),J("arche"),J("assassin"),Qt(),Kt()]}function Je(){const a=document.getElementById("app"),t=L.filter(e=>e.starter);a.innerHTML=`
  ...
  `,t.forEach(e=>{document.getElementById(`starter-${e.id}`).addEventListener("click",async()=>{await f.chooseStarter(e.id),f.addArchireve(500),we()})})}function we(){const a=f.state,t=document.getElementById("app");if(a.profile||(f.state.profile={pseudo:"Forgeron",avatar:"https://api.dicebear.com/7.x/pixel-art/svg?seed=local_hero",region:"Offline",level:1,xp:0},f.save()),!a.starterChosen){Je();return}const e=f.getTeamInstances(),i=a.totalBattles>0?Math.round(a.totalWins/a.totalBattles*100):0,r=(a.ownedCharacters||[]).some(p=>p.isNew),n=(a.inventory||[]).some(p=>p.isNew),s=f.canFuseAny(),d=["enchantement","osiris","supplice","maragorh","imotep"],o={enchantement:"Enchantement",osiris:"Osiris",supplice:"Supplice",maragorh:"Maragorh",imotep:"Imotep"};let l=d[0],c=0;for(const p of d){let g=0;for(let u=0;u<20;u++)f.getLevelFlames(p,u)>0&&g++;const m=Math.round(g/20*100);m>c&&(c=m,l=p)}t.innerHTML=`
    <div style="width:100vw;height:100vh;background:#06050a;display:flex;flex-direction:column;overflow:hidden;position:relative">
      ...
      ">
        ...
        <div style="display:flex;align-items:center;gap:14px;cursor:pointer" id="btn-profile">
          ...
          ">${(a.profile.pseudo||"R").charAt(0).toUpperCase()}</div>
          <div>
      ...
      <div style="flex:1;display:grid;grid-template-columns:290px 1fr 310px;gap:0;overflow:hidden;z-index:2">
        ...
        ">
          ...
          <div style="display:flex;flex-direction:column;gap:5px;margin-bottom:28px">
            ...
            ">
              ...
              SUCCÈS
              ${(()=>{const p=f.state.achievements||{},g=f.ACHIEVEMENTS?.length||12;return`<div style="position:absolute;right:10px;font-family:var(--font-stat);font-size:8px;color:var(--epique);background:rgba(163,53,238,0.1);padding:2px 6px;border-radius:2px;border:1px solid rgba(163,53,238,0.2)">${Object.keys(p).length}/${g}</div>`})()}
            </button>
          </div>
          ...
          <div style="display:flex;flex-direction:column;gap:10px">
            ${d.map(p=>{let g=0;for(let v=0;v<20;v++)f.getLevelFlames(p,v)>0&&g++;const m=Math.round(g/20*100),u=m===100;return`
                <div>
                  <div style="display:flex;justify-content:space-between;margin-bottom:4px">
                    ...
                    <span style="font-family:var(--font-stat);font-size:9px;color:var(--text-muted)">${g}/20</span>
                  </div>
        ...
        <div style="display:flex;flex-direction:column;align-items:center;justify-content:center;padding:40px 36px;position:relative;overflow:hidden">
          ...
          <div style="display:grid;grid-template-columns:repeat(4,175px);gap:16px;z-index:1;margin-bottom:36px">
            ${[0,1,2,3].map(p=>{const g=e[p];if(g){const m=`var(--${g.rarity||"rare"})`;return`
                  <div style="
                  ...
                  ">
                    ...
                    <img src="${C((g.type||"").split("/")[0])}" class="sprite sprite--xl sprite--animate" alt="${g.name}" style="margin:0 auto 10px;display:block">
                    
                    <div style="font-family:var(--font-title);font-size:10px;color:${m};font-weight:700;letter-spacing:0.5px;margin-bottom:3px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:170px" title="${g.name}">${g.name}</div>
                    <div style="font-family:var(--font-stat);font-size:9px;color:var(--text-muted);letter-spacing:2px;margin-bottom:9px">${(g.type||"").toUpperCase()} · NIV.${g.level}</div>
                    ...
                    <div style="font-family:var(--font-stat);font-size:8px;color:var(--text-muted);margin-top:4px">${g.maxHp}/${g.maxHp} HP</div>
                  </div>
                `}return`
                <div style="
          ...
          ">
            ${[{val:a.totalBattles,label:"COMBATS",color:"var(--text-bright)"},{val:a.totalWins,label:"VICTOIRES",color:"var(--peucommun)"},{val:i+"%",label:"TAUX",color:"var(--accent-light)"},{val:a.ownedCharacters.length,label:"HÉROS",color:"var(--rare-light)"}].map((p,g)=>`
              <div style="flex:1;text-align:center;padding:14px 8px;position:relative">
                ${g>0?'<div style="position:absolute;left:0;top:20%;bottom:20%;width:1px;background:rgba(200,150,60,0.08)"></div>':""}
        ...
        ">
          ...
          <div id="daily-missions-panel" style="display:flex;flex-direction:column;gap:8px;margin-bottom:28px">
            ${(()=>{const p=f.getDailyMissions(),g=p.every(m=>m.done);return p.map(m=>{const u=Math.min(100,Math.round(m.progress/m.target*100));return`
                  <div style="
                    padding:12px 14px;
          ...
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:32px">
            ${[{label:"RARE",count:a.ownedCharacters.filter(p=>L.find(m=>m.id===p.id)?.rarity==="rare").length,color:"var(--rare)"},{label:"EPIQUE",count:a.ownedCharacters.filter(p=>L.find(m=>m.id===p.id)?.rarity==="epique").length,color:"var(--epique)"},{label:"LEGEND.",count:a.ownedCharacters.filter(p=>L.find(m=>m.id===p.id)?.rarity==="legendaire").length,color:"var(--legendaire)"},{label:"ULTIMATE",count:a.ownedCharacters.filter(p=>L.find(m=>m.id===p.id)?.rarity==="ultimate").length,color:"var(--ultimate)"}].map(p=>`
              <div style="
  ...
  `,ti(),ei(),ii(),document.getElementById("btn-profile")?.addEventListener("click",()=>w.navigate("profile")),document.getElementById("btn-campaign")?.addEventListener("click",()=>w.navigate("campaign")),document.getElementById("btn-dungeon")?.addEventListener("click",()=>w.navigate("dungeon")),document.getElementById("btn-invocation")?.addEventListener("click",()=>w.navigate("invocation")),document.getElementById("btn-forge")?.addEventListener("click",()=>w.navigate("forge")),document.getElementById("btn-achievements")?.addEventListener("click",()=>w.navigate("achievements")),document.getElementById("btn-dashboard")?.addEventListener("click",()=>w.navigate("dashboard")),document.getElementById("btn-team")?.addEventListener("click",()=>{f.state.ownedCharacters&&(f.state.ownedCharacters.forEach(p=>delete p.isNew),f.save()),w.navigate("team")}),document.getElementById("btn-inventory")?.addEventListener("click",()=>{f.state.inventory&&(f.state.inventory.forEach(p=>delete p.isNew),f.save()),w.navigate("inventory")}),document.getElementById("btn-dashboard")?.addEventListener("click",()=>w.navigate("dashboard")),document.getElementById("btn-quick-play")?.addEventListener("click",()=>w.navigate("campaign"))}function ti(){const a=document.getElementById("ember-particles");if(!a)return;let t="";for(let e=0;e<65;e++){const i=Math.random()*100,r=Math.random()*12,n=5+Math.random()*12,s=1+Math.random()*2.5,d=.12+Math.random()*.35,o=(Math.random()-.5)*80,l=["rgba(255,107,157,0.8)","rgba(255,141,182,0.6)","rgba(192,132,252,0.5)","rgba(252,211,77,0.4)","rgba(255,182,193,0.5)"],c=l[Math.floor(Math.random()*l.length)];t+=`<div style="
    ...
    "></div>`}a.innerHTML=t}function ei(){const a=document.getElementById("floating-runes");if(!a)return;const t=["花","月","雷","火","風","光","水","雪","星","龍","剣","神"];let e="";for(let i=0;i<12;i++){const r=5+Math.random()*90,n=5+Math.random()*90,s=14+Math.random()*18,d=Math.random()*20,o=15+Math.random()*15;e+=`<div class="floating-rune" style="
      left:${r}%;top:${n}%;font-size:${s}px;
      animation-duration:${o}s;
      animation-delay:${d}s;
    ">${t[i]}</div>`}a.innerHTML=e}function ii(){const a=document.getElementById("title-sparkles");if(!a)return;let t=setInterval(()=>{if(!document.getElementById("title-sparkles")){clearInterval(t);return}const e=document.createElement("div"),i=Math.random()*100,r=Math.random()*100,n=1+Math.random()*2,s=.8+Math.random()*.5,d=["#ff6b9d","#ff8db6","#c084fc","#fcd34d"],o=d[Math.floor(Math.random()*d.length)];e.style.cssText=`
      ...
      pointer-events:none;
    `,a.appendChild(e),setTimeout(()=>e.remove(),s*1e3+50)},300)}const $e={enchantement:"#C89B3C",osiris:"#E85D20",supplice:"#4A7C59",maragorh:"#c084fc",imotep:"#DC2626",abysses:"#22D3EE",citadelle:"#A78BFA",terre_desolee:"#EF4444",nexus:"#F5D060",preludes:"#FDE68A",bifrost:"#818CF8",domaine:"#FBBF24"};let _t=0;function ke(){const a=document.getElementById("app");a.innerHTML=`
    <div style="width:100vw;height:100vh;background:#0D0A08;display:flex;flex-direction:column;overflow:hidden;position:relative">
      ...
      ">
        ...
        ">
          ...
          <span style="font-family:var(--font-stat);font-size:13px;font-weight:700;color:var(--text-bright)">${f.state.archireve.toLocaleString()}</span>
        </div>
      </div>
      ...
      <div style="flex:1;display:flex;overflow:hidden;z-index:2">
        ...
        ">
          ...
          <div style="display:flex;flex-direction:column;gap:2px;padding:0 8px 20px">
            ${j.map((t,e)=>{const i=f.isLevelUnlocked(t.id,0),r=t.levels||20,n=Object.keys(f.state.campaignProgress[t.id]||{}).length,s=Math.round(n/r*100),d=$e[t.id]||"#C89B3C",o=e===_t,l=e===0,c=t.tier===2&&(e===0||j[e-1]?.tier!==2),p=t.tier===3&&(e===0||j[e-1]?.tier!==3);return`
  ...
  `,document.getElementById("back-btn").addEventListener("click",()=>w.navigate("home")),document.querySelectorAll(".zone-list-btn").forEach(t=>{t.addEventListener("click",()=>{const e=parseInt(t.dataset.zoneIdx),i=j[e];!i||!f.isLevelUnlocked(i.id,0)||(_t=e,ke())})}),document.querySelectorAll(".level-tile-btn").forEach(t=>{t.addEventListener("click",()=>{const e=t.dataset.zone,i=parseInt(t.dataset.level);w.navigate("vs",{zone:e,level:i})})})}function ai(a){const t=j[a];if(!t)return'<div style="flex:1;display:flex;align-items:center;justify-content:center;color:var(--text-muted)">Selectionnez une zone</div>';f.isLevelUnlocked(t.id,0);const e=t.levels||20,i=Object.keys(f.state.campaignProgress[t.id]||{}).length,r=f.getZoneStars(t.id),n=e*3,s=Math.round(i/e*100),d=$e[t.id]||"#C89B3C",o=e>50?10:e>20?6:5;return`
    <!-- Zone Header with BG -->
    <div style="
    ...
    <div style="flex:1;overflow-y:auto;padding:24px 32px">
      ...
      <div style="display:grid;grid-template-columns:repeat(${o},1fr);gap:10px;max-width:${o===10?"900px":o===6?"800px":"700px"}">
        ${Array.from({length:e},(l,c)=>{const p=c===e-1,g=f.getLevelFlames(t.id,c),m=f.isLevelUnlocked(t.id,c),u=g>0,v=Array.from({length:3},(E,Y)=>'<span style="font-size:10px;color:'+(Y<g?d:"rgba(200,155,60,0.15)")+'">&#9670;</span>').join("");if(!m)return'<div style="padding:14px 8px;text-align:center;background:rgba(10,6,3,0.6);border:1px solid rgba(200,155,60,0.04);border-radius:6px;opacity:0.25"><div style="font-family:var(--font-stat);font-size:16px;color:var(--text-muted);margin-bottom:4px">&#9618;</div><div style="font-size:9px;color:var(--text-muted);letter-spacing:1px">VERR.</div></div>';const h=p?"linear-gradient(135deg,rgba(127,29,29,0.3),rgba(13,10,8,0.8))":u?"rgba(15,10,5,0.8)":"rgba(10,6,3,0.6)",x=p?"rgba(220,38,38,0.3)":u?d+"25":"rgba(200,155,60,0.06)",A=p?"var(--font-title)":"var(--font-stat)",D=p?"12px":"16px",M=p?"var(--danger)":u?d:"var(--text-primary)",B=p?"2px":"0",z=p?"BOSS":c+1,b=p?t.boss.name.split(" ")[0]:"NIV."+(t.levelRange[0]+c);return'<button class="level-tile-btn" data-zone="'+t.id+'" data-level="'+c+'" style="padding:14px 8px;text-align:center;background:'+h+";border:1px solid "+x+';border-radius:6px;cursor:pointer;transition:all 0.15s ease;color:var(--text-primary)"><div style="font-family:'+A+";font-size:"+D+";font-weight:700;color:"+M+";margin-bottom:4px;letter-spacing:"+B+'">'+z+'</div><div style="font-family:var(--font-stat);font-size:9px;color:var(--text-muted);margin-bottom:6px;letter-spacing:1px">'+b+'</div><div style="display:flex;justify-content:center;gap:2px">'+v+"</div></button>"}).join("")}
      </div>
    </div>
  `}const F=50,mt=6e3,ri=5e3,ni=35,oi=8,si=.5,li=1.5;class di{constructor(t,e){this.playerTeam=t.map((i,r)=>({...i,stats:{...i.stats},currentHp:i.currentHp??i.stats.hp,maxHp:i.stats.hp,alive:!0,buffs:[],debuffs:[],atbGauge:Math.random()*20,atbMax:100,isPlayer:!0,isGuarding:!1,x:400,y:300+r*120})),this.enemyTeam=e.map((i,r)=>({...i,stats:{...i.stats},currentHp:i.currentHp??i.stats.hp??i.maxHp,maxHp:i.maxHp??i.stats.hp,alive:!0,buffs:i.buffs||[],debuffs:i.debuffs||[],atbGauge:Math.random()*15,atbMax:100,isPlayer:!1,weakness:i.weakness||"physique",breakGauge:i.breakGauge||0,breakMax:i.breakMax||100,isBroken:i.isBroken||!1,breakTimer:0,x:1300+(i.isBoss?0:r*30),y:300+r*120})),this.running=!1,this.paused=!1,this.gameOver=!1,this.winner=null,this.tickInterval=null,this.elapsedTime=0,this.turnCount=0,this.activeUnit=null,this.log=[],this.totalDmgDealt=0,this.onTick=null,this.onPlayerReady=null,this.onActionExecuted=null,this.onLog=null,this.onBreak=null,this.onGameOver=null}start(){this.running||(this.running=!0,this.paused=!1,this.addLog("⚔️ Le combat commence !"),this.tickInterval=setInterval(()=>this._tick(),F))}stop(){this.running=!1,this.tickInterval&&(clearInterval(this.tickInterval),this.tickInterval=null)}destroy(){this.stop(),this.onTick=null,this.onPlayerReady=null,this.onActionExecuted=null,this.onLog=null,this.onBreak=null,this.onGameOver=null}setSpeed(t){const e=Math.round(F/t);this.tickInterval&&(clearInterval(this.tickInterval),this.tickInterval=setInterval(()=>this._tick(),e))}_tick(){if(!this.running||this.gameOver||this.paused)return;this.elapsedTime+=F;for(const i of this.enemyTeam)i.isBroken&&i.alive&&(i.breakTimer-=F,i.breakTimer<=0&&(i.isBroken=!1,i.breakGauge=0,i.breakTimer=0));this.elapsedTime%1e3<F&&this._processStatusEffects();const t=[...this.playerTeam,...this.enemyTeam];for(const i of t){if(!i.alive||i.isBroken)continue;const n=i.stats.spd/50*F*100/mt;i.atbGauge=Math.min(i.atbMax,i.atbGauge+n)}const e=t.filter(i=>i.alive&&i.atbGauge>=i.atbMax).sort((i,r)=>r.stats.spd-i.stats.spd);if(e.length>0){const i=e[0];i.isPlayer?(this.paused=!0,this.activeUnit=i,this.onPlayerReady?.(i)):(this._executeEnemyAction(i),i.atbGauge=0)}this._checkWinCondition(),this.onTick?.({playerTeam:this.playerTeam,enemyTeam:this.enemyTeam,timeline:this.getTimeline(),elapsedTime:this.elapsedTime,activeUnit:this.activeUnit,paused:this.paused})}executePlayerAction(t,e){if(!this.paused||!this.activeUnit)return null;const i=this.activeUnit,r=i.skills[t];if(!r)return null;const n=this._resolveAction(i,r,e,!0),d=(r.recovery||2e3)/mt*100;return i.atbGauge=-d,i.isGuarding=!1,this.turnCount++,this.paused=!1,this.activeUnit=null,setTimeout(()=>this._checkWinCondition(),100),n}executeGuard(){if(!this.paused||!this.activeUnit)return;const t=this.activeUnit;t.isGuarding=!0,t.atbGauge=-20,this.addLog(`🛡️ ${t.name} se met en garde !`),this.onActionExecuted?.({actor:t,skill:{id:"guard",name:"Garde",icon:"🛡️",type:"guard"},targets:[],results:{guards:[t.id]},isPlayer:!0}),this.turnCount++,this.paused=!1,this.activeUnit=null}_executeEnemyAction(t){const e=t.skills||[{id:"attaque",name:"Attaque",type:"physical",power:80,accuracy:100,icon:"👊",recovery:1800}],i=this.playerTeam.filter(p=>p.alive);if(i.length===0)return;let r=null,n=null;const s=e.find(p=>p.type==="heal"),d=this.enemyTeam.filter(p=>p.alive),o=d.find(p=>p.currentHp/p.maxHp<.4);if(s&&o&&(r=s,n=[...d].sort((p,g)=>p.currentHp/p.maxHp-g.currentHp/g.maxHp)[0].id),!r){const p=e.find(g=>g.type==="buff");p&&(!t.buffs||t.buffs.length===0)&&this.turnCount<=6&&(r=p,n=t.id)}if(!r){const p=e.filter(g=>g.type==="physical"||g.type==="magical");if(t.isBoss){const g=p.find(u=>u.aoe),m=p.find(u=>!u.aoe);g&&i.length>=2&&this.turnCount%3===0?r=g:m?r=m:r=p[0]||e[0],n=[...i].sort((u,v)=>u.currentHp-v.currentHp)[0].id}else if(t.type==="assassin"){r=p.find(u=>u.critBonus||u.executeMult)||p[0]||e[0];const g=i.filter(u=>u.type==="mage"||u.type==="arche");n=[...g.length>0?g:i].sort((u,v)=>u.currentHp-v.currentHp)[0].id}else t.type==="mage"?(r=p.length>0?p[Math.floor(Math.random()*p.length)]:e[0],n=[...i].sort((g,m)=>g.stats.magDef-m.stats.magDef)[0].id):(r=p.length>0?p[Math.floor(Math.random()*p.length)]:e[0],n=[...i].sort((g,m)=>g.stats.def-m.stats.def)[0].id)}r||(r=e[0]),n||(n=i[0].id),this._resolveAction(t,r,n,!1);const c=(r.recovery||2e3)/mt*100;t.atbGauge=-c}_resolveAction(t,e,i,r){const n={hits:[],heals:[],buffs:[],misses:[]};if(Math.random()*100>(e.accuracy||100))return this.addLog(`${r?"🎯":"👹"} ${t.name} — RATÉ !`),n.misses.push(i),this.onActionExecuted?.({actor:t,skill:e,targets:[i],results:n,isPlayer:r}),n;if(e.type==="heal"){const d=this.findUnit(i);if(d&&d.alive){const o=Math.floor(e.power*(1+this._getEffectiveStat(t,"magAtk")/200));d.currentHp=Math.min(d.maxHp,d.currentHp+o),this.addLog(`💚 ${t.name} soigne ${d.name} (+${o} PV)`),n.heals.push({targetId:i,amount:o})}}else if(e.type==="buff"){const d=e.effect?.aoe?(r?this.playerTeam:this.enemyTeam).filter(o=>o.alive):[this.findUnit(i)].filter(Boolean);for(const o of d)e.effect?.type==="stealth"?(o.buffs.push({type:"stealth",turns:e.effect.turns}),this.addLog(`👤 ${t.name} se rend invisible !`)):e.effect&&(o.buffs.push({stat:e.effect.stat,boost:e.effect.boost,turns:e.effect.turns}),this.addLog(`✨ ${t.name} → ${e.name}`)),n.buffs.push({targetId:o.id})}else{const d=e.aoe?(r?this.enemyTeam:this.playerTeam).filter(o=>o.alive):[this.findUnit(i)].filter(Boolean);for(const o of d){if(!o||!o.alive)continue;const l=e.type==="magical"?this._getEffectiveStat(t,"magAtk"):this._getEffectiveStat(t,"atk");let c=e.type==="magical"?this._getEffectiveStat(o,"magDef"):this._getEffectiveStat(o,"def");e.ignoreDefPercent&&(c=Math.floor(c*(1-e.ignoreDefPercent)));let p=Math.floor(l*e.power/(c+50)*(.85+Math.random()*.3));const g=10+(t.type==="assassin"?15:0)+(e.critBonus||0),m=Math.random()*100<g;if(m&&(p=Math.floor(p*1.5)),e.executeMult&&o.currentHp/o.maxHp<.3&&(p=Math.floor(p*e.executeMult)),e.aoe&&(p=Math.floor(p*.7)),o.isBroken&&(p=Math.floor(p*li)),o.isGuarding&&(p=Math.floor(p*(1-si)),o.isGuarding=!1),p=Math.max(1,p),o.currentHp-=p,r&&(this.totalDmgDealt+=p),this.addLog(`${r?"⚔️":"👹"} ${t.name} → ${e.name} → ${o.name} : -${p}${m?" 💥CRIT!":""}${o.isBroken?" 🔥BREAK!":""}`),o.currentHp<=0&&(o.currentHp=0,o.alive=!1,this.addLog(`💀 ${o.name} vaincu !`)),e.effect?.type==="poison"&&o.alive&&(o.debuffs.push({type:"poison",damage:e.effect.damage,turns:e.effect.turns}),this.addLog(`☠️ ${o.name} empoisonné !`)),r&&o.alive&&!o.isBroken&&o.weakness){const v=e.element===o.weakness?ni:oi;o.breakGauge=Math.min(o.breakMax,(o.breakGauge||0)+v),o.breakGauge>=o.breakMax&&(o.isBroken=!0,o.breakTimer=ri,o.atbGauge=-60,this.addLog(`💥 ${o.name} est BRISÉ ! (+50% dégâts)`),this.onBreak?.(o))}n.hits.push({targetId:o.id,damage:p,isCrit:m,isBreakHit:o.isBroken})}}return this.onActionExecuted?.({actor:t,skill:e,targets:n.hits.map(d=>d.targetId),results:n,isPlayer:r}),n}getTimeline(){const t=[...this.playerTeam,...this.enemyTeam].filter(i=>i.alive),e=[];for(const i of t){const r=i.atbMax-i.atbGauge,s=i.stats.spd/50*F*100/mt,o=(r>0?Math.ceil(r/s):0)*F;e.push({id:i.id,name:i.name,type:i.type,isPlayer:i.isPlayer,isBoss:i.isBoss,atbPct:Math.max(0,Math.min(100,i.atbGauge/i.atbMax*100)),msToReady:o,isReady:i.atbGauge>=i.atbMax,isBroken:i.isBroken,rarity:i.rarity})}return e.sort((i,r)=>i.msToReady-r.msToReady),e}findUnit(t){return this.playerTeam.find(e=>e.id===t)||this.enemyTeam.find(e=>e.id===t)}_getEffectiveStat(t,e){let i=t.stats[e];for(const r of t.buffs||[])r.stat===e&&(i=Math.floor(i*(1+r.boost)));return i}_processStatusEffects(){const t=[...this.playerTeam,...this.enemyTeam];for(const e of t)e.alive&&(e.debuffs=(e.debuffs||[]).filter(i=>(i.type==="poison"&&(e.currentHp-=i.damage,e.currentHp<=0&&(e.currentHp=0,e.alive=!1,this.addLog(`💀 ${e.name} succombe au poison !`))),i.turns--,i.turns>0)),e.buffs=(e.buffs||[]).filter(i=>(i.turns--,i.turns>0)))}_checkWinCondition(){const t=this.playerTeam.filter(i=>i.alive).length,e=this.enemyTeam.filter(i=>i.alive).length;t===0&&!this.gameOver&&(this.gameOver=!0,this.winner="enemy",this.addLog("💀 Défaite... Votre équipe a été vaincue."),this.stop(),this.onGameOver?.("enemy")),e===0&&!this.gameOver&&(this.gameOver=!0,this.winner="player",this.addLog("🏆 Victoire ! Les ennemis sont vaincus !"),this.stop(),this.onGameOver?.("player"))}addLog(t){this.log.push({message:t,time:this.elapsedTime}),this.onLog?.(t)}getSummary(){return{won:this.winner==="player",turnsPlayed:this.turnCount,playerTeamState:this.playerTeam,enemyTeamState:this.enemyTeam,log:this.log,totalDmgDealt:this.totalDmgDealt}}}const de={character:{frameW:48,frameH:48,idle:{row:0,frames:6,fps:8,loop:!0,holdLast:!1},walk:{row:1,frames:8,fps:12,loop:!0,holdLast:!1},attack:{row:2,frames:6,fps:14,loop:!1,holdLast:!1},hurt:{row:3,frames:3,fps:16,loop:!1,holdLast:!1},death:{row:4,frames:7,fps:8,loop:!1,holdLast:!0}},boss:{frameW:96,frameH:96,idle:{row:0,frames:6,fps:6,loop:!0,holdLast:!1},attack:{row:1,frames:6,fps:10,loop:!1,holdLast:!1},hurt:{row:2,frames:3,fps:14,loop:!1,holdLast:!1},death:{row:3,frames:8,fps:7,loop:!1,holdLast:!0}},minion:{frameW:48,frameH:48,idle:{row:0,frames:6,fps:10,loop:!0,holdLast:!1},walk:{row:1,frames:8,fps:14,loop:!0,holdLast:!1},attack:{row:2,frames:5,fps:14,loop:!1,holdLast:!1},hurt:{row:3,frames:3,fps:16,loop:!1,holdLast:!1},death:{row:4,frames:6,fps:8,loop:!1,holdLast:!0}}},Ee={guerrier:"/assets/characters/guerrier_sheet.png",mage:"/assets/characters/mage_sheet.png",arche:"/assets/characters/arche_sheet.png",assassin:"/assets/characters/assassin_sheet.png",boss:"/assets/characters/boss_sheet.png",minion:"/assets/characters/minion_sheet.png"},ut={};async function pi(a){return ut[a]!==void 0?ut[a]:new Promise(t=>{const e=new Image;e.onload=()=>{ut[a]=!0,t(!0)},e.onerror=()=>{ut[a]=!1,t(!1)},e.src=Ee[a]})}class ci{constructor(t,e,i="character"){this.el=t,this.type=e,this.config=de[i]||de.character,this.currentAnim=null,this.currentFrame=0,this.lastTime=0,this.rafId=null,this.onAnimEnd=null,this.hasSheet=!1,this._queue=null,this._init()}async _init(){const t=await pi(this.type);if(this.hasSheet=t,t){const{frameW:e,frameH:i}=this.config;this.el.style.backgroundImage=`url('${Ee[this.type]}')`,this.el.style.backgroundRepeat="no-repeat",this.el.style.backgroundSize="auto",this.el.style.imageRendering="pixelated",this.el.style.width=e+"px",this.el.style.height=i+"px";const r=this.el.querySelector("img");r&&(r.style.display="none"),this.play("idle")}}play(t,e=null){if(!this.hasSheet){this._triggerCSSFallback(t),e&&e();return}this.config[t]&&(this.currentAnim==="death"&&t!=="death"||(this.currentAnim=t,this.currentFrame=0,this.lastTime=performance.now(),this.onAnimEnd=e,this._queue=null,this.rafId&&cancelAnimationFrame(this.rafId),this._tick(this.lastTime)))}playThen(t,e){this.play(t,()=>this.play(e))}stop(){this.rafId&&cancelAnimationFrame(this.rafId),this.rafId=null}destroy(){this.stop(),this.el=null}_tick(t){if(!this.el)return;const e=this.config[this.currentAnim];if(!e)return;const i=1e3/e.fps,r=t-this.lastTime;if(r>=i&&(this.lastTime=t-r%i,this._renderFrame(e),this.currentFrame++,this.currentFrame>=e.frames))if(e.loop)this.currentFrame=0;else if(e.holdLast){this.currentFrame=e.frames-1,this._renderFrame(e),this.onAnimEnd&&(this.onAnimEnd(),this.onAnimEnd=null);return}else{this.currentFrame=0,this.onAnimEnd&&(this.onAnimEnd(),this.onAnimEnd=null);return}this.rafId=requestAnimationFrame(n=>this._tick(n))}_renderFrame(t){if(!this.el)return;const{frameW:e,frameH:i}=this.config,r=-(this.currentFrame*e),n=-(t.row*i);this.el.style.backgroundPosition=`${r}px ${n}px`}_triggerCSSFallback(t){if(!this.el)return;const i={attack:"combat-unit--attack-player",hurt:"combat-unit--hit",death:"combat-unit--death"}[t];i&&(this.el.classList.add(i),setTimeout(()=>this.el?.classList.remove(i),600))}}const It=new Map;function gi(a,t){It.set(a,t)}function Te(){It.forEach(a=>a.destroy()),It.clear()}function q(a,t,e=null){const i=It.get(a);i&&i.play(t,e)}let y=null,N=null,G=null,Ht=[],V=null,S=null,U=!1,P=1;function fi(a,t,e){a.addEventListener(t,e),Ht.push({target:a,type:t,fn:e})}function dt(){Ht.forEach(({target:a,type:t,fn:e})=>a.removeEventListener(t,e)),Ht=[],y&&(y.destroy(),y=null),V&&(clearInterval(V),V=null),Te(),S=null,U=!1,P=1}const Jt={feu:"🔥",glace:"❄️",foudre:"⚡",nature:"🌿",tenebres:"💀",physique:"⚔️"},Bt={feu:"#E85D20",glace:"#60A5FA",foudre:"#FBBF24",nature:"#4ADE80",tenebres:"#A855F7",physique:"#F87171"};function Nt(a={}){const t=a.zone||N,e=parseInt(a.level??G??0);N=t,G=e;const i=j.find(o=>o.id===t);if(!i){dt(),w.navigate("campaign");return}const r=f.getTeamInstances();if(r.length===0){dt(),w.navigate("team");return}const n=e===(i.levels||20)-1,s=Ve(t,e,f.state.playerLevel);y=new di(r,s),y.onTick=o=>{document.getElementById("atb-battlefield")&&(ui(o.timeline),wi(),Ci())},y.onPlayerReady=o=>{if(U){const l=o.skills||[],c=l.filter(x=>x.type==="physical"||x.type==="magical"),p=l.filter(x=>x.type==="heal"),m=y.playerTeam.filter(x=>x.alive).find(x=>x.currentHp/x.maxHp<.4);let u=0,v=null;if(p.length&&m)u=l.indexOf(p[0]),v=m.id;else if(c.length){const x=c.sort((M,B)=>B.power-M.power)[0];u=l.indexOf(x),v=y.enemyTeam.filter(M=>M.alive).sort((M,B)=>M.currentHp-B.currentHp)[0]?.id}const h=P>=4?80:200;setTimeout(()=>{y&&v!==null&&(S=v,te(u,o))},h);return}ki(o),$i(o.id)},y.onActionExecuted=o=>{Ei(o)},y.onLog=o=>{const l=document.getElementById("atb-combat-log");l&&(l.textContent=o)},y.onBreak=o=>{Si(o.id)},y.onGameOver=o=>{setTimeout(()=>Mi(i,n),600)};const d=y.enemyTeam.find(o=>o.alive);d&&(S=d.id),mi(i),y.start()}function mi(a,t){const e=document.getElementById("app");e.innerHTML=`
  ...
  `,yi(),xi(),fi(window,"keydown",r=>{if(!y||!y.paused)return;const n=y.activeUnit;if(!n)return;const d={a:0,z:1,e:2,r:3}[r.key.toLowerCase()];d!==void 0&&n.skills[d]&&te(d,n),r.code==="Space"&&(r.preventDefault(),y.executeGuard(),Gt())}),document.getElementById("flee-btn").addEventListener("click",()=>{confirm("Fuir le combat ?")&&(dt(),w.navigate("campaign"))}),document.getElementById("speed-btn").addEventListener("click",()=>{P=P===1?2:P===2?4:1;const r=document.getElementById("speed-btn");r&&(r.textContent=`⚡ x${P}`,r.style.color=P===1?"var(--text-bright)":P===2?"#FBBF24":"#FF6B2C",r.style.borderColor=P===1?"rgba(200,155,60,0.3)":P===2?"rgba(251,191,36,0.5)":"rgba(255,107,44,0.5)"),y&&y.setSpeed(P)}),document.getElementById("auto-btn").addEventListener("click",()=>{U=!U;const r=document.getElementById("auto-btn");r&&(r.style.color=U?"#4ADE80":"var(--text-muted)",r.style.borderColor=U?"rgba(74,222,128,0.5)":"rgba(200,155,60,0.3)",r.style.background=U?"rgba(74,222,128,0.1)":"rgba(0,0,0,0.6)",r.textContent=U?"🤖 AUTO":"AUTO")}),document.getElementById("atb-guard-btn").addEventListener("click",()=>{y?.paused&&(y.executeGuard(),Gt())}),Ai(a.id)}function ui(a){const t=document.getElementById("atb-timeline-track");if(!t)return;const e=a.slice(0,10);t.innerHTML=e.map((i,r)=>{const n=i.isPlayer?"var(--accent-light)":"var(--danger)",s=i.isReady?"#fff":i.isPlayer?"var(--accent)":"rgba(220,38,38,0.5)",d=Math.min(100,i.atbPct),o=i.name.split(" ")[0].substring(0,5),l=i.isBroken?"atb-portrait--broken":"",c=i.isReady?"atb-portrait--ready":"";return`
      <div class="atb-portrait ${l} ${c}" style="--atb-pct:${d}%;border-color:${s}" title="${i.name}">
        ...
        <div class="atb-portrait-icon">${i.isPlayer?vi(i.type):i.isBoss?"💀":"👹"}</div>
        <div class="atb-portrait-name">${o}</div>
      </div>
    `}).join("")}function vi(a){return{guerrier:"⚔️",mage:"🔮",arche:"🏹",assassin:"🗡️"}[a]||"⚔️"}function xi(){const a=document.getElementById("player-portraits");!a||!y||(a.innerHTML=y.playerTeam.map(t=>{const e=t.currentHp/t.maxHp*100,i=Math.max(0,t.atbGauge/t.atbMax*100);return`
  ...
  `}function yi(){const a=document.getElementById("unit-container");if(!a||!y)return;const t=[...y.playerTeam,...y.enemyTeam];a.innerHTML=t.map(e=>hi(e)).join(""),Te(),t.forEach(e=>{if(!e.alive)return;const i=a.querySelector(`[data-unit-id="${e.id}"] img.sprite`);if(!i)return;const r=e.isBoss?"boss":e.isEnemy?"minion":e.type||"guerrier",n=e.isBoss?"boss":e.isEnemy?"minion":"character",s=new ci(i.parentElement,r,n);gi(e.id,s)}),a.querySelectorAll(".enemy-unit").forEach(e=>{e.addEventListener("click",()=>{const i=e.dataset.unitId,r=y?.findUnit(i);r&&!r.isPlayer&&r.alive&&(S=i,ze(),Ie())})})}function hi(a){const t=Math.max(0,a.currentHp/a.maxHp)*100,e=a.isBoss,i=a.isPlayer,r=e?Qt(a.useNewBossSprite):a.isEnemy?Kt():C(a.type),n=a.x,s=a.id===S,d=!i&&a.weakness&&Jt[a.weakness]||"";return`
    <div class="${i?"player-unit":"enemy-unit"} combat-unit"
      ...
      ${!i&&a.weakness?`
        <div class="atb-weakness-badge" style="--weak-color:${Bt[a.weakness]||"#F87171"}">
          ${d}
        </div>
      `:""}
  ...
  `}function wi(){if(!y)return;const a=[...y.playerTeam,...y.enemyTeam];for(const t of a){const e=document.querySelector(`[data-unit-id="${t.id}"]`);if(!e)continue;const i=document.querySelector(`[data-unit-hp="${t.id}"]`);if(i){const s=Math.max(0,t.currentHp/t.maxHp*100);i.style.width=s+"%";const d=s<=25?"low":s<=50?"medium":"";i.className=`bar-fill bar-fill--hp ${d}`}const r=document.querySelector(`[data-unit-hp-text="${t.id}"]`);r&&(r.textContent=`${Math.max(0,t.currentHp)}/${t.maxHp}`),t.alive||(e.style.opacity="0.2",e.style.filter="grayscale(1)",e.style.pointerEvents="none");const n=document.querySelector(`[data-break-ring="${t.id}"] circle:nth-child(2)`);if(n){const s=(t.breakGauge||0)/(t.breakMax||100),d=2*Math.PI*18;n.setAttribute("stroke-dashoffset",d*(1-s)),n.setAttribute("stroke",t.isBroken?"#FF6B35":"#FBBF24")}}if(S){const t=y.findUnit(S);if(!t||!t.alive){const e=y.enemyTeam.find(i=>i.alive);S=e?e.id:null}}bi(),ze(),Ie()}function Ie(){if(document.querySelectorAll(".selection-ring").forEach(a=>a.remove()),S){const a=document.querySelector(`[data-unit-id="${S}"]`);if(a&&!a.querySelector(".selection-ring")){const t=document.createElement("div");t.className="selection-ring",t.style.left="50%",a.insertBefore(t,a.firstChild)}}}function $i(a){document.querySelectorAll(".atb-active-highlight").forEach(i=>i.remove());const t=document.querySelector(`[data-unit-id="${a}"]`);if(t){const i=document.createElement("div");i.className="atb-active-highlight",t.appendChild(i)}document.querySelectorAll(".atb-hero-portrait").forEach(i=>i.classList.remove("atb-hero-portrait--active"));const e=document.querySelector(`[data-portrait-id="${a}"]`);e&&e.classList.add("atb-hero-portrait--active")}function ki(a,t,e){const i=document.getElementById("atb-skill-buttons");if(!i)return;i.innerHTML=a.skills.map((n,s)=>{const d=n.speed==="fast"?"atb-skill--fast":n.speed==="heavy"?"atb-skill--heavy":"atb-skill--medium",o=n.speed==="fast"?"⚡ Rapide":n.speed==="heavy"?"🐢 Lourd":"⚖️ Normal",l=((n.recovery||2e3)/1e3).toFixed(1),c=n.element&&Jt[n.element]||"",p=n.element&&Bt[n.element]||"#F87171",g=n.type==="heal"?"💚 Soin":n.type==="buff"?"✨ Buff":n.type==="magical"?"🔮 Magique":"⚔️ Physique",m=n.power?`${n.power}%`:"—",u=S?y?.findUnit(S):null,v=u&&u.weakness&&n.element===u.weakness;return`
    ...
    `}).join(""),i.querySelectorAll(".atb-skill-btn").forEach(n=>{const s=n.querySelector(".skill-tooltip");s&&(n.addEventListener("mouseenter",()=>{s.style.opacity="1"}),n.addEventListener("mouseleave",()=>{s.style.opacity="0"}))}),i.querySelectorAll(".atb-skill-btn").forEach(n=>{n.addEventListener("click",()=>{const s=parseInt(n.dataset.skillIdx);te(s,a)})});const r=document.getElementById("atb-action-panel");r&&r.classList.add("atb-action-panel--active")}function te(a,t){if(!y?.paused)return;const e=t.skills[a];if(e){if(e.type==="heal"||e.type==="buff")y.executePlayerAction(a,t.id);else if(S)y.executePlayerAction(a,S);else{const i=document.getElementById("atb-combat-log");i&&(i.textContent="🎯 Ciblez un ennemi (Clic Gauche) !");return}Gt()}}function Gt(){const a=document.getElementById("atb-action-panel");a&&a.classList.remove("atb-action-panel--active"),document.querySelectorAll(".atb-active-highlight").forEach(e=>e.remove()),document.querySelectorAll(".atb-hero-portrait--active").forEach(e=>e.classList.remove("atb-hero-portrait--active"));const t=document.getElementById("atb-skill-buttons");t&&(t.innerHTML='<div style="color:var(--text-muted);font-size:11px;padding:10px;letter-spacing:1px">⏳ ATB en cours...</div>')}function Ei(a){const{actor:t,skill:e,results:i,isPlayer:r}=a,n=document.querySelector(`[data-unit-id="${t.id}"]`);n&&(e.type==="physical"?(n.classList.add(r?"combat-unit--dash-right":"combat-unit--dash-left"),q(t.id,"attack",()=>q(t.id,"idle")),setTimeout(()=>n.classList.remove("combat-unit--dash-right","combat-unit--dash-left"),600)):(n.classList.add("combat-unit--casting"),q(t.id,"attack",()=>q(t.id,"idle")),setTimeout(()=>n.classList.remove("combat-unit--casting"),600))),t.type==="mage"&&e.type!=="heal"&&e.type!=="buff"&&i.hits?.length>0&&Ti(t,i.hits[0].targetId,e),setTimeout(()=>{let s=!1,d=0;if(i.hits&&(i.hits.forEach(o=>{o.isCrit&&(s=!0),d+=o.damage||0,zi(o.targetId,o.isCrit),pe(o.targetId,o.damage,o.isCrit,!1);const l=y?.findUnit(o.targetId);l&&!l.alive&&setTimeout(()=>Ii(o.targetId),300)}),d>0&&r&&f.updateDailyStat("damage",d),s)){const o=document.querySelector(".combat-screen");o&&(o.classList.add("screen--shake"),setTimeout(()=>o.classList.remove("screen--shake"),400))}i.heals&&i.heals.forEach(o=>{pe(o.targetId,o.amount,!1,!0)})},350)}function Ti(a,t,e){const i=document.getElementById("atb-battlefield"),r=document.querySelector(`[data-unit-id="${t}"]`);if(!i||!r)return;const n=i.getBoundingClientRect(),s=r.getBoundingClientRect(),d=s.left-n.left+s.width/2,o=s.top-n.top+s.height/2,l=a.x+55,c=a.y+60,p=e.element&&Bt[e.element]||"#ff6b9d",g=document.createElement("div");g.style.cssText=`position:absolute; left:${l}px; top:${c}px; width:24px; height:24px;
    background:radial-gradient(circle, ${p} 20%, transparent); border-radius:50%;
    box-shadow:0 0 15px ${p}; z-index:20; transition: all 0.45s cubic-bezier(0.4,0,0.2,1);`,i.appendChild(g),requestAnimationFrame(()=>{g.style.left=d+"px",g.style.top=o+"px",g.style.transform="scale(1.5)"}),setTimeout(()=>g.remove(),500)}function zi(a,t){const e=document.querySelector(`[data-unit-id="${a}"]`);if(!e)return;const i=t?"combat-unit--crit":"combat-unit--hit";e.classList.add(i),q(a,"hurt",()=>q(a,"idle")),setTimeout(()=>e.classList.remove(i),500)}function Ii(a){const t=document.querySelector(`[data-unit-id="${a}"]`);t&&(t.classList.add("combat-unit--death"),q(a,"death"))}function Si(a){const t=document.querySelector(`[data-unit-id="${a}"]`),e=document.getElementById("atb-battlefield");if(!t||!e)return;t.classList.add("combat-unit--break"),setTimeout(()=>t.classList.remove("combat-unit--break"),700);const i=document.createElement("div");i.style.cssText="position:absolute;inset:0;background:rgba(251,191,36,0.15);z-index:30;pointer-events:none;animation:fadeIn 0.1s ease, fadeOut 0.5s ease 0.2s forwards",e.appendChild(i),setTimeout(()=>i.remove(),700);const r=document.querySelector(".combat-screen");r&&(r.classList.add("screen--shake"),setTimeout(()=>r.classList.remove("screen--shake"),400));const n=t.getBoundingClientRect(),s=e.getBoundingClientRect(),d=document.createElement("div");d.style.cssText=`position:absolute;left:${n.left-s.left+n.width/2}px;top:${n.top-s.top-20}px;
    ...
    animation:damageFloat 1.2s ease forwards;pointer-events:none;z-index:35;letter-spacing:3px`,d.textContent="💥 BREAK!",e.appendChild(d),setTimeout(()=>d.remove(),1200)}function pe(a,t,e,i){const r=document.querySelector(`[data-unit-id="${a}"]`);if(!r)return;const n=document.createElement("div");n.className=`damage-number ${i?"damage-number--heal":""} ${e?"damage-number--crit":""}`,n.textContent=`${i?"+":"-"}${t}`,r.appendChild(n),setTimeout(()=>n.remove(),1e3)}function Ci(){if(!y)return;const a=Math.floor(y.elapsedTime/1e3),t=Math.floor(a/60),e=a%60,i=document.getElementById("atb-timer");i&&(i.textContent=`${String(t).padStart(2,"0")}:${String(e).padStart(2,"0")}`);const r=document.getElementById("atb-dmg-total");r&&(r.textContent=`⚔ ${(y.totalDmgDealt||0).toLocaleString()} dmg`)}const ce={enchantement:{emoji:"✨",count:15,speed:4,opacity:.6,sway:40},osiris:{emoji:"🏜️",count:20,speed:3,opacity:.4,sway:60,altEmoji:"💨"},supplice:{emoji:"🫧",count:12,speed:5,opacity:.5,sway:30},maragorh:{emoji:"🍃",count:18,speed:3.5,opacity:.5,sway:50,altEmoji:"🌿"},imotep:{emoji:"🌋",count:15,speed:2.5,opacity:.4,sway:20,altEmoji:"✦"},abysses:{emoji:"🫧",count:20,speed:6,opacity:.5,sway:60,altEmoji:"💎"},citadelle:{emoji:"⚡",count:12,speed:2,opacity:.4,sway:30,altEmoji:"✦"},terre_desolee:{emoji:"🔥",count:25,speed:3,opacity:.5,sway:20,altEmoji:"💀"},nexus:{emoji:"🌌",count:18,speed:5,opacity:.6,sway:50,altEmoji:"💫"}};function Ai(a){const t=document.getElementById("ambient-particles");if(!t)return;const e=ce[a]||ce.enchantement;V&&clearInterval(V);function i(){if(!document.getElementById("ambient-particles")){clearInterval(V);return}const r=document.createElement("div"),n=e.altEmoji&&Math.random()>.6,s=(Math.random()-.5)*2*e.sway,d=(Math.random()-.5)*720,o=Math.random()*100,l=e.speed+Math.random()*3,c=8+Math.random()*12;r.textContent=n?e.altEmoji:e.emoji,r.style.cssText=`position:absolute;left:${o}%;top:-20px;font-size:${c}px;
      --p-sway:${s}px;--p-rot:${d}deg;--p-opacity:${e.opacity};
      animation:ambientFall ${l}s linear forwards;pointer-events:none;z-index:0;`,t.appendChild(r),setTimeout(()=>r.remove(),l*1e3+100)}for(let r=0;r<Math.floor(e.count/3);r++)setTimeout(i,r*200);V=setInterval(i,1e4/e.count)}function Mi(a,t){if(!y)return;const e=y.winner==="player",i=document.getElementById("victory-overlay");if(i)if(e){const r=y.playerTeam,n=r.reduce((z,b)=>z+b.maxHp,0),d=r.reduce((z,b)=>z+Math.max(0,b.currentHp),0)/n,o=d>=.7?3:d>=.35?2:1,l=f.getLevelFlames(N,G),c=l===0,p=o>l;let m=(t?se.boss:se.normal)[o]||0;!c&&!p&&(m=Math.floor(m*.3));const u=G+1,v=Math.floor(t?u*8+150:o===3?u*5+80:o===2?u*3+50:u*2+30);let h=c?v:Math.floor(v*.3),x=Math.floor(h/3);f.completeLevel(N,G,o),f.addArchireve(m);const A=f.addTeamXp(h);f.addProfileXp(x),f.recordBattle(!0),f.updateDailyStat("wins",1),f.updateDailyStat("levels",1),f.checkAchievements(),f.getTeamInstances().forEach(z=>{const b=f.state.ownedCharacters.find(E=>E.id===z.id);b&&(b.currentHp=void 0)});const D=Math.floor(y.elapsedTime/1e3),M=`${Math.floor(D/60)}:${String(D%60).padStart(2,"0")}`,B=document.createElement("div");B.className="victory-banner",B.innerHTML=`
      ...
      <div style="font-size:10px;color:var(--text-muted);margin-bottom:12px">⏱ ${M} · ⚔ ${(y.totalDmgDealt||0).toLocaleString()} dégâts</div>
      <div style="display:flex;justify-content:center;gap:14px;margin:16px 0 24px">
        ${Array.from({length:3},(z,b)=>`<span style="font-size:36px;filter:drop-shadow(0 0 12px #E85D20);transition:all 0.3s ease;${b>=o?"opacity:0.18;filter:grayscale(1)":""}">${t?"🔥":"🍃"}</span>`).join("")}
      </div>
      <div style="display:flex;flex-direction:column;align-items:center;gap:10px;padding:16px 24px;background:rgba(0,0,0,0.25);border-radius:var(--radius-xl);border:1px solid rgba(255,255,255,0.06);margin-bottom:8px">
        ...
        ${A.some(z=>z.leveled)?'<div style="font-size:11px;color:var(--legendaire);font-weight:700">⬆️ Level Up !</div>':""}
        ${!c&&!p?'<div style="font-size:9px;color:var(--text-muted)">Récompenses réduites (déjà complété)</div>':""}
      </div>
    `,i.appendChild(B),setTimeout(()=>{const z=document.createElement("div");z.style.cssText="position:absolute;bottom:60px;left:50%;transform:translateX(-50%);z-index:50;display:flex;gap:12px;animation:fadeIn 0.5s ease";const b=G+1,E=j.find(Rt=>Rt.id===N),Y=E&&b<E.levels;z.innerHTML=`
      ...
      `,i.appendChild(z),document.getElementById("next-level-btn")?.addEventListener("click",()=>{S=null,Nt({zone:N,level:b})}),document.getElementById("back-campaign-btn")?.addEventListener("click",()=>{dt(),w.navigate("campaign")})},1500)}else f.recordBattle(!1),i.innerHTML=`
      <div style="position:absolute; inset:0; background:rgba(0,0,0,0.8); display:flex; flex-direction:column; align-items:center; justify-content:center; z-index:100; animation: fadeIn 0.5s ease">
        ...
        <div style="font-size:10px;color:var(--text-muted);margin-bottom:20px">⏱ ${Math.floor(y.elapsedTime/1e3)}s</div>
        <div style="display:flex; gap:15px">
          <button class="btn btn--primary" id="retry-btn">🔄 Réessayer</button>
          <button class="btn btn--ghost" id="back-btn">◀ Retour</button>
        </div>
      </div>
    `,document.getElementById("retry-btn").onclick=()=>Nt({zone:N,level:G}),document.getElementById("back-btn").onclick=()=>{dt(),w.navigate("campaign")}}const Dt=75,Ot=15;function qt(){const a=document.getElementById("app"),t=f.state,e=t.pityCount||0,i=t.pityEpic||0,r=t.scories||0,n=Math.min(100,Math.round(e/Dt*100)),s=Math.min(100,Math.round(i/Ot*100)),d=t.archireve>=W.single,o=t.archireve>=W.multi;a.innerHTML=`
        ...
        <!-- Portal Animation -->
          ...
          <div style="display:flex;flex-direction:column;gap:10px;width:100%">
            <button class="btn btn--primary btn--full" id="char-pull-single" ${d?"":"disabled"}
              ...
              <span style="font-size:9px;opacity:0.7;letter-spacing:1px">◆ ${W.single.toLocaleString()} · ×1 Héros</span>
            </button>
            <button class="btn btn--star btn--full" id="char-pull-multi" ${o?"":"disabled"}
              ...
              <span style="font-size:9px;opacity:0.7;letter-spacing:1px">◆ ${W.multi.toLocaleString()} · ×10 — Epique+ garanti</span>
            </button>
          </div>
        </div>
        ...
        <div style="flex:1;min-width:380px;max-width:480px;display:flex;flex-direction:column;align-items:center;
          ...
          <div style="display:flex;flex-direction:column;gap:10px;width:100%">
            <button class="btn btn--full" id="item-pull-single" ${d?"":"disabled"}
              ...
              <span style="font-size:9px;opacity:0.7;letter-spacing:1px">◆ ${W.single.toLocaleString()} · ×1 Item</span>
            </button>
      ...
      <div style="display:flex;gap:24px;justify-content:center;padding:0 48px;flex-wrap:wrap;max-width:1020px;margin:0 auto;width:100%">
        ...
        <div style="flex:1;min-width:280px;max-width:480px">
          ...
          <div class="pity-container" style="margin-bottom:12px">
            <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:6px">
              ...
              <div style="font-family:var(--font-stat);font-size:12px;color:var(--legendaire)">${e} / ${Dt}</div>
            </div>
            <div class="pity-bar-track"><div class="pity-bar-fill" style="width:${n}%"></div></div>
            <div style="font-size:9px;color:var(--text-muted);letter-spacing:1px">${Dt-e} invocations avant un Legendaire garanti</div>
          </div>
          <!-- Pity Épique -->
          <div class="pity-container" style="margin-bottom:12px">
            <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:6px">
        ...
        <div class="glass" style="flex:1;min-width:280px;max-width:480px;padding:20px;border-radius:16px">
          ...
          <div style="display:flex;flex-direction:column;gap:8px">
            ${[{name:"Rare",color:"var(--rare)",pct:ft.rare},{name:"Epique",color:"var(--epique)",pct:ft.epique},{name:"Legendaire",color:"var(--legendaire)",pct:ft.legendaire},{name:"ULTIMATE",color:"var(--ultimate)",pct:ft.ultimate}].map(l=>`
  ...
  `,document.getElementById("back-btn").addEventListener("click",()=>w.navigate("home")),document.getElementById("char-pull-single").addEventListener("click",()=>{const l=je();l.success?(vt(1,l.results[0]?.rarity),f.updateDailyStat("pulls",1),xt(l.results)):bt(l.error,"error")}),document.getElementById("char-pull-multi").addEventListener("click",()=>{const l=He();l.success?(vt(10,null,l.characters.map(c=>c.rarity)),f.updateDailyStat("pulls",10),xt(l.characters)):bt(l.error,"error")}),document.getElementById("item-pull-single").addEventListener("click",()=>{const l=Ne();l.success?(vt(1,l.results[0]?.rarity),f.updateDailyStat("pulls",1),xt(l.results)):bt(l.error,"error")}),document.getElementById("item-pull-multi").addEventListener("click",()=>{const l=Ge();l.success?(vt(10,null,l.characters.map(c=>c.rarity)),f.updateDailyStat("pulls",10),xt(l.characters)):bt(l.error,"error")})}function vt(a,t,e){const i=f.state;i.pityCount=(i.pityCount||0)+a,i.pityEpic=(i.pityEpic||0)+a,i.scories=(i.scories||0)+a*10;const r=e||(t?[t]:[]);for(const n of r)n==="legendaire"||n==="ultimate"?(i.pityCount=0,i.pityEpic=0):n==="epique"&&(i.pityEpic=0);f.save?.()}function xt(a){const t=document.createElement("div");t.className="modal-overlay",t.style.cssText="flex-direction:column;gap:0;background:rgba(0,0,0,0.97)";let e=0;const i={rare:{color:"#4a9eff",glow:"rgba(74,158,255,0.4)",name:"RARE"},epique:{color:"#c44aff",glow:"rgba(196,74,255,0.5)",name:"EPIQUE"},legendaire:{color:"#ffb84a",glow:"rgba(255,184,74,0.5)",name:"LEGENDAIRE"},ultimate:{color:"#ff4a6a",glow:"rgba(255,74,106,0.6)",name:"ULTIMATE"}},r={rare:0,epique:1,legendaire:2,ultimate:3};function n(d){const o=a[d],l=o.rarity||"rare",c=i[l]||i.rare,p=r[l]||0;t.innerHTML=`
    ...
    `;const g=document.getElementById("forge-sparks");if(g){for(let u=0;u<30;u++)setTimeout(()=>{const v=document.createElement("div"),h=Math.random()*Math.PI*2,x=80+Math.random()*200;v.style.cssText="position:absolute;left:50%;top:50%;width:"+(2+Math.random()*3)+"px;height:"+(4+Math.random()*8)+"px;background:linear-gradient("+c.color+",transparent);border-radius:50% 50% 0 0;opacity:0;transform-origin:bottom center;animation:particleBurst 1.2s "+(.6+Math.random()*.6)+"s ease forwards;--dx:"+Math.cos(h)*x+"px;--dy:"+Math.sin(h)*x+"px;",g.appendChild(v)},u*40);const m=document.createElement("style");m.textContent="@keyframes particleBurst { 0%{transform:translate(-50%,-50%) scale(0);opacity:1} 100%{transform:translate(calc(-50% + var(--dx)),calc(-50% + var(--dy))) scale(0.2);opacity:0} }",t.appendChild(m)}document.getElementById("forge-phase").addEventListener("click",()=>s(d))}function s(d){const o=a[d],l=o.type==="item",c=o.rarity||"rare",p=i[c]||i.rare;let g,m,u,v,h;if(l&&o.item){const x=o.item,A=K[x.slot]||{name:x.slot,icon:""};g=x.name,m=x.desc||"",u='<div style="font-size:72px;margin:16px 0;filter:drop-shadow(0 0 25px '+p.glow+')">'+(x.icon||"📦")+"</div>";const D=Object.entries(x.stats||{}).map(M=>M[0].toUpperCase()+" +"+M[1]).join(" · ");v='<span class="type-badge" style="background:rgba(74,158,255,0.15);color:#4a9eff">'+A.icon+" "+A.name+'</span><span class="rarity-badge rarity-badge--'+c+'">'+c.toUpperCase()+"</span>",m+='<br><span style="color:var(--accent);font-size:10px;letter-spacing:1px">'+D+"</span>",h="📦 ITEM"}else{const x=o.character;g=x.name,m=x.desc,u='<img src="'+C(x.type)+'" class="sprite sprite--xxl" alt="'+x.name+'" style="filter:drop-shadow(0 0 25px '+p.glow+') drop-shadow(0 4px 8px rgba(0,0,0,0.5));animation:pullRevealSprite 0.6s ease">',v='<span class="type-badge type-badge--'+x.type+'">'+x.type.toUpperCase()+'</span><span class="rarity-badge rarity-badge--'+x.rarity+'">'+x.rarity.toUpperCase()+"</span>",h="⚔️ HÉROS"}t.innerHTML='<div class="modal" style="text-align:center;border-color:'+p.color+";box-shadow:0 0 60px "+p.glow+';min-width:320px;max-width:380px;border-radius:var(--radius-xl);overflow:hidden;position:relative;padding:0;animation:revealSlam 0.5s cubic-bezier(0.2,1.5,0.3,1)"><div style="height:3px;background:linear-gradient(90deg,transparent,'+p.color+',transparent)"></div><div style="padding:var(--space-xl) var(--space-lg)"><div style="font-family:var(--font-stat);font-size:9px;color:'+p.color+';letter-spacing:3px;margin-bottom:4px;opacity:0.7">'+h+'</div><div style="font-family:var(--font-title);font-size:11px;color:'+p.color+";letter-spacing:4px;margin-bottom:var(--space-sm);text-shadow:0 0 15px "+p.glow+'">◆ '+p.name+" ◆</div>"+(o.isNew?'<div style="color:var(--success);font-size:11px;font-weight:700;margin-bottom:var(--space-xs);letter-spacing:2px">NOUVEAU !</div>':"")+(o.levelUp?'<div style="color:var(--warning);font-size:11px;font-weight:700;margin-bottom:var(--space-xs);letter-spacing:2px">NIVEAU + !</div>':"")+'<div style="position:relative;margin:var(--space-md) auto;width:fit-content">'+u+'<div style="position:absolute;inset:-20px;background:radial-gradient(circle,'+p.glow+',transparent 60%);z-index:-1;filter:blur(20px)"></div></div><div style="font-family:var(--font-title);font-size:18px;color:'+p.color+";font-weight:800;margin:var(--space-md) 0 var(--space-sm);letter-spacing:1px;text-shadow:0 0 10px "+p.glow+'">'+g+'</div><div style="display:flex;justify-content:center;gap:var(--space-sm);margin-bottom:var(--space-sm)">'+v+'</div><p style="font-size:11px;color:var(--text-secondary);line-height:1.6;margin-bottom:var(--space-lg)">'+m+'</p><div style="font-size:10px;color:var(--text-muted);margin-bottom:var(--space-md);letter-spacing:1px">'+(d+1)+" / "+a.length+'</div><button class="btn btn--primary btn--full" id="pull-next" style="border-radius:var(--radius-lg)">'+(d<a.length-1?"SUIVANT":"TERMINER")+"</button>"+(a.length>1&&d<a.length-1?'<button class="btn btn--ghost btn--full btn--sm" id="skip-all" style="margin-top:var(--space-xs);font-size:9px;letter-spacing:2px">PASSER TOUT</button>':"")+"</div></div><style>@keyframes pullRevealSprite { 0%{transform:scale(0.2) rotate(-15deg);opacity:0;filter:brightness(3)} 50%{transform:scale(1.15) rotate(3deg)} 100%{transform:scale(1) rotate(0);opacity:1} }@keyframes revealSlam { 0%{transform:scale(0.5) translateY(30px);opacity:0} 60%{transform:scale(1.05) translateY(-5px)} 100%{transform:scale(1) translateY(0);opacity:1} }</style>",document.getElementById("pull-next").addEventListener("click",()=>{d<a.length-1?(e++,n(e)):(t.remove(),qt())}),document.getElementById("skip-all")?.addEventListener("click",()=>{t.remove(),qt()})}document.body.appendChild(t),n(0)}function bt(a,t="warning"){const e=document.createElement("div");e.className="toast toast--"+t,e.textContent=a,document.body.appendChild(e),setTimeout(()=>e.remove(),3e3)}let $t="all",kt="all",tt="rarity";const Z={guerrier:"#f87171",mage:"#c084fc",arche:"#86efac",assassin:"#ff6b9d"},rt={hp:"HP",atk:"ATK",def:"DEF",spd:"SPD",magAtk:"MAG",magDef:"RES"},ge=["ultimate","legendaire","epique","rare"];function O(){const a=document.getElementById("app"),t=f.state,e=t.team,i=f.getTeamInstances(),r=f.getOwnedInstances();let n=[...r];$t!=="all"&&(n=n.filter(o=>o.type===$t)),kt!=="all"&&(n=n.filter(o=>o.rarity===kt)),n.sort((o,l)=>tt==="rarity"?ge.indexOf(o.rarity||"rare")-ge.indexOf(l.rarity||"rare"):tt==="level"?l.level-o.level:tt==="atk"?l.stats.atk+l.stats.magAtk-(o.stats.atk+o.stats.magAtk):0);const s=Pi(i),d=i.reduce((o,l)=>o+Object.values(l.stats).reduce((c,p)=>c+p,0),0);a.innerHTML=`
        ...
        ">
          ...
          <div style="padding:0 28px;flex-shrink:0">
            <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:14px;margin-bottom:24px">
              ${[0,1,2,3].map(o=>{const l=e[o];if(l){const c=t.ownedCharacters.find(g=>g.id===l),p=lt(l,c?.level||1)||f.getFusedCharacterData(l);if(p){const g=`var(--${p.rarity||"rare"})`,m=Z[p.type]||"var(--accent)",u=Math.floor(100*Math.pow(1.1,p.level-1)),v=Math.round((c?.xp||0)/u*100);return`
                      ...
                      ">
                        <!-- Rarity accent line -->
                        <div style="position:absolute;top:0;left:20%;right:20%;height:2px;background:${g};border-radius:0 0 2px 2px;opacity:0.7;box-shadow:0 0 8px ${g}"></div>
                        ...
                        <div style="font-family:var(--font-title);font-size:11px;color:${g};font-weight:700;letter-spacing:1px;margin-bottom:3px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis" title="${p.name}">${p.name.length>16?p.name.split(" ")[0]:p.name}</div>
              ...
              <table style="width:100%;border-collapse:collapse;font-family:var(--font-ui)">
                <thead>
                  <tr>
                    ...
                    ${Object.values(rt).map(o=>`<th style="text-align:center;padding:6px 4px;font-size:8px;letter-spacing:1px;color:var(--text-muted);border-bottom:1px solid var(--border-metal)">${o}</th>`).join("")}
                  </tr>
                </thead>
                <tbody>
                  ${i.map((o,l)=>(Z[o.type],`
                      <tr style="background:${l%2?"transparent":"rgba(200,155,60,0.015)"}">
                        ...
                        ${Object.keys(rt).map(c=>{const p=Math.max(...i.map(u=>u.stats[c]||0)),g=o.stats[c]||0;return`<td style="padding:6px 4px;text-align:center;border-bottom:1px solid rgba(200,155,60,0.03)">
                            <div style="font-family:var(--font-stat);font-size:12px;font-weight:700;color:${g===p&&p>0?"var(--legendaire)":"var(--text-secondary)"}">${g}</div>
                          </td>`}).join("")}
                      </tr>
                    `)).join("")}
                </tbody>
        ...
        ">
          ...
          ">
            ...
            <div style="display:flex;gap:8px;margin-bottom:12px;flex-wrap:wrap">
              ${["all","guerrier","mage","arche","assassin"].map(o=>{const l=o===$t,c=o==="all"?"var(--accent)":Z[o]||"var(--accent)";return`
            ...
            <div style="display:flex;gap:8px;align-items:center;flex-wrap:wrap">
              ${["all","rare","epique","legendaire","ultimate"].map(o=>{const l=o===kt,c=o==="all"?"var(--text-muted)":`var(--${o})`;return`
              ...
              ${["rarity","level","atk"].map(o=>{const l=o===tt;return`
          ...
          <div style="flex:1;overflow-y:auto;padding:20px 28px;scrollbar-width:thin;scrollbar-color:rgba(200,155,60,0.1) transparent">
            ...
            `:`
              <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(170px,1fr));gap:14px">
                ${n.map(o=>{const l=e.includes(o.id),c=`var(--${o.rarity||"rare"})`,p=Z[o.type]||"var(--accent)",g=t.ownedCharacters.find(v=>v.id===o.id),m=Math.floor(100*Math.pow(1.1,o.level-1)),u=Math.round((g?.xp||0)/m*100);return`
                    ...
                    ">
                      ...
                      <img src="${C((o.type||"").split("/")[0])}" class="sprite sprite--md" alt="${o.name}" style="margin:6px auto 8px;display:block">
                      ...
                      <div style="display:flex;justify-content:space-around">
                        ${[{stat:"hp",icon:"♥",color:"#EF4444"},{stat:"atk",icon:"⚔",color:"#f87171"},{stat:"spd",icon:"↗",color:"#C89B3C"}].map(v=>`
                          <div style="text-align:center">
                            ...
                            <div style="font-family:var(--font-stat);font-size:10px;font-weight:700;color:var(--text-secondary)">${o.stats[v.stat]}</div>
                          </div>
                        `).join("")}
                      </div>
                    </div>
  ...
  `,Li(t,e)}function Li(a,t){document.getElementById("back-btn")?.addEventListener("click",()=>w.navigate("home")),document.querySelectorAll(".filter-type-btn").forEach(e=>{e.addEventListener("click",()=>{$t=e.dataset.filterType,O()})}),document.querySelectorAll(".filter-rarity-btn").forEach(e=>{e.addEventListener("click",()=>{kt=e.dataset.filterRarity,O()})}),document.querySelectorAll(".sort-btn").forEach(e=>{e.addEventListener("click",()=>{tt=e.dataset.sort,O()})}),document.querySelectorAll(".remove-from-team").forEach(e=>{e.addEventListener("click",i=>{i.stopPropagation();const r=[...a.team];r[parseInt(e.dataset.slot)]=null,f.setTeam(r),O()})}),document.querySelectorAll(".roster-card:not(.roster-card--in-team)").forEach(e=>{e.addEventListener("click",()=>{const i=e.dataset.charId;if(t.includes(i))return;const r=t.indexOf(null);if(r===-1){Ri(i);return}const n=[...a.team];n[r]=i,f.setTeam(n),Bi(e),setTimeout(()=>O(),250)}),e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-4px) scale(1.02)",e.style.borderColor="rgba(200,155,60,0.25)",e.style.boxShadow="0 8px 30px rgba(0,0,0,0.5), 0 0 15px rgba(192,57,11,0.08)"}),e.addEventListener("mouseleave",()=>{e.style.transform="",e.style.borderColor="",e.style.boxShadow=""}),e.addEventListener("contextmenu",i=>{i.preventDefault(),fe(e.dataset.charId)})}),document.querySelectorAll(".team-slot-card").forEach(e=>{e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-3px)",e.style.borderColor="rgba(200,155,60,0.25)",e.style.boxShadow="0 6px 20px rgba(0,0,0,0.5), 0 0 12px rgba(192,57,11,0.1)"}),e.addEventListener("mouseleave",()=>{e.style.transform="",e.style.borderColor="",e.style.boxShadow=""}),e.addEventListener("click",i=>{i.target.closest(".remove-from-team")||fe(e.dataset.charId)})}),document.getElementById("btn-optimize")?.addEventListener("click",()=>{const e=_i();e&&(f.setTeam(e),O())}),document.getElementById("btn-clear-all")?.addEventListener("click",()=>{f.setTeam([null,null,null,null]),O()})}function Bi(a){a.style.transition="all 0.25s cubic-bezier(0.34,1.56,0.64,1)",a.style.transform="scale(0.92)",a.style.opacity="0.5"}function Ri(a){const t=f.state,e=document.createElement("div");e.className="modal-overlay";const i=t.ownedCharacters.find(s=>s.id===a),r=lt(a,i?.level||1)||f.getFusedCharacterData(a);if(!r)return;const n=`var(--${r.rarity||"rare"})`;e.innerHTML=`
    <div class="modal" style="text-align:center;max-width:400px;border-radius:12px;padding:32px">
      ...
      <div style="display:flex;align-items:center;gap:12px;justify-content:center;margin-bottom:24px;padding:14px;background:rgba(200,155,60,0.04);border-radius:8px;border:1px solid rgba(200,155,60,0.08)">
        <img src="${C((r.type||"").split("/")[0])}" class="sprite sprite--md" alt="${r.name}">
      ...
      <div style="display:flex;flex-direction:column;gap:8px">
        ${t.team.map((s,d)=>{if(!s)return"";const o=t.ownedCharacters.find(p=>p.id===s),l=lt(s,o?.level||1)||f.getFusedCharacterData(s);if(!l)return"";const c=Z[l.type]||"var(--accent)";return`
            ...
            ">
              <img src="${C((l.type||"").split("/")[0])}" class="sprite sprite--sm" alt="${l.name}">
              <div style="flex:1">
  ...
  `,document.body.appendChild(e),e.querySelectorAll(".swap-btn").forEach(s=>{s.addEventListener("mouseenter",()=>{s.style.borderColor="var(--accent)",s.style.background="rgba(192,57,11,0.08)"}),s.addEventListener("mouseleave",()=>{s.style.borderColor="var(--border-metal)",s.style.background="rgba(20,12,6,0.8)"}),s.addEventListener("click",()=>{const d=[...t.team];d[parseInt(s.dataset.slot)]=a,f.setTeam(d),e.remove(),O()})}),document.getElementById("swap-cancel").addEventListener("click",()=>e.remove()),e.addEventListener("click",s=>{s.target===e&&e.remove()})}function fe(a){const e=f.state.ownedCharacters.find(m=>m.id===a);if(!e)return;const i=lt(a,e.level)||f.getFusedCharacterData(a);if(!i)return;const r=Z[i.type]||"var(--accent)",n=`var(--${i.rarity||"rare"})`,s=f.getCharacterBonusStats(a);Object.values(s).some(m=>m>0);const d=Math.floor(100*Math.pow(1.1,i.level-1)),o=Math.round((e?.xp||0)/d*100),l=120,c=me(i.stats,l*.42),p=[.33,.66,1].map(m=>me({hp:1,atk:1,def:1,spd:1,magAtk:1,magDef:1},l*.42*m)),g=document.createElement("div");g.className="modal-overlay",g.innerHTML=`
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;margin-bottom:24px">
          ...
          <div style="background:rgba(0,0,0,0.2);border:1px solid var(--border);border-radius:10px;padding:16px;display:flex;align-items:center;justify-content:center">
            <svg viewBox="0 0 ${l} ${l}" style="width:${l}px;height:${l}px">
              ...
              ${Di(l*.42,l/2).map(([m,u])=>`<line x1="${l/2}" y1="${l/2}" x2="${m}" y2="${u}" stroke="rgba(200,155,60,0.06)" stroke-width="0.5"/>`).join("")}
          ...
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px">
            ${Object.entries(rt).map(([m,u])=>{const v=i.stats[m]||0,h=s[m]||0,x=v+h;return`
                <div style="padding:8px;background:rgba(0,0,0,0.25);border-radius:6px;border:1px solid var(--border);text-align:center">
                  ...
                  <div style="font-family:var(--font-stat);font-size:18px;font-weight:700;color:var(--text-bright);line-height:1">${x}</div>
  ...
  `,document.body.appendChild(g),document.getElementById("detail-close").addEventListener("click",()=>g.remove()),g.addEventListener("click",m=>{m.target===g&&g.remove()})}function Pi(a){if(!a.length)return{label:"Equipe vide",bonus:""};const t={};a.forEach(r=>{t[r.type]=(t[r.type]||0)+1});const e=Object.entries(t).sort((r,n)=>n[1]-r[1])[0],i=e[0].charAt(0).toUpperCase()+e[0].slice(1);return e[1]===4?{label:`Meute ${i}`,bonus:`+15% toutes les stats (${i})`}:e[1]===3?{label:`Formation ${i}`,bonus:`+10% ATK +5% SPD (${i})`}:e[1]===2?{label:`Duo ${i}`,bonus:`+5% ATK (${i})`}:Object.keys(t).length===4?{label:"Composition Mixte",bonus:"+3% SPD globale (flexibilite)"}:{label:"Standard",bonus:""}}function _i(){const a=f.state.ownedCharacters;return a.length<1?null:a.map(e=>{const i=L.find(n=>n.id===e.id)||f.getFusedCharacterData(e.id);if(!i)return null;const r={rare:1,epique:1.3,legendaire:1.7,ultimate:2.2,semi_ultimate:3.4,supreme:22}[i.rarity]||1;return{id:e.id,score:e.level*r}}).filter(Boolean).sort((e,i)=>i.score-e.score).slice(0,4).map(e=>e.id)}const ee=["hp","atk","def","spd","magAtk","magDef"],ie=a=>a*2*Math.PI/6-Math.PI/2;function me(a,t){const e={hp:800,atk:200,def:200,spd:150,magAtk:220,magDef:200};return ee.map((i,r)=>{const d=Math.min(a[i]||0,e[i])/(e[i]||1)*t,o=ie(r),l=60+d*Math.cos(o),c=60+d*Math.sin(o);return`${l.toFixed(1)},${c.toFixed(1)}`}).join(" ")}function Di(a,t){return ee.map((e,i)=>{const r=ie(i);return[t+a*Math.cos(r),t+a*Math.sin(r)]})}function Oi(a,t,e){return ee.map((i,r)=>{const n=ie(r),s=t+14,d=e+s*Math.cos(n),o=e+s*Math.sin(n);return`<text x="${d.toFixed(1)}" y="${o.toFixed(1)}" text-anchor="middle" dominant-baseline="middle" fill="rgba(255,107,157,0.6)" font-size="8" font-family="DM Sans">${rt[i]}</text>`}).join("")}function Se(){const a=document.getElementById("app"),t=f.state,{pseudo:e,avatar:i,region:r,level:n,xp:s}=t.profile,d=n*100,o=s/d*100,l=t.totalBattles,c=t.totalWins,p=l-c,g=l>0?Math.round(c/l*100):0,m=t.ownedCharacters.length;a.innerHTML=`
    <div class="screen">
      <div class="topbar">
        <button class="topbar__back" id="back-btn">◀</button>
      ...
      <div class="content" style="display:flex;flex-direction:column;align-items:center;gap:var(--space-xl);padding-top:var(--space-xl)">
        ...
        <div class="glass" style="width:100%;max-width:500px;padding:var(--space-xl);border-radius:var(--radius-xl);display:flex;flex-direction:column;align-items:center;position:relative;overflow:hidden">
          ...
          <div style="width:100%;margin-top:var(--space-lg)">
            ...
            <div class="bar-container bar-container--thick">
              <div class="bar-fill bar-fill--xp" style="width:${o}%"></div>
            </div>
          </div>
        </div>
        ...
        <div class="grid-2" style="width:100%;max-width:500px">
          <div class="glass" style="padding:var(--space-lg);border-radius:var(--radius-lg);text-align:center">
            ...
            <div style="font-size:10px;color:var(--accent);margin-top:var(--space-xs)">${g}% de victoires</div>
          </div>
          ...
          <div class="glass" style="padding:var(--space-lg);border-radius:var(--radius-lg);text-align:center">
            ...
            <div style="font-family:var(--font-title);font-size:24px;color:var(--star);font-weight:700;text-shadow:0 0 10px rgba(255,215,0,0.3)">
              ${m} <span style="font-size:14px;color:var(--text-secondary)">/ 32</span>
            </div>
...
Cette action est irréversible !`)&&f.reset()})}function yt(a,t="success"){const e=document.createElement("div");e.className=`toast toast--${t}`,e.textContent=a,document.body.appendChild(e),setTimeout(()=>e.remove(),3e3)}const Fi={subtitle:"Seuls les plus braves oseront y entrer"},Ui={coup_titan:{id:"coup_titan",name:"Coup Titanesque",type:"physical",power:200,accuracy:90,cooldown:8,icon:"💥",desc:"Frappe colossale qui ébranle le sol"},bouclier_seuil:{id:"bouclier_seuil",name:"Bouclier du Seuil",type:"buff",power:0,accuracy:100,cooldown:20,icon:"🛡️",desc:"Régénère un bouclier absorbant 30% des dégâts",effect:{type:"shield",value:.3,turns:999}},seisme_titan:{id:"seisme_titan",name:"Séisme Titanesque",type:"physical",power:120,accuracy:85,cooldown:15,aoe:!0,icon:"🌋",desc:"Écrase tous les ennemis"},rayon_oracle:{id:"rayon_oracle",name:"Rayon de l'Oracle",type:"magical",power:220,accuracy:95,cooldown:6,icon:"⚡",desc:"Rayon d'énergie pure dévastateur"},clone_oracle:{id:"clone_oracle",name:"Dédoublement",type:"special",power:0,accuracy:100,cooldown:30,icon:"👥",desc:"Crée un clone à 50% des HP du boss"},malediction:{id:"malediction",name:"Malédiction",type:"debuff",power:0,accuracy:90,cooldown:12,aoe:!0,icon:"🔮",desc:"Réduit l'ATK de toute l'équipe de 30%"},morsure_hydre:{id:"morsure_hydre",name:"Morsure de l'Hydre",type:"physical",power:180,accuracy:90,cooldown:5,icon:"🐉",desc:"Morsure venimeuse qui empoisonne"},triple_frappe:{id:"triple_frappe",name:"Triple Frappe",type:"physical",power:90,accuracy:80,cooldown:10,aoe:!0,icon:"🔱",desc:"Frappe 3 cibles simultanément"},enrage_hydre:{id:"enrage_hydre",name:"Enrage!",type:"buff",power:0,accuracy:100,cooldown:999,icon:"😡",desc:"À 30% HP: ATK +100%, SPD +50%"},lame_sacree:{id:"lame_sacree",name:"Lame Sacrée",type:"physical",power:240,accuracy:85,cooldown:8,icon:"⚔️",desc:"Tranche avec une lame bénie corrompue"},invisibilite_ange:{id:"invisibilite_ange",name:"Disparition Divine",type:"buff",power:0,accuracy:100,cooldown:25,icon:"🌫️",desc:"Devient invisible 5s puis frappe tous"},pluie_plumes:{id:"pluie_plumes",name:"Pluie de Plumes",type:"physical",power:80,accuracy:95,cooldown:8,aoe:!0,icon:"🪶",desc:"Pluie de plumes tranchantes"},frappe_abyssale:{id:"frappe_abyssale",name:"Frappe Abyssale",type:"physical",power:300,accuracy:90,cooldown:6,icon:"💀",desc:"Puissance des abysses"},vague_tenebres:{id:"vague_tenebres",name:"Vague de Ténèbres",type:"magical",power:180,accuracy:90,cooldown:10,aoe:!0,icon:"🌑",desc:"Vague d'obscurité dévastatrice"},domaine_samael:{id:"domaine_samael",name:"Domaine de Samaël",type:"special",power:0,accuracy:100,cooldown:999,icon:"🔴",desc:"Crée un domaine: tous perdent 3% HP/s"},absorption_ame:{id:"absorption_ame",name:"Absorption d'Âme",type:"heal",power:400,accuracy:100,cooldown:20,icon:"💜",desc:"Absorbe les âmes pour se soigner"},armageddon:{id:"armageddon",name:"Armageddon",type:"magical",power:350,accuracy:85,cooldown:15,aoe:!0,icon:"☄️",desc:"Déchaîne la fin du monde"},malédiction_finale:{id:"malédiction_finale",name:"Malédiction Finale",type:"debuff",power:0,accuracy:100,cooldown:20,aoe:!0,icon:"🌀",desc:"Réduit tous les stats de 50%"}},Ce=[{floor:1,name:"Le Gardien du Seuil",subtitle:"Porte-parole des anciens pactes",icon:"🏛️",bgGradient:"linear-gradient(180deg, #0d0d1f, #0a0a15)",accentColor:"#7777ff",minDuration:120,boss:{id:"gardien_seuil",name:"Gardien du Seuil",desc:"Le premier gardien du temple. Sa cuirasse absorbe les coups les plus puissants.",type:"guerrier",rarity:"legendaire",icon:"🏛️",phase:1,stats:{hp:12e3,maxHp:12e3,atk:180,def:200,spd:30,magAtk:80,magDef:150},skills:["coup_titan","bouclier_seuil","seisme_titan"],mechanics:{shieldRegen:{interval:20,value:.3},passiveHeal:{interval:3,amount:60}},rewards:{archireve:300,items:["armure_maragorh","ceinture_force"],xpBonus:200}},minions:[]},{floor:2,name:"L'Oracle Déchu",subtitle:"Il voit l'avenir mais ne peut l'éviter",icon:"🔮",bgGradient:"linear-gradient(180deg, #1a0a2a, #0d0520)",accentColor:"#aa44ff",minDuration:120,boss:{id:"oracle_dechu",name:"Oracle Déchu",desc:"Un voyant corrompu par sa propre prophétie. Quand il souffre, il se dédouble.",type:"mage",rarity:"legendaire",icon:"🔮",phase:1,stats:{hp:15e3,maxHp:15e3,atk:100,def:120,spd:55,magAtk:280,magDef:180},skills:["rayon_oracle","clone_oracle","malediction"],mechanics:{cloneAt:.5,passiveHeal:{interval:4,amount:75},magAtkBoost:{interval:30,value:.1}},rewards:{archireve:400,items:["baton_mage","orbe_enchantement"],xpBonus:280}},minions:[]},{floor:3,name:"L'Hydre des Ténèbres",subtitle:"Chaque blessure la rend plus furieuse",icon:"🐉",bgGradient:"linear-gradient(180deg, #0a1a0a, #050f05)",accentColor:"#22ff44",minDuration:120,boss:{id:"hydre_tenebres",name:"Hydre des Ténèbres",desc:"Une créature primordiale à trois têtes. Entamer sa vie déclenche son enrage.",type:"guerrier",rarity:"ultimate",icon:"🐉",phase:1,stats:{hp:2e4,maxHp:2e4,atk:250,def:160,spd:40,magAtk:120,magDef:100},skills:["morsure_hydre","triple_frappe"],mechanics:{enrageAt:.3,enrageSkills:["morsure_hydre","triple_frappe","enrage_hydre"],enrageStatBoost:{atk:1,spd:.5},passiveHeal:{interval:5,amount:100}},rewards:{archireve:550,items:["arc_elfique","dague_ombre"],xpBonus:380}},minions:[]},{floor:4,name:"L'Archange Corrompu",subtitle:"La lumière divine souillée par les ombres",icon:"😇",bgGradient:"linear-gradient(180deg, #1a1a0a, #0f0f05)",accentColor:"#ffdd44",minDuration:120,boss:{id:"archange_corrompu",name:"Archange Corrompu",desc:"Autrefois gardien des cieux, désormais serviteur des ombres. Frappe en toute impunité.",type:"assassin",rarity:"ultimate",icon:"😇",phase:1,stats:{hp:25e3,maxHp:25e3,atk:320,def:140,spd:110,magAtk:200,magDef:160},skills:["lame_sacree","invisibilite_ange","pluie_plumes"],mechanics:{invisPhase:{cooldown:25,duration:5,burstDamage:2},passiveHeal:{interval:4,amount:125}},rewards:{archireve:700,items:["sceptre_samael","anneau_rapidite"],xpBonus:500}},minions:[]},{floor:5,name:"SAMAËL",subtitle:"Le dieu déchu, maître de l'obscurité éternelle",icon:"☠️",bgGradient:"linear-gradient(180deg, #150008, #0a0005)",accentColor:"#ff2244",minDuration:180,boss:{id:"samael_final",name:"Samaël le Maudit",desc:"La forme finale de Samaël. Trois phases de pouvoir croissant. Ne le sous-estimez jamais.",type:"assassin",rarity:"ultimate",icon:"☠️",phase:1,currentPhase:1,stats:{hp:4e4,maxHp:4e4,atk:280,def:200,spd:90,magAtk:260,magDef:220},phase1Skills:["frappe_abyssale","vague_tenebres"],phase2Skills:["frappe_abyssale","vague_tenebres","domaine_samael","absorption_ame"],phase3Skills:["frappe_abyssale","armageddon","malédiction_finale","absorption_ame"],skills:["frappe_abyssale","vague_tenebres"],mechanics:{phases:[{hpThreshold:.66,activated:!1,label:"Phase I — Éveil"},{hpThreshold:.33,activated:!1,label:"Phase II — Domination"},{hpThreshold:0,activated:!1,label:"Phase III — Apocalypse"}],passiveHeal:{interval:3,amount:200},domain:{active:!1,damagePerSecond:.03}},rewards:{archireve:2e3,items:["phylactere_samael","egide_samael"],xpBonus:1e3,firstClear:{archireve:5e3,title:"Vainqueur de Samaël"}}},minions:[]}];function ji(a){return Ce.find(t=>t.floor===a)||null}function ht(a){return a.map(t=>Ui[t]||{id:t,name:t,type:"physical",power:100,accuracy:90,cooldown:5,icon:"💥"})}const R=100,wt=2e3;class Hi{constructor(t,e){this.floorData=e,this.minDuration=(e.minDuration||120)*1e3,this.startTime=null,this.elapsedTime=0,this.gameOver=!1,this.winner=null,this.running=!1,this.tickInterval=null,this.log=[],this.dpsTracker={},this.aggroTable={},this.playerTeam=t.map((r,n)=>({...r,stats:{...r.stats},currentHp:r.stats.hp,maxHp:r.stats.hp,alive:!0,buffs:[],debuffs:[],autoAttackTimer:wt-r.stats.spd*5,autoAttackCooldown:Math.max(800,wt-r.stats.spd*5),skillCooldowns:{},isPlayer:!0,x:80+n*5,y:80+n*90,aggro:0}));const i=e.boss;this.boss={...i,currentHp:i.stats.hp,maxHp:i.stats.hp,alive:!0,buffs:[],debuffs:[],skills:ht(i.skills||i.phase1Skills||[]),skillTimers:{},autoAttackTimer:Math.max(1e3,wt-i.stats.spd*5),autoAttackCooldown:Math.max(1e3,wt-i.stats.spd*5),isPlayer:!1,isBoss:!0,shieldValue:0,isInvisible:!1,invisTimer:0,currentPhase:1,enraged:!1,domainActive:!1,cloneCreated:!1},this.onTick=null,this.onSkillUsed=null,this.onLog=null,this.onPhaseChange=null,this.onBossAbility=null}start(){if(!this.running){this.startTime=Date.now(),this.running=!0,this.addLog("💀 L'Épreuve commence...");for(const t of this.boss.skills)this.boss.skillTimers[t.id]=(t.cooldown||10)*1e3*.3;this.tickInterval=setInterval(()=>this._tick(),R)}}pause(){this.running=!1}resume(){this.running=!0}stop(){this.running=!1,this.tickInterval&&(clearInterval(this.tickInterval),this.tickInterval=null)}_tick(){if(!this.running||this.gameOver)return;this.elapsedTime+=R;for(const e of this.playerTeam)if(e.alive){for(const i of Object.keys(e.skillCooldowns))e.skillCooldowns[i]=Math.max(0,e.skillCooldowns[i]-R);e.autoAttackTimer-=R,e.autoAttackTimer<=0&&(e.autoAttackTimer=e.autoAttackCooldown,this.boss.alive&&!this.boss.isInvisible&&this._doAutoAttack(e,this.boss)),this._tickStatusEffects(e)}if(this.boss.alive){if(this._checkBossPhases(),this._tickBossPassiveHeal(),this.boss.domainActive&&this._applyDomainDamage(),this.boss.isInvisible&&(this.boss.invisTimer-=R,this.boss.invisTimer<=0&&(this.boss.isInvisible=!1,this._doBossEmergeBurst())),this.boss.autoAttackTimer-=R,this.boss.autoAttackTimer<=0&&!this.boss.isInvisible){this.boss.autoAttackTimer=this.boss.autoAttackCooldown;const e=this._getBossTarget();e&&this._doBossAutoAttack(e)}for(const e of this.boss.skills)this.boss.skillTimers[e.id]||(this.boss.skillTimers[e.id]=0),this.boss.skillTimers[e.id]-=R,this.boss.skillTimers[e.id]<=0&&(this.boss.skillTimers[e.id]=(e.cooldown||10)*1e3,this._executeBossSkill(e))}if(this.playerTeam.filter(e=>e.alive).length===0){this._endCombat("enemy");return}if(!this.boss.alive)if(this.elapsedTime<this.minDuration)this.boss.currentHp=Math.floor(this.boss.maxHp*.25),this.boss.alive=!0,this.addLog(`⚠️ ${this.boss.name} refuse de mourir si vite !`),this.onBossAbility?.({type:"revive",boss:this.boss});else{this._endCombat("player");return}this.onTick?.({playerTeam:this.playerTeam,boss:this.boss,elapsedTime:this.elapsedTime,dpsTracker:this.dpsTracker,minDuration:this.minDuration})}activateSkill(t,e){const i=this.playerTeam.find(d=>d.id===t);if(!i||!i.alive)return!1;const r=i.skills[e];if(!r)return!1;const n=`${e}`;if((i.skillCooldowns[n]||0)>0)return!1;const s=this._executePlayerSkill(i,r);return i.skillCooldowns[n]=(r.cooldown||3)*1e3,s}_executePlayerSkill(t,e){const i={caster:t.id,skill:e.id,hits:[]};if(e.type==="heal"){const r=[...this.playerTeam.filter(s=>s.alive)].sort((s,d)=>s.currentHp/s.maxHp-d.currentHp/d.maxHp)[0],n=Math.floor(e.power*(1+t.stats.magAtk/200));r.currentHp=Math.min(r.maxHp,r.currentHp+n),this.addLog(`💚 ${t.name} soigne ${r.name} +${n} PV`),i.hits.push({target:r.id,heal:n})}else if(e.type==="buff"){const r=e.effect?.aoe?this.playerTeam.filter(n=>n.alive):[t];for(const n of r)e.effect?.stat&&n.buffs.push({stat:e.effect.stat,boost:e.effect.boost,durationMs:e.effect.turns*2e3,remainingMs:e.effect.turns*2e3});this.addLog(`✨ ${t.name} utilise ${e.name}`)}else{const r=e.aoe?[this.boss]:[this.boss];for(const n of r){if(!n.alive)continue;const s=this._calcDamage(t,n,e);this._applyDamageToTarget(n,s,t,e),i.hits.push({target:n.id,damage:s.amount,isCrit:s.isCrit})}}return this.onSkillUsed?.(i),i}_doAutoAttack(t,e){const i=Math.floor(t.stats.atk/(e.stats.def+50)*60*(.9+Math.random()*.2)),r=Math.max(1,i);this._applyDamageToTarget(e,{amount:r,isCrit:!1},t,{type:"physical",id:"auto"})}_doBossAutoAttack(t){const e=this.boss,i=Math.floor(e.stats.atk/(t.stats.def+50)*80*(.85+Math.random()*.3)),r=Math.random()<.08,n=Math.max(1,r?Math.floor(i*1.5):i);t.currentHp-=n,this.addLog(`👹 ${e.name} frappe ${t.name} -${n}${r?" CRIT!":""}`),t.currentHp<=0&&(t.currentHp=0,t.alive=!1,this.addLog(`💀 ${t.name} tombe !`))}_calcDamage(t,e,i){const r=i.type==="magical"?t.stats.magAtk:t.stats.atk;let n=i.type==="magical"?e.stats.magDef:e.stats.def;e.shieldValue>0&&(n+=100);let s=Math.floor(r*(i.power||80)/(n+50)*(.85+Math.random()*.3));i.aoe&&(s=Math.floor(s*.7));const d=10+(t.type==="assassin"?15:0),o=Math.random()*100<d;return o&&(s=Math.floor(s*1.5)),{amount:Math.max(1,s),isCrit:o}}_applyDamageToTarget(t,e,i,r){let{amount:n}=e;if(t.shieldValue>0){const s=Math.min(t.shieldValue,Math.floor(n*.4));t.shieldValue-=s,n-=s}t.currentHp=Math.max(0,t.currentHp-n),i.isPlayer&&(this.dpsTracker[i.id]=(this.dpsTracker[i.id]||0)+n,this.aggroTable[t.id]=this.aggroTable[t.id]||{},this.aggroTable[t.id][i.id]=(this.aggroTable[t.id][i.id]||0)+n,i.type==="guerrier"&&(this.aggroTable[t.id][i.id]*=1.5)),t.currentHp<=0&&(t.alive=!1)}_getBossTarget(){const t=this.playerTeam.filter(n=>n.alive);if(t.length===0)return null;const e=this.aggroTable[this.boss.id]||{};let i=-1,r=null;for(const n of t){const s=e[n.id]||0;s>i&&(i=s,r=n)}return!r||i<10?t.find(s=>s.type==="guerrier")||t[Math.floor(Math.random()*t.length)]:r}_executeBossSkill(t){if(!this.boss.alive)return;const e=this.playerTeam.filter(r=>r.alive);if(e.length===0)return;if(t.type==="special"){this._handleBossSpecial(t);return}if(t.type==="debuff"){this._handleBossDebuff(t);return}if(t.type==="buff"){this._handleBossBuff(t);return}const i=t.aoe?e:[this._getBossTarget()].filter(Boolean);for(const r of i){const n=this._calcDamage(this.boss,r,t);r.currentHp=Math.max(0,r.currentHp-n.amount),r.currentHp<=0&&(r.alive=!1,this.addLog(`💀 ${r.name} tombe !`))}this.addLog(`⚡ ${this.boss.name} utilise ${t.name}!`),this.onSkillUsed?.({caster:this.boss.id,skill:t.id,targets:i.map(r=>r.id)})}_handleBossSpecial(t){t.id==="clone_oracle"?this.boss.cloneCreated||(this.boss.cloneCreated=!0,this.addLog("👥 L'Oracle se dédouble !"),this.onBossAbility?.({type:"clone",boss:this.boss})):t.id==="domaine_samael"&&(this.boss.domainActive||(this.boss.domainActive=!0,this.addLog("🔴 Samaël active son Domaine ! Vous perdez 3% HP/s !"),this.onBossAbility?.({type:"domain",boss:this.boss})))}_handleBossDebuff(t){const e=this.playerTeam.filter(r=>r.alive),i=t.aoe?e:[this._getBossTarget()].filter(Boolean);for(const r of i)if(t.id==="malediction")r.buffs.push({stat:"atk",boost:-.3,durationMs:8e3,remainingMs:8e3,type:"debuff"});else if(t.id==="malédiction_finale")for(const n of["atk","magAtk","def","spd"])r.buffs.push({stat:n,boost:-.5,durationMs:15e3,remainingMs:15e3,type:"debuff"});this.addLog(`🔮 ${this.boss.name} lance ${t.name} !`),this.onBossAbility?.({type:"debuff",skill:t})}_handleBossBuff(t){if(t.id==="bouclier_seuil")this.boss.shieldValue=Math.floor(this.boss.maxHp*.3),this.addLog(`🛡️ ${this.boss.name} génère un bouclier !`),this.onBossAbility?.({type:"shield",value:this.boss.shieldValue});else if(t.id==="invisibilite_ange")this.boss.isInvisible=!0,this.boss.invisTimer=5e3,this.addLog("🌫️ L'Archange disparaît dans l'ombre..."),this.onBossAbility?.({type:"invisible"});else if(t.id==="absorption_ame"){const e=Math.min(t.power,this.boss.maxHp-this.boss.currentHp);this.boss.currentHp=Math.min(this.boss.maxHp,this.boss.currentHp+e),this.addLog(`💜 Samaël absorbe les âmes (+${e} PV)`),this.onBossAbility?.({type:"heal",amount:e})}}_doBossEmergeBurst(){const t=this.playerTeam.filter(i=>i.alive);let e=0;for(const i of t){const r=Math.floor(this.boss.stats.atk*2*(.9+Math.random()*.2));i.currentHp=Math.max(0,i.currentHp-r),i.currentHp<=0&&(i.alive=!1),e+=r}this.addLog("💥 L'Archange surgit ! Burst sur toute l'équipe !"),this.onBossAbility?.({type:"emerge_burst",totalDmg:e})}_checkBossPhases(){const t=this.boss.currentHp/this.boss.maxHp,e=this.boss.mechanics||{};if(e.enrageAt&&!this.boss.enraged&&t<=e.enrageAt){if(this.boss.enraged=!0,e.enrageStatBoost)for(const[i,r]of Object.entries(e.enrageStatBoost))this.boss.stats[i]=Math.floor(this.boss.stats[i]*(1+r));e.enrageSkills&&(this.boss.skills=ht(e.enrageSkills)),this.addLog(`😡 ${this.boss.name} entre en mode ENRAGE !`),this.onPhaseChange?.({boss:this.boss,newPhase:"enrage"})}this.boss.id==="samael_final"&&(t<=.33&&this.boss.currentPhase<3?(this.boss.currentPhase=3,this.boss.skills=ht(this.floorData.boss.phase3Skills||[]),this.addLog("☠️ SAMAËL — PHASE III : APOCALYPSE !"),this.onPhaseChange?.({boss:this.boss,newPhase:3})):t<=.66&&this.boss.currentPhase<2&&(this.boss.currentPhase=2,this.boss.skills=ht(this.floorData.boss.phase2Skills||[]),this.addLog("🌑 SAMAËL — PHASE II : DOMINATION !"),this.boss.domainActive=!0,this.onPhaseChange?.({boss:this.boss,newPhase:2})))}_tickBossPassiveHeal(){const t=this.boss.mechanics?.passiveHeal;if(t&&(this._passiveHealTimer||(this._passiveHealTimer=t.interval*1e3),this._passiveHealTimer-=R,this._passiveHealTimer<=0)){this._passiveHealTimer=t.interval*1e3;const e=t.amount;this.boss.currentHp=Math.min(this.boss.maxHp,this.boss.currentHp+e)}}_applyDomainDamage(){const e=(this.boss.mechanics?.domain?.damagePerSecond||.03)*R/1e3;for(const i of this.playerTeam){if(!i.alive)continue;const r=Math.max(1,Math.floor(i.maxHp*e));i.currentHp=Math.max(0,i.currentHp-r),i.currentHp<=0&&(i.alive=!1)}}_tickStatusEffects(t){t.buffs=(t.buffs||[]).filter(e=>e.durationMs!==void 0?(e.remainingMs-=R,e.remainingMs>0):!0)}_tickShieldRegen(){const t=this.boss.mechanics?.shieldRegen;t&&(this._shieldRegenTimer||(this._shieldRegenTimer=t.interval*1e3),this._shieldRegenTimer-=R,this._shieldRegenTimer<=0&&this.boss.shieldValue===0&&(this._shieldRegenTimer=t.interval*1e3,this.boss.shieldValue=Math.floor(this.boss.maxHp*t.value),this.addLog(`🛡️ Le bouclier du ${this.boss.name} se régénère !`),this.onBossAbility?.({type:"shield",value:this.boss.shieldValue})))}_endCombat(t){this.gameOver=!0,this.winner=t,this.stop();const e=Math.floor(this.elapsedTime/1e3);t==="player"?this.addLog(`🏆 Victoire ! Temps: ${Math.floor(e/60)}m${String(e%60).padStart(2,"0")}s`):this.addLog(`💀 Défaite après ${Math.floor(e/60)}m${String(e%60).padStart(2,"0")}s`),this.onTick?.({playerTeam:this.playerTeam,boss:this.boss,elapsedTime:this.elapsedTime,dpsTracker:this.dpsTracker,minDuration:this.minDuration,gameOver:!0,winner:t})}addLog(t){this.log.push({message:t,time:this.elapsedTime}),this.onLog?.(t)}getElapsedSeconds(){return Math.floor(this.elapsedTime/1e3)}getSummary(){return{won:this.winner==="player",duration:this.elapsedTime,dpsTracker:this.dpsTracker,playerTeamState:this.playerTeam,bossState:this.boss}}getSkillCooldownPct(t,e){const i=this.playerTeam.find(o=>o.id===t);if(!i)return 0;const r=i.skills[e];if(!r)return 0;const n=`${e}`,s=i.skillCooldowns[n]||0,d=(r.cooldown||3)*1e3;return s/d}getAutoAttackProgress(t){const e=this.playerTeam.find(i=>i.id===t);return e?1-e.autoAttackTimer/e.autoAttackCooldown:0}}let nt=null,Vt=!1,Xt=1;function ot(){nt&&(clearInterval(nt),nt=null),Vt=!1,Xt=1}function Ni(a,t,e,i){ot();const r=t.floor===5;a.innerHTML=`
  ...
  `,document.getElementById("flee-btn").addEventListener("click",()=>{confirm("Fuir l'épreuve ?")&&(ot(),i())}),Ki(t),Gi(t)}function Gi(a,t){let e=0;nt=setInterval(()=>{const i=document.getElementById("attack-lane");if(!i){clearInterval(nt);return}e++,e%2===0?qi(i,a):Vi(i,a),e%4===0&&Me(i)},1100)}function qi(a,t){const e=["#4ADE80","#60A5FA","#FBBF24","#F87171","#A78BFA","#34D399"],i=e[Math.floor(Math.random()*e.length)],r=30+Math.random()*25,n=document.createElement("div");n.style.cssText=`position:absolute;left:180px;top:${r}%;
    ...
    animation:projRight 0.5s cubic-bezier(0.25,0.1,0.85,1) forwards;z-index:10`,a.appendChild(n),setTimeout(()=>{n.remove(),Ae(a,"72%",r,i,"right");const s=document.getElementById("boss-sprite");s&&(s.style.animation="bossHitFlash 0.35s ease-out",setTimeout(()=>{s.style.animation=`bossRage ${t.floor===5?"1.8":"3"}s ease-in-out infinite`},360))},470)}function Vi(a,t){const e=t.accentColor||"#ff2244",i=32+Math.random()*22,r=document.createElement("div");r.style.cssText=`position:absolute;right:200px;top:${i}%;
    ...
    animation:projLeft 0.48s cubic-bezier(0.25,0.1,0.85,1) forwards;z-index:10`,a.appendChild(r),setTimeout(()=>{r.remove(),Ae(a,"12%",i,e,"left"),ae()},460)}function Ae(a,t,e,i,r){const n=document.createElement("div");n.style.cssText=`position:absolute;${r}:${t};top:${e}%;
    ...
    animation:impactBurst 0.4s ease-out forwards;z-index:11`,a.appendChild(n),setTimeout(()=>n.remove(),420)}function Me(a){const t=document.createElement("div");t.style.cssText=`position:absolute;bottom:168px;left:8%;height:2px;width:0;
    background:linear-gradient(90deg,transparent,rgba(255,80,0,0.9),rgba(255,200,0,0.7),transparent);
    animation:groundCrack 0.7s ease-out forwards;z-index:12;pointer-events:none`,a.appendChild(t),setTimeout(()=>t.remove(),720)}function ae(){const a=document.getElementById("dungeon-combat-screen");a&&(a.style.animation="hellShake 0.32s ease-out",setTimeout(()=>{a.style.animation=""},340))}function Xi(a,t,e){const{playerTeam:i,boss:r,elapsedTime:n,dpsTracker:s,minDuration:d,gameOver:o,winner:l}=a,c=Math.floor(n/1e3),p=Math.max(0,r.currentHp/r.maxHp*100),g=document.getElementById("boss-hp-bar");g&&(g.style.width=`${p}%`,g.style.background=p>60?"linear-gradient(90deg,#990020,#dd2244,#ff6644)":p>30?"linear-gradient(90deg,#cc4400,#ff6600,#ffaa00)":"linear-gradient(90deg,#660000,#aa0000,#ff2200)");const m=document.getElementById("boss-hp-text");m&&(m.textContent=`${Math.max(0,r.currentHp).toLocaleString()} / ${r.maxHp.toLocaleString()}`);const u=document.getElementById("boss-shield-text");u&&(u.textContent=r.shieldValue>0?`🛡️ ${r.shieldValue.toLocaleString()}`:"");const v=r.currentPhase||1;v!==Xt&&(Xt=v,Yi(v));const h=document.getElementById("boss-phase-badge");if(h){const b={1:"PHASE I",2:"⚡ PHASE II",3:"💀 PHASE III — ARMAGEDDON"};h.textContent=b[v]||"",h.style.color=v===3?"#ff2244":v===2?"#cc44ff":t.accentColor}if(t.floor===5&&v>=2&&!Vt){Vt=!0;const b=document.getElementById("domain-overlay");b&&(b.style.display="block");const E=document.getElementById("boss-domain-sigil");E&&(E.style.opacity="1")}const x=document.getElementById("timer-display");x&&(x.textContent=`⏱️ ${Math.floor(c/60)}:${String(c%60).padStart(2,"0")}`);const A=document.getElementById("min-timer-display");if(A){const b=Math.max(0,Math.floor(d/1e3)-c);A.textContent=b>0?`⏳ ${Math.floor(b/60)}:${String(b%60).padStart(2,"0")} restant`:"✅ Durée ok",A.style.color=b>0?"#ff8800":"#4ADE80"}const D=document.getElementById("boss-invisible-overlay");D&&(D.style.display=r.isInvisible?"block":"none");const M=document.getElementById("boss-sprite");M&&(M.style.opacity=r.isInvisible?"0.12":"1");const B=document.getElementById("player-sprites");B&&(B.innerHTML=i.map(b=>{const E=Math.max(0,b.currentHp/b.maxHp*100);return`
        <div id="ps-${b.id}" style="display:flex;align-items:center;gap:8px;
          opacity:${b.alive?1:.2};transition:opacity 0.5s">
          <div style="position:relative">
            <img src="${C(b.type)}" style="width:70px;height:70px;image-rendering:pixelated;
              filter:drop-shadow(0 0 12px ${b.alive?"rgba(100,200,255,0.55)":"rgba(255,0,0,0.2)"})
              ${b.alive?"":"grayscale(1)"};transition:filter 0.3s">
            ...
            ${b.alive?"":'<div style="position:absolute;inset:0;display:flex;align-items:center;justify-content:center;font-size:22px">💀</div>'}
          </div>
        </div>`}).join(""));const z=document.getElementById("player-hud-bottom");z&&(z.innerHTML=i.map(b=>{const E=Math.max(0,b.currentHp/b.maxHp*100),Y=s[b.id]||0,Rt=e?e.getAutoAttackProgress(b.id)*100:0;return`<div style="flex:1;background:rgba(15,0,5,0.85);border-radius:8px;padding:8px;
        border:1px solid ${b.alive?"rgba(180,10,20,0.35)":"rgba(60,0,0,0.4)"}">
        <div style="display:flex;align-items:center;gap:6px;margin-bottom:5px">
          <img src="${C(b.type)}" style="width:26px;height:26px;image-rendering:pixelated;${b.alive?"":"filter:grayscale(1);opacity:0.35"}">
          <div>
            <div style="font-size:9px;font-weight:700;color:var(--${b.rarity})">${b.name.split(" ")[0]}</div>
            <div style="font-size:8px;color:rgba(255,255,255,0.35)">${Y>0?Math.round(Y/Math.max(1,c))+" DPS":b.type}</div>
          </div>
        </div>
        ...
        <div style="height:3px;background:rgba(255,255,255,0.06);border-radius:2px;margin-bottom:5px;overflow:hidden">
          <div style="height:100%;width:${Rt}%;background:rgba(255,200,50,0.75);transition:width 0.1s linear;border-radius:2px"></div>
        </div>
        <div style="display:flex;gap:3px;flex-wrap:wrap">
          ${(b.skills||[]).slice(0,4).map((Ue,oe)=>{const Pt=e?e.getSkillCooldownPct(b.id,oe)*100:0;return`<button class="dsk" data-char="${b.id}" data-skill="${oe}"
  ...
  `,setTimeout(()=>{const l=document.getElementById("vp");if(l)for(let c=0;c<65;c++){const p=document.createElement("div"),g=4+Math.random()*8,m=Math.random()*100,u=Math.random()*3.5,v=2.5+Math.random()*4,h=["#FFD700","#FFA500","#FFED4E","#fff","#FFC107"];p.style.cssText=`position:absolute;top:-20px;left:${m}%;width:${g}px;height:${g}px;border-radius:50%;
        background:${h[Math.floor(Math.random()*h.length)]};
        animation:goldRain ${v}s ${u}s linear infinite`,l.appendChild(p)}},300),document.getElementById("victory-btns")}function Qi(a){const t=document.getElementById("dungeon-result-overlay");if(t)return t.style.cssText="position:absolute;inset:0;z-index:100",t.innerHTML=`
  ...
  `,document.getElementById("defeat-btns")}function Ki(a){const t=document.getElementById("dungeon-particles");if(!t)return;const e=["ᚱ","ᚷ","ᛏ","ᚦ","ᛉ","☽","☿","⊕","❋","✦","⋆"];for(let i=0;i<28;i++){const r=document.createElement("div"),n=Math.random()*100,s=2+Math.random()*3.5,d=Math.random()*14,o=1.5+Math.random()*3;r.style.cssText=`position:absolute;left:${n}%;bottom:162px;width:${s}px;height:${s}px;
      ...
      text-shadow:0 0 10px ${a.accentColor}`,r.textContent=e[Math.floor(Math.random()*e.length)],t.appendChild(r)}}let I=null;function Ji(){I=null,St()}function St(){const a=document.getElementById("app"),t=f.getTeamInstances();a.innerHTML=`
    <div class="screen" style="background:linear-gradient(180deg,#0a0010,#050005)">
      <div class="topbar" style="background:rgba(10,0,20,0.9);border-bottom:1px solid rgba(255,34,68,0.2)">
        ...
        <div class="currency"><span>⭐</span><span>${f.state.archireve.toLocaleString()}</span></div>
      </div>
      ...
      <div class="content" style="display:flex;flex-direction:column;align-items:center;gap:var(--space-xl);padding:var(--space-xl) var(--space-lg)">
        ...
        <div style="background:rgba(255,34,68,0.08);border:1px solid rgba(255,34,68,0.3);border-radius:var(--radius-xl);padding:var(--space-lg);text-align:center;max-width:600px;width:100%">
          ...
          <div style="font-size:12px;color:#ff8899;line-height:1.6">${Fi.subtitle}</div>
  ...
  `,document.getElementById("back-btn").addEventListener("click",()=>w.navigate("home")),document.querySelectorAll(".floor-enter-btn").forEach(e=>{e.addEventListener("click",()=>{const i=parseInt(e.dataset.floor);Wt(i)})})}function ta(a){const t=f.getDungeonFloorProgress(a.floor),e=f.isDungeonFloorUnlocked(a.floor),i=a.floor===5,r=t.clears>0,n=t.bestTime?`${Math.floor(t.bestTime/60)}m${String(t.bestTime%60).padStart(2,"0")}s`:"——";return`
  ...
  `}function Wt(a){const t=ji(a);if(!t)return;const e=f.getTeamInstances();if(e.length===0){ia("Votre équipe est vide !","error");return}ot(),I&&(I.stop(),I=null),I=new Hi(e,t);let i=!1;I.onTick=n=>{Xi(n,t,I),n.gameOver&&!i&&(i=!0,ot(),I?.stop(),setTimeout(()=>ea(n.winner,t,Math.floor(n.elapsedTime/1e3)),500))},I.onLog=n=>Wi(n),I.onPhaseChange=n=>Yt(n),I.onBossAbility=n=>Yt(n);const r=document.getElementById("app");Ni(r,t,I,()=>{ot(),I?.stop(),I=null,St()}),I.start()}function ea(a,t,e){if(a==="player"){const i=f.recordDungeonClear(t.floor,e),r=i.isFirstClear?1:.3,n=Math.floor((t.boss.rewards?.archireve||300)*r);f.addArchireve(n);const s=Math.floor(qe({isDungeon:!0,dungeonFloor:t.floor})*r),d=f.addTeamXp(s);let o=null;const l=t.boss.rewards?.items||[];if(i.isFirstClear&&l.length>0){const p=l[Math.floor(Math.random()*l.length)];_[p]&&(o=_[p],f.addItem(p))}f.recordBattle(!0);const c=Zi(t,i,{archireveEarned:n,xpAmount:s,xpResults:d,itemEarned:o});if(c){if(t.floor<5){const g=document.createElement("button");g.textContent=`→ ÉTAGE ${t.floor+1}`,g.style.cssText="padding:14px 32px;font-family:var(--font-title);font-size:13px;letter-spacing:3px;background:linear-gradient(135deg,rgba(255,200,0,0.3),rgba(255,100,0,0.2));border:1px solid rgba(255,200,0,0.4);border-radius:8px;color:#FFD700;cursor:pointer",g.addEventListener("click",()=>Wt(t.floor+1)),c.appendChild(g)}const p=document.createElement("button");p.textContent="◀ RETOUR",p.style.cssText="padding:14px 32px;font-family:var(--font-title);font-size:13px;letter-spacing:3px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.12);border-radius:8px;color:rgba(255,255,255,0.6);cursor:pointer",p.addEventListener("click",()=>{I=null,St()}),c.appendChild(p)}}else{f.recordBattle(!1);const i=Qi(t);if(i){const r=document.createElement("button");r.textContent="🔄 RÉESSAYER",r.style.cssText="padding:14px 32px;font-family:var(--font-title);font-size:13px;letter-spacing:3px;background:linear-gradient(135deg,rgba(180,0,20,0.35),rgba(80,0,0,0.45));border:1px solid rgba(180,0,20,0.45);border-radius:8px;color:#ff4444;cursor:pointer",r.addEventListener("click",()=>Wt(t.floor)),i.appendChild(r);const n=document.createElement("button");n.textContent="◀ RETOUR",n.style.cssText="padding:14px 32px;font-family:var(--font-title);font-size:13px;letter-spacing:3px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.1);border-radius:8px;color:rgba(255,255,255,0.5);cursor:pointer",n.addEventListener("click",()=>{I=null,St()}),i.appendChild(n)}}}function ia(a,t="success"){const e=document.createElement("div");e.className=`toast toast--${t}`,e.textContent=a,document.body.appendChild(e),setTimeout(()=>e.remove(),3e3)}function aa(){const a=document.getElementById("app");try{et(a,null)}catch(t){console.error("[InventoryScreen] Crash:",t),a.innerHTML=`
      ...
      </div>`,document.getElementById("err-back")?.addEventListener("click",()=>w.navigate("home"))}}function et(a,t){const e=f.getOwnedInstances(),i=f.getInventoryItems(),r=t?e.find(n=>n.id===t):null;a.innerHTML=`
    <div class="screen">
      <div class="topbar">
        <button class="topbar__back" id="back-btn">◀</button>
        <div class="topbar__title">🎒 Inventaire</div>
          ...
          <div style="display:flex;flex-wrap:wrap;gap:8px">
            ${e.map(n=>`
              <div class="glass char-picker-btn ${t===n.id?"char-picker-btn--active":""}"
                ...
                <img src="${C(n.type)}" style="width:32px;height:32px;image-rendering:pixelated">
                <div>
  ...
  `,document.getElementById("back-btn").addEventListener("click",()=>w.navigate("home")),document.querySelectorAll(".char-picker-btn").forEach(n=>{n.addEventListener("click",()=>{et(a,n.dataset.char)})}),document.querySelectorAll(".btn-equip").forEach(n=>{n.addEventListener("click",()=>{const{instanceId:s,charId:d}=n.dataset;f.equipItem(d,s)&&(Ft("Objet équipé !","success"),et(a,d))})}),document.querySelectorAll(".btn-unequip").forEach(n=>{n.addEventListener("click",()=>{const{charId:s,slot:d}=n.dataset;f.unequipItem(s,d),Ft("Objet retiré","warning"),et(a,s)})}),document.getElementById("dev-add-items")?.addEventListener("click",()=>{["epee_rouille","baton_mage","robe_arcane","anneau_rapidite","talisman_nature","dague_ombre"].forEach(s=>f.addItem(s)),Ft("Objets ajoutés !","success"),et(a,t)})}function ra(a,t){const e=f.getCharacterEquipped(a.id),i=f.getCharacterBonusStats(a.id);return`
    <div class="glass" style="padding:var(--space-md);border-radius:var(--radius-xl)">
      ...
      ${Object.entries(K).map(([r,n])=>{const s=e[r],d=s?t.find(c=>c.instanceId===s):null,o=d?d.fusedData||_[d.itemId]||d:null,l=o?H[o.rarity]||H.rare:null;return`
  ...
  `}function na(a,t,e){const i=H[a.rarity]||H.rare,r=K[a.slot];let n=!1;if(e){const o=f.getCharacterEquipped(e.id);n=Object.values(o).includes(a.instanceId)}const d=(e?f.getCharacterEquipped(e.id):{})[a.slot];return`
  ...
  `}function Ft(a,t="success"){const e=document.createElement("div");e.className=`toast toast--${t}`,e.textContent=a,document.body.appendChild(e),setTimeout(()=>e.remove(),3e3)}let X="characters",$=null,k=null;const gt={rare:"#4a9eff",epique:"#c44aff",legendaire:"#ffb84a",ultimate:"#ff4a4a",semi_ultimate:"#FF6B2C",supreme:"#FF1493"};function Ct(){$=null,k=null;const a=document.getElementById("app");a.innerHTML=Le(),Re()}function Le(){const a=f.state,t=a.ownedCharacters.filter(o=>{const l=L.find(c=>c.id===o.id)||f.getFusedCharacterData(o.id);return l&&(l.rarity==="legendaire"||l.rarity==="ultimate")}),e=(a.inventory||[]).filter(o=>{const l=o.fusedData||_[o.itemId];return l&&(l.rarity==="legendaire"||l.rarity==="ultimate")}),i=da(),r=pa(),n=i&&r&&i.rarity===r.rarity,s=X==="characters",d=n?Be():null;return'<div class="screen" style="background:var(--bg-primary);display:flex;flex-direction:column;height:100vh;overflow:hidden;background-image:radial-gradient(ellipse at 50% 80%,rgba(192,57,11,0.08),transparent 55%)"><div class="topbar" style="width:100%;position:relative;z-index:10;flex-shrink:0"><button class="topbar__back" id="forge-back">&#9664;</button><div class="topbar__title" style="letter-spacing:4px">⚒ FORGE DE FUSION</div><div></div></div><div style="display:flex;justify-content:center;gap:8px;padding:12px 20px 8px;flex-shrink:0"><button class="btn '+(s?"btn--primary":"btn--ghost")+'" id="tab-chars" style="padding:10px 28px;font-size:11px;letter-spacing:2px">⚔ PERSONNAGES</button><button class="btn '+(s?"btn--ghost":"btn--primary")+'" id="tab-items" style="padding:10px 28px;font-size:11px;letter-spacing:2px">📦 ITEMS</button></div><div style="display:flex;flex:1;overflow:hidden;gap:0"><div style="width:420px;flex-shrink:0;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:24px;border-right:1px solid rgba(200,155,60,0.06)"><div style="font-family:var(--font-title);font-size:10px;letter-spacing:4px;color:var(--text-muted);margin-bottom:20px">— FUSION —</div><div style="display:flex;align-items:center;gap:20px">'+ue(i,1)+'<div style="font-size:28px;color:var(--text-muted)">+</div>'+ue(r,2)+'</div><div style="margin:20px 0;font-size:24px;color:var(--accent)">⇣</div>'+(d?oa(d):'<div style="width:180px;height:100px;border:2px dashed rgba(200,155,60,0.08);border-radius:12px;display:flex;align-items:center;justify-content:center;color:var(--text-muted);font-size:12px;letter-spacing:1px">Résultat</div>')+'<div style="margin-top:20px;padding:14px 20px;background:rgba(0,0,0,0.3);border-radius:10px;border:1px solid rgba(200,155,60,0.06);max-width:350px"><div style="font-family:var(--font-stat);font-size:9px;color:var(--legendaire);letter-spacing:2px;margin-bottom:8px">RÈGLES DE FUSION</div><div style="font-size:10px;color:var(--text-secondary);line-height:1.8">⚔ Légendaire + Légendaire → <span style="color:#FF6B2C;font-weight:700">Semi-Ultimate</span> (stats ×2)<br>🔥 Ultimate + Ultimate → <span style="color:#FF1493;font-weight:700">Suprême Divin</span> (stats ×10)</div></div><button class="btn btn--star btn--large" id="fuse-btn" style="margin-top:24px;padding:16px 48px;font-size:14px;letter-spacing:3px" '+(n?"":"disabled")+'>⚒ FUSIONNER</button></div><div style="flex:1;overflow-y:auto;padding:20px"><div style="font-family:var(--font-title);font-size:10px;letter-spacing:3px;color:var(--text-muted);margin-bottom:12px">'+(s?"— PERSONNAGES ELIGIBLES ("+t.length+") —":"— ITEMS ÉLIGIBLES ("+e.length+") —")+'</div><div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(130px,1fr));gap:10px">'+(s?sa(t):la(e))+"</div></div></div></div>"}function ue(a,t){if(!a)return'<div class="forge-slot forge-slot--empty" data-slot="'+t+'" style="width:130px;height:150px;border:2px dashed rgba(200,155,60,0.15);border-radius:12px;display:flex;flex-direction:column;align-items:center;justify-content:center;cursor:pointer;background:rgba(0,0,0,0.2);transition:all 0.15s"><div style="font-size:32px;opacity:0.3;margin-bottom:8px">+</div><div style="font-size:9px;color:var(--text-muted);letter-spacing:1px">SLOT '+t+"</div></div>";const e=gt[a.rarity]||"#aaa",i=!!a.type&&!a.slot;return'<div class="forge-slot" data-slot="'+t+'" data-selected="true" style="width:130px;height:150px;border:2px solid '+e+'40;border-radius:12px;display:flex;flex-direction:column;align-items:center;justify-content:center;cursor:pointer;background:rgba(0,0,0,0.3);position:relative;transition:all 0.15s">'+(i?'<img src="'+C(a.type.split("/")[0])+'" style="width:48px;height:48px;filter:drop-shadow(0 0 8px '+e+'60)">':'<div style="font-size:36px;filter:drop-shadow(0 0 8px '+e+'60)">'+(a.icon||"📦")+"</div>")+'<div style="font-family:var(--font-ui);font-size:10px;font-weight:700;color:'+e+';margin-top:8px;text-align:center;padding:0 4px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:120px">'+a.name+'</div><div style="font-size:8px;color:var(--text-muted);letter-spacing:1px;margin-top:2px">'+a.rarity.toUpperCase()+'</div><button class="forge-slot-clear" data-clear="'+t+'" style="position:absolute;top:4px;right:4px;width:20px;height:20px;border:none;background:rgba(220,38,38,0.5);color:white;border-radius:50%;font-size:10px;cursor:pointer;display:flex;align-items:center;justify-content:center">✕</button></div>'}function oa(a){const t=gt[a.rarity]||"#FF6B2C",e=Object.entries(a.stats||{}).map(function(i){return'<span style="color:'+t+'">'+i[0].toUpperCase()+"</span> "+i[1]}).join(" · ");return'<div style="width:220px;padding:16px;border:2px solid '+t+'30;border-radius:12px;background:rgba(0,0,0,0.4);text-align:center"><div style="font-family:var(--font-stat);font-size:8px;color:'+t+';letter-spacing:3px;margin-bottom:6px">'+a.rarity.toUpperCase().replace("_","-")+'</div><div style="font-family:var(--font-title);font-size:14px;color:var(--text-bright);margin-bottom:8px">'+a.name+'</div><div style="font-size:9px;color:var(--text-secondary);line-height:1.6">'+e+"</div></div>"}function sa(a){return a.map(t=>{const e=L.find(n=>n.id===t.id)||f.getFusedCharacterData(t.id);if(!e)return"";const i=gt[e.rarity]||"#aaa",r=$===t.id||k===t.id;return'<button class="forge-grid-item" data-char-id="'+t.id+'" style="padding:12px 8px;text-align:center;border-radius:8px;cursor:pointer;border:1px solid '+(r?i:"rgba(200,155,60,0.06)")+";background:"+(r?"rgba(192,57,11,0.15)":"rgba(10,6,3,0.6)")+';color:var(--text-primary);transition:all 0.15s"><img src="'+C(e.type.split("/")[0])+'" style="width:40px;height:40px;filter:drop-shadow(0 0 6px '+i+'40)"><div style="font-family:var(--font-ui);font-size:9px;font-weight:700;color:'+i+';margin-top:6px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis">'+e.name.split(" ")[0]+'</div><div style="font-size:8px;color:var(--text-muted);letter-spacing:1px">LV.'+t.level+'</div><div style="font-size:7px;color:'+i+';letter-spacing:1px;margin-top:2px">'+e.rarity.toUpperCase()+"</div></button>"}).join("")}function la(a){return a.map(t=>{const e=t.fusedData||_[t.itemId];if(!e)return"";const i=gt[e.rarity]||"#aaa",r=$===t.instanceId||k===t.instanceId,n=K[e.slot]||{name:"",icon:""};return'<button class="forge-grid-item" data-item-id="'+t.instanceId+'" style="padding:12px 8px;text-align:center;border-radius:8px;cursor:pointer;border:1px solid '+(r?i:"rgba(200,155,60,0.06)")+";background:"+(r?"rgba(192,57,11,0.15)":"rgba(10,6,3,0.6)")+';color:var(--text-primary);transition:all 0.15s"><div style="font-size:28px;filter:drop-shadow(0 0 6px '+i+'40)">'+(e.icon||"📦")+'</div><div style="font-family:var(--font-ui);font-size:9px;font-weight:700;color:'+i+';margin-top:6px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis">'+e.name.split(" ").slice(0,2).join(" ")+'</div><div style="font-size:7px;color:var(--text-muted);letter-spacing:1px">'+n.icon+" "+n.name+'</div><div style="font-size:7px;color:'+i+';letter-spacing:1px;margin-top:2px">'+e.rarity.toUpperCase()+"</div></button>"}).join("")}function da(){if(!$)return null;if(X==="characters")return L.find(a=>a.id===$)||f.getFusedCharacterData($);{const a=(f.state.inventory||[]).find(t=>t.instanceId===$);return a?a.fusedData||_[a.itemId]:null}}function pa(){if(!k)return null;if(X==="characters")return L.find(a=>a.id===k)||f.getFusedCharacterData(k);{const a=(f.state.inventory||[]).find(t=>t.instanceId===k);return a?a.fusedData||_[a.itemId]:null}}function Be(){if(X==="characters"){const a=L.find(r=>r.id===$)||f.getFusedCharacterData($),t=L.find(r=>r.id===k)||f.getFusedCharacterData(k);if(!a||!t)return null;const e=f.state.ownedCharacters.find(r=>r.id===$),i=f.state.ownedCharacters.find(r=>r.id===k);return Xe(a,t,e?.level||1,i?.level||1)}else{const a=(f.state.inventory||[]).find(r=>r.instanceId===$),t=(f.state.inventory||[]).find(r=>r.instanceId===k);if(!a||!t)return null;const e=a.fusedData||_[a.itemId],i=t.fusedData||_[t.itemId];return Ye(e,i)}}function Re(){document.getElementById("forge-back")?.addEventListener("click",()=>w.navigate("home")),document.getElementById("tab-chars")?.addEventListener("click",()=>{X="characters",$=null,k=null,Ct()}),document.getElementById("tab-items")?.addEventListener("click",()=>{X="items",$=null,k=null,Ct()}),document.querySelectorAll(".forge-grid-item").forEach(a=>{a.addEventListener("click",()=>{const t=a.dataset.charId||a.dataset.itemId;t&&(t===$?$=null:t===k?k=null:$?k=t:$=t,ve())})}),document.querySelectorAll(".forge-slot-clear").forEach(a=>{a.addEventListener("click",t=>{t.stopPropagation();const e=a.dataset.clear;e==="1"&&($=null),e==="2"&&(k=null),ve()})}),document.getElementById("fuse-btn")?.addEventListener("click",()=>{const a=Be();a&&(X==="characters"?(f.removeFusionIngredients($,k),f.addFusedCharacter(a)):f.fuseItems($,k,a),$=null,k=null,ca(a))})}function ve(){const a=document.getElementById("app");a.innerHTML=Le(),Re()}function ca(a){const t=gt[a.rarity]||"#FF6B2C",e=document.createElement("div");e.className="modal-overlay",e.style.cssText="flex-direction:column;gap:0;background:rgba(0,0,0,0.95);z-index:9999",e.innerHTML='<div style="display:flex;flex-direction:column;align-items:center;justify-content:center;width:100%;height:100%;position:relative"><div style="position:absolute;inset:0;background:radial-gradient(circle,rgba('+(a.rarity==="supreme"?"255,20,147":"255,107,44")+',0.15),transparent 60%);animation:gachaFlash 2s ease forwards"></div><div style="position:relative;width:160px;height:160px;display:flex;align-items:center;justify-content:center"><div style="position:absolute;inset:0;border-radius:50%;border:2px solid '+t+"88;animation:portalRotate 4s linear infinite;box-shadow:0 0 30px "+t+'40"></div><div style="font-size:72px;filter:drop-shadow(0 0 30px '+t+');animation:crystalGlow 1.5s ease infinite alternate">⚒</div></div><div style="margin-top:32px;font-family:var(--font-title);font-size:16px;color:'+t+";letter-spacing:5px;text-shadow:0 0 20px "+t+'60;animation:fadeIn 1s 1s ease forwards;opacity:0">'+a.rarity.toUpperCase().replace("_","-")+'</div><div style="margin-top:12px;font-family:var(--font-title);font-size:28px;color:var(--text-bright);letter-spacing:3px;text-shadow:0 2px 20px rgba(0,0,0,0.5);animation:fadeIn 1s 1.5s ease forwards;opacity:0">'+a.name+'</div><div style="margin-top:12px;font-size:11px;color:var(--text-secondary);animation:fadeIn 1s 2s ease forwards;opacity:0">'+a.desc+'</div><button class="btn btn--primary" id="fusion-done" style="margin-top:32px;padding:14px 36px;animation:fadeIn 1s 2.5s ease forwards;opacity:0">CONTINUER</button></div><style>@keyframes crystalGlow { from{filter:drop-shadow(0 0 20px '+t+") brightness(1)} to{filter:drop-shadow(0 0 50px "+t+") brightness(1.4)} }</style>",document.body.appendChild(e),setTimeout(()=>{document.getElementById("fusion-done")?.addEventListener("click",()=>{e.remove(),Ct()})},100)}const ga={guerrier:{hp:1.5,def:1.5,atk:1,magDef:.5,spd:.3,magAtk:0},mage:{hp:.8,def:.3,atk:0,magDef:1.2,spd:.5,magAtk:2},arche:{hp:.7,def:.4,atk:1.8,magDef:.3,spd:1.5,magAtk:0},assassin:{hp:.6,def:.3,atk:1.6,magDef:.2,spd:2,magAtk:0}},xe=["commun","peucommun","rare","epique","legendaire","mythique","ultimate"],re={rare:{color:"#3B82F6",label:"Rare"},epique:{color:"#9333EA",label:"Epique"},legendaire:{color:"#C89B3C",label:"Legendaire"},ultimate:{color:"#F5F0E8",label:"Ultimate"}},pt={guerrier:"#f87171",mage:"#c084fc",arche:"#86efac",assassin:"#ff6b9d"},At={hp:"HP",atk:"ATK",def:"DEF",spd:"SPD",magAtk:"MAG",magDef:"RES"};let it="overview",st=null,Et="all",at="rarity",Tt="all",zt="all";function Pe(){const a=document.getElementById("app");a.innerHTML=`
    <div class="screen" style="background:var(--bg-primary);overflow:hidden;display:flex;flex-direction:column;">
  ...
  `,document.getElementById("dash-back").addEventListener("click",()=>w.navigate("home")),document.querySelectorAll(".dash-tab").forEach(t=>{t.addEventListener("click",()=>{it=t.dataset.tab,Pe()})}),Q()}function fa(a){return{overview:"Apercu",team:"Equipe",characters:"Personnages",inventory:"Inventaire",forge:"Forge"}[a]}function Q(){const a=document.getElementById("dash-content");if(a)switch(it){case"overview":a.innerHTML=ma();break;case"team":a.innerHTML=ua(),xa();return;case"characters":a.innerHTML=ha(),wa();return;case"inventory":a.innerHTML=$a(),ka();return;case"forge":a.innerHTML=Ea();break}}function ma(){const a=f.state,t=a.profile||{pseudo:"Forgeant",level:1,xp:0},e=a.totalBattles>0?Math.round(a.totalWins/a.totalBattles*100):0,i=a.ownedCharacters.length,r=t.level*100,n=Math.min(100,Math.round(t.xp/r*100)),s=["enchantement","osiris","supplice","maragorh","imotep"],d={enchantement:"Enchantement",osiris:"Osiris",supplice:"Supplice",maragorh:"Maragorh",imotep:"Imotep"},o=s.map(c=>{let p=0;for(let g=0;g<20;g++)f.getLevelFlames(c,g)>0&&p++;return{id:c,name:d[c],done:p,total:20,pct:Math.round(p/20*100)}}),l={rare:0,epique:0,legendaire:0,ultimate:0};return a.ownedCharacters.forEach(c=>{const p=L.find(g=>g.id===c.id);p&&l[p.rarity]!==void 0&&l[p.rarity]++}),Object.values(l).reduce((c,p)=>c+p,0),`
    <div style="padding:var(--space-xl);max-width:1100px;margin:0 auto">
      ...
      <div class="glass" style="padding:var(--space-xl);border-radius:var(--radius-xl)">
        ...
        <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:var(--space-md)">
          ${Object.entries(l).map(([c,p])=>{const g=re[c],m=Math.round(p/i*100)||0;return`
              <div style="text-align:center">
                <div style="font-family:var(--font-stat);font-size:32px;font-weight:700;color:${g.color};margin-bottom:4px">${p}</div>
                <div style="font-size:9px;color:var(--text-muted);letter-spacing:2px">${g.label.toUpperCase()}</div>
                <div style="margin-top:8px;height:4px;background:rgba(0,0,0,0.5);border-radius:2px;overflow:hidden">
                  <div style="height:100%;width:${m}%;background:${g.color};border-radius:2px"></div>
                </div>
              </div>
            `}).join("")}
        </div>
  ...
  `}function ua(){const a=f.getTeamInstances(),t=ba(a);return`
    <div style="padding:var(--space-xl);max-width:1100px;margin:0 auto">
          ...
          <table style="width:100%;border-collapse:collapse;font-family:var(--font-ui)">
            <thead>
              <tr>
                ...
                ${Object.values(At).map(e=>`<th style="text-align:center;padding:10px;font-size:10px;letter-spacing:2px;color:var(--text-muted);border-bottom:1px solid var(--border-metal)">${e}</th>`).join("")}
              </tr>
            </thead>
            <tbody>
              ${a.map((e,i)=>`
                <tr style="background:${i%2?"transparent":"rgba(200,155,60,0.02)"}">
                  ...
                  ${Object.keys(At).map(r=>{const n=Math.max(...a.map(o=>o.stats[r]||0)),s=e.stats[r]||0,d=n>0?Math.round(s/n*100):0;return`<td style="padding:10px;text-align:center;border-bottom:1px solid rgba(200,155,60,0.04)">
  ...
  `}function va(a){const t=be(a.stats,90),e=pt[a.type]||"var(--accent)",i=We[a.rarity?.toUpperCase()]?.color||"#aaa",r=f.getCharacterBonusStats(a.id),n=Object.values(r).some(s=>s>0);return`
    <div class="glass" style="padding:var(--space-lg);border-radius:var(--radius-xl);text-align:center;border-color:rgba(${za(e)},0.2);position:relative">
      ...
      <svg viewBox="0 0 200 200" style="width:140px;height:140px;margin:0 auto var(--space-md)">
        <!-- Grid hexagons -->
        ${[.33,.66,1].map(s=>`<polygon points="${be({hp:1,atk:1,def:1,spd:1,magAtk:1,magDef:1},90*s)}" fill="none" stroke="rgba(200,155,60,0.12)" stroke-width="1"/>`).join("")}
        <!-- Axes -->
        ${Ia(90).map(([s,d])=>`<line x1="100" y1="100" x2="${s}" y2="${d}" stroke="rgba(200,155,60,0.08)" stroke-width="1"/>`).join("")}
        <!-- Data -->
  ...
  `}function xa(){document.getElementById("btn-optimize")?.addEventListener("click",()=>{const a=ya();a&&(f.setTeam(a),Q())})}function ba(a){if(!a.length)return{label:"Equipe vide",bonus:""};const t={};a.forEach(r=>{t[r.type]=(t[r.type]||0)+1});const e=Object.entries(t).sort((r,n)=>n[1]-r[1])[0],i=e[0].charAt(0).toUpperCase()+e[0].slice(1);return e[1]===4?{label:`Meute ${i}`,bonus:`+15% toutes les stats (${i})`}:e[1]===3?{label:`Formation ${i}`,bonus:`+10% ATK +5% SPD (${i})`}:e[1]===2?{label:`Duo ${i}`,bonus:`+5% ATK (${i})`}:Object.keys(t).length===4?{label:"Composition Mixte",bonus:"+3% SPD globale (flexibilite)"}:{label:"Standard",bonus:""}}function ya(){const a=f.state.ownedCharacters;return a.length<1?null:a.map(e=>{const i=L.find(n=>n.id===e.id);if(!i)return null;const r={rare:1,epique:1.3,legendaire:1.7,ultimate:2.2}[i.rarity]||1;return{id:e.id,score:e.level*r}}).filter(Boolean).sort((e,i)=>i.score-e.score).slice(0,4).map(e=>e.id)}function ha(){let t=f.getOwnedInstances();return Et!=="all"&&(t=t.filter(e=>e.type===Et)),t.sort((e,i)=>at==="rarity"?xe.indexOf(i.rarity||"rare")-xe.indexOf(e.rarity||"rare"):at==="level"?i.level-e.level:at==="atk"?i.stats.atk+i.stats.magAtk-(e.stats.atk+e.stats.magAtk):0),`
    <div style="display:flex;height:100%">
      ...
      <div style="flex:0 0 320px;border-right:1px solid var(--border-metal);overflow-y:auto;padding:var(--space-md);">
        ...
        <!-- Char list -->
        <div style="display:flex;flex-direction:column;gap:8px">
          ${t.map(e=>{const i=e.id===st,r=re[e.rarity]||{color:"#aaa"};return`
  ...
  `}function Zt(){return`<div style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;color:var(--text-muted);gap:var(--space-md)">
  ...
  </div>`}function _e(a){const t=f.state.ownedCharacters.find(l=>l.id===a);if(!t)return Zt();const e=lt(a,t.level);if(!e)return Zt();const i=f.getCharacterBonusStats(a),r=pt[e.type]||"var(--accent)",n=re[e.rarity]||{color:"#aaa"},s=e.skills.map(l=>{let c=0,p="",g="var(--text-secondary)";return l.type==="physical"?(c=Math.round(l.power/100*e.stats.atk),p=c+" DPS",g="#E85D20"):l.type==="magical"?(c=Math.round(l.power/100*e.stats.magAtk),p=c+" MAG",g="#c084fc"):l.type==="heal"?(c=Math.round(l.power/100*e.stats.magAtk),p=c+" SOIN",g="#4A7C59"):(p="Soutien",g="var(--text-muted)"),{...l,dps:c,dpsLabel:p,dpsColor:g}}),d=De(e,a,3),o=f.getCharacterEquipped(a);return`
    <!-- Header -->
    ...
    <div class="glass" style="padding:var(--space-lg);border-radius:var(--radius-xl);margin-bottom:var(--space-lg)">
      ...
      <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:var(--space-md)">
        ${Object.entries(At).map(([l,c])=>{const p=e.stats[l]||0,g=i[l]||0,m=p+g;return`
            <div style="padding:10px;background:rgba(0,0,0,0.3);border-radius:var(--radius-md);border:1px solid var(--border)">
              ...
              <div style="display:flex;align-items:baseline;gap:6px">
                ...
                ${g>0?`<span style="font-size:11px;color:var(--legendaire);font-weight:700">+${g}</span>`:""}
              </div>
            </div>
          `}).join("")}
      </div>
    ...
    <div class="glass" style="padding:var(--space-lg);border-radius:var(--radius-xl);margin-bottom:var(--space-lg)">
      ...
      <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:var(--space-md)">
        ${Object.entries(K).map(([l,c])=>{const p=o[l],g=p?f.state.inventory.find(v=>v.instanceId===p):null,m=g?_[g.itemId]:null,u=m?H[m.rarity]?.color||"#aaa":"var(--text-muted)";return`
            <div style="text-align:center;padding:var(--space-md);background:rgba(0,0,0,0.3);border-radius:var(--radius-md);border:1px solid ${m?u+"40":"var(--border)"}">
              <div style="font-size:24px;margin-bottom:var(--space-xs)">${m?Mt(m.id):"&#9711;"}</div>
              <div style="font-size:9px;color:${m?u:"var(--text-muted)"};letter-spacing:1px">${m?m.name:c.name.toUpperCase()}</div>
              ${m?`<div style="font-size:8px;color:var(--text-muted);margin-top:4px">${Object.entries(m.stats||{}).map(([v,h])=>"+"+h+" "+v.toUpperCase()).join(" ")}</div>`:""}
            </div>
          `}).join("")}
      </div>
    </div>
        ...
        ${d.map((l,c)=>{const p=H[l.item.rarity]?.color||"#aaa";return`
            <div style="display:flex;align-items:center;gap:var(--space-md);padding:12px;background:rgba(0,0,0,0.3);border-radius:var(--radius-md);border:1px solid ${p}30">
              ...
              <div style="flex:1">
                ...
                <div style="font-size:10px;color:var(--text-secondary);margin-top:2px">${Object.entries(l.item.stats||{}).map(([g,m])=>"+"+m+" "+g.toUpperCase()).join(", ")}</div>
              </div>
              <div style="text-align:right">
    ...
    `:""}
  `}function wa(){document.querySelectorAll("[data-cfilter]").forEach(a=>{a.addEventListener("click",()=>{Et=a.dataset.cfilter,Q()})}),document.querySelectorAll("[data-csort]").forEach(a=>{a.addEventListener("click",()=>{at=a.dataset.csort,Q()})}),document.querySelectorAll("[data-charid]").forEach(a=>{a.addEventListener("click",()=>{st=a.dataset.charid;const t=document.getElementById("char-detail-panel");t&&(t.innerHTML=_e(st))})})}function $a(){let t=f.getInventoryItems();Tt!=="all"&&(t=t.filter(r=>r.slot===Tt)),zt!=="all"&&(t=t.filter(r=>r.rarity===zt));const i=f.getTeamInstances().map(r=>{const n=De(r,r.id,2);return{char:r,recs:n}}).filter(r=>r.recs.length>0);return`
    <div style="padding:var(--space-xl);max-width:1100px;margin:0 auto">
      ...
      <div style="display:flex;gap:var(--space-sm);margin-bottom:var(--space-md);flex-wrap:wrap">
        ...
        ${["all","commun","peu_commun","rare","epique","legendaire"].map(r=>`
          <button class="btn btn--sm ${r===zt?"btn--primary":"btn--ghost"}" data-irarity="${r}">${r==="all"?"ALL":r.toUpperCase()}</button>
        `).join("")}
      </div>
      ...
      <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(140px,1fr));gap:var(--space-md);margin-bottom:var(--space-xxl)">
        ${t.map(r=>{const n=H[r.rarity]?.color||"#aaa",s=Object.values(f.state.equipped).some(d=>Object.values(d).includes(r.instanceId));return`
          ...
          ${i.map(({char:r,recs:n})=>`
            <div>
              ...
              <div style="display:flex;gap:var(--space-md);flex-wrap:wrap">
                ${n.map(s=>{const d=H[s.item.rarity]?.color||"#aaa";return`
                    <div style="display:flex;align-items:center;gap:10px;padding:10px 14px;background:rgba(0,0,0,0.3);border-radius:var(--radius-md);border:1px solid ${d}30">
                      <span style="font-size:20px">${Mt(s.item.id)}</span>
                      <div>
  ...
  `}function ka(){document.querySelectorAll("[data-ifilter]").forEach(a=>{a.addEventListener("click",()=>{Tt=a.dataset.ifilter,Q()})}),document.querySelectorAll("[data-irarity]").forEach(a=>{a.addEventListener("click",()=>{zt=a.dataset.irarity,Q()})})}function Ea(){return`
  ...
  `}function De(a,t,e=3){const i=ga[a.type]||{},r=f.getCharacterEquipped(t),n=new Set(Object.values(r).filter(Boolean));return f.state.inventory.filter(s=>!n.has(s.instanceId)).map(s=>{const d=_[s.itemId];if(!d||!d.stats)return null;let o=0;for(const[l,c]of Object.entries(d.stats))o+=c*(i[l]||0);return{item:{...d,instanceId:s.instanceId},score:o}}).filter(Boolean).sort((s,d)=>d.score-s.score).slice(0,e)}function Ta(a){return{guerrier:"&#9876;",mage:"&#9670;",arche:"&#8982;",assassin:"&#8693;"}[a]||"?"}function Mt(a){return{epee_rouille:"&#9876;",lame_forestiere:"&#9876;",baton_mage:"&#9670;",arc_elfique:"&#8982;",dague_ombre:"&#8693;",sceptre_samael:"&#9760;",gambison_use:"&#9711;",cuirasse_ecailles:"&#9680;",robe_arcane:"&#9670;",armure_maragorh:"&#9680;",egide_samael:"&#9680;",amulette_vitalite:"&#9711;",ceinture_force:"&#9711;",anneau_rapidite:"&#9711;",orbe_enchantement:"&#9670;",pendentif_chance:"&#9670;",collier_precision:"&#9671;",talisman_nature:"&#9671;",phylactere_samael:"&#9760;"}[a]||"&#9671;"}function za(a){if(!a.startsWith("#"))return"192,57,11";const t=parseInt(a.slice(1,3),16),e=parseInt(a.slice(3,5),16),i=parseInt(a.slice(5,7),16);return`${t},${e},${i}`}const Lt=["hp","atk","def","spd","magAtk","magDef"],ne=a=>a*2*Math.PI/6-Math.PI/2;function be(a,t){const r={hp:800,atk:200,def:200,spd:150,magAtk:220,magDef:200},n={};for(const s of Lt)n[s]=Math.max(r[s],(a[s]||0)*1.2);return Lt.map((s,d)=>{const c=Math.min(a[s]||0,n[s])/(n[s]||1)*t,p=ne(d),g=100+c*Math.cos(p),m=100+c*Math.sin(p);return`${g.toFixed(1)},${m.toFixed(1)}`}).join(" ")}function Ia(a){return Lt.map((i,r)=>{const n=ne(r);return[100+a*Math.cos(n),100+a*Math.sin(n)]})}function Sa(a,t){return Lt.map((r,n)=>{const s=ne(n),d=t+18,o=100+d*Math.cos(s),l=100+d*Math.sin(s);return`<text x="${o.toFixed(1)}" y="${l.toFixed(1)}" text-anchor="middle" dominant-baseline="middle" fill="rgba(255,107,157,0.7)" font-size="11" font-family="DM Sans">${At[r]}</text>`}).join("")}function Ca(){const a=document.getElementById("app"),t=f.state,e=f.ACHIEVEMENTS,i=t.achievements||{},r=Object.keys(i).length,n=e.length,s=Math.round(r/n*100);f.checkAchievements(),a.innerHTML=`
  ...
  `,document.getElementById("back-btn").addEventListener("click",()=>w.navigate("home"))}const jt={gardien_enchante:{line:`"Vous osez fouler ces terres sacrées ?
...
...Vous osez ? Vous OSEZ défier la divinité ?"`,mood:"evil"}},ye=['"Préparez-vous à votre fin !"','"Vous ne passerez pas !"','"Ces terres vous sont interdites !"','"Vous êtes trop faibles pour avancer !"'],he={warn:{border:"rgba(252,211,77,0.5)",glow:"rgba(252,211,77,0.15)",text:"#fcd34d"},evil:{border:"rgba(239,68,68,0.5)",glow:"rgba(239,68,68,0.15)",text:"#fb7185"},beast:{border:"rgba(134,239,172,0.4)",glow:"rgba(134,239,172,0.1)",text:"#86efac"}};function Aa(a={}){const{zone:t,level:e}=a,i=parseInt(e||0),r=j.find(x=>x.id===t);if(!r){w.navigate("campaign");return}const n=i===(r.levels||20)-1,s=f.getTeamInstances(),d=document.getElementById("app");let o="",l="warn";n&&jt[r.boss.id]?(o=jt[r.boss.id].line,l=jt[r.boss.id].mood):n||(o=ye[Math.floor(Math.random()*ye.length)],l="warn");const c=he[l]||he.warn,p=n?r.boss.name:r.enemyTypes[Math.floor(Math.random()*r.enemyTypes.length)].replace(/_/g," ").replace(/\b\w/g,x=>x.toUpperCase()),g=n?r.boss.icon:r.icon,m=n?Qt(!1):Kt(),u=n?`BOSS — ${r.name}`:`Niveau ${i+1} — ${r.name}`;d.innerHTML=`
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:0;width:100%;max-width:1100px;z-index:5">
        ...
        <div id="vs-left" style="flex:1;display:flex;flex-direction:column;align-items:center;
          ...
          <div style="display:flex;flex-wrap:wrap;justify-content:center;gap:16px;max-width:360px">
            ${s.map(x=>`
              <div style="text-align:center">
                <img src="${C((x.type||"guerrier").split("/")[0])}"
                ...
                <div style="font-size:10px;color:var(--accent-light);margin-top:4px;
                  font-family:var(--font-title);letter-spacing:0.5px">${x.name.split(" ")[0]}</div>
              </div>
            `).join("")}
          </div>
        </div>
  ...
  `;const e=[{t:300,fn:()=>{T("load-bg-glow").style.opacity="1"}},{t:1500,fn:()=>{T("rune-circle").style.opacity="1"}},{t:2500,fn:()=>{for(let s=0;s<16;s++){const d=T(`rune-${s}`);d&&(d.style.fill="rgba(255,107,157,0.6)")}}},{t:3500,fn:()=>{const s=T("forge-symbol");s.style.fontSize="72px",s.style.opacity="1",s.style.filter="drop-shadow(0 0 30px rgba(200,150,60,0.8))"}},{t:4e3,fn:()=>Ba(80)},{t:4500,fn:()=>{const s=T("epic-loading");s.style.animation="screenShake 0.4s cubic-bezier(0.36,0.07,0.19,0.97)",setTimeout(()=>s.style.animation="",400)}},{t:4700,fn:()=>{const s=T("golden-flash");s.style.opacity="0.6",setTimeout(()=>s.style.opacity="0",200)}},{t:5e3,fn:()=>{T("load-bg-gold").style.opacity="1"}},{t:5500,fn:()=>{const s=T("title-container");s.style.fontSize="52px",["R","Y","T","I","G","E","R"].forEach((d,o)=>{setTimeout(()=>{const l=T(`letter-${o}`);l&&(l.style.opacity="1",l.style.transform="translateY(0) scale(1)",l.style.filter="drop-shadow(0 0 20px rgba(200,150,60,0.6))",Ra(l))},o*120)})}},{t:7500,fn:()=>{T("load-subtitle").style.color="rgba(200,150,60,0.5)"}},{t:8e3,fn:()=>{T("load-bar-wrap").style.opacity="1",T("load-text").style.color="rgba(200,150,60,0.55)",[{t:0,w:"15%"},{t:600,w:"35%"},{t:1200,w:"55%"},{t:2e3,w:"70%"},{t:2800,w:"85%"},{t:3500,w:"95%"},{t:4200,w:"100%"}].forEach(d=>{setTimeout(()=>{const o=T("load-bar-fill");o&&(o.style.width=d.w)},d.t)})}},{t:9e3,fn:()=>{Pa(40,3e3)}},{t:12500,fn:()=>{const s=T("golden-flash");s.style.opacity="0.4",setTimeout(()=>s.style.opacity="0",300)}},{t:13500,fn:()=>n()}],i=[];e.forEach(s=>{i.push(setTimeout(()=>{t||s.fn()},s.t))});function r(){t||(t=!0,i.forEach(clearTimeout),n())}T("epic-loading")?.addEventListener("click",r),window.addEventListener("keydown",function s(d){(d.code==="Space"||d.key==="Escape")&&(r(),window.removeEventListener("keydown",s))}),Qe(Ke());function n(){const s=T("epic-loading");s&&(s.style.transition="opacity 0.8s ease",s.style.opacity="0",setTimeout(()=>{s.remove(),w.start(),(window.location.hash===""||window.location.hash==="#")&&w.navigate("home"),ct.start(),_a()},800))}}function T(a){return document.getElementById(a)}function Ba(a){const t=T("load-particles");if(t)for(let e=0;e<a;e++)setTimeout(()=>{const i=document.createElement("div"),r=Math.random()*Math.PI*2,n=100+Math.random()*400,s=1+Math.random()*3,d=1+Math.random()*1.5,o=["#ff6b9d","#ff8db6","#c084fc","#fcd34d","#fda4af"],l=o[Math.floor(Math.random()*o.length)];i.style.cssText=`
        ...
        --dx:${Math.cos(r)*n}px;
        --dy:${Math.sin(r)*n}px;
      `,t.appendChild(i),setTimeout(()=>i.remove(),d*1e3+100)},e*15)}function Ra(a){const t=T("load-particles");if(!t||!a)return;const e=a.getBoundingClientRect();for(let i=0;i<6;i++){const r=document.createElement("div"),n=1+Math.random()*2;r.style.cssText=`
      position:absolute;
    ...
    `,t.appendChild(r),setTimeout(()=>r.remove(),900)}}function Pa(a,t){const e=T("load-particles");if(!e)return;const i=t/a;for(let r=0;r<a;r++)setTimeout(()=>{const n=document.createElement("div"),s=Math.random()*100,d=1+Math.random()*2.5,o=3+Math.random()*4,l=(Math.random()-.5)*80,c=["rgba(255,107,157,0.8)","rgba(192,132,252,0.7)","rgba(252,211,77,0.5)"],p=c[Math.floor(Math.random()*c.length)];n.style.cssText=`
        ...
        --sway:${l}px;
      `,e.appendChild(n),setTimeout(()=>n.remove(),o*1e3+100)},r*i)}window.addEventListener("keydown",a=>{if(a.key==="Escape"&&window.location.hash!=="#home"&&window.location.hash!==""&&w.navigate("home"),a.key==="m"||a.key==="M"){const t=ct.toggleMute();Oe(t)}});function _a(){if(document.getElementById("music-controls"))return;const a=document.createElement("div");a.id="music-controls",a.innerHTML=Fe(ct.muted),a.title="Musique (M pour mute)",a.style.cssText=`
  ...
  `,a.addEventListener("mouseenter",()=>{a.style.borderColor="rgba(200, 155, 60, 0.6)",a.style.boxShadow="0 2px 20px rgba(192,57,11,0.3), inset 0 1px 0 rgba(200,155,60,0.2)",a.style.transform="scale(1.1)"}),a.addEventListener("mouseleave",()=>{a.style.borderColor="rgba(200, 155, 60, 0.3)",a.style.boxShadow="0 2px 12px rgba(0,0,0,0.5), inset 0 1px 0 rgba(200,155,60,0.1)",a.style.transform="scale(1)"}),a.addEventListener("click",()=>{const t=ct.toggleMute();Oe(t)}),document.body.appendChild(a)}function Oe(a){const t=document.getElementById("music-controls");t&&(t.innerHTML=Fe(a))}function Fe(a){return a?`<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#C89B3C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
