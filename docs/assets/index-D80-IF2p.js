import{g,C as J,P as wt,s as Ye,m as We,a as Ze,b as Ke,x as Qe}from"./game-engine-B1buFJxH.js";import{C as P,Z as N,e as Je,F as me,f as at,c as vt,I as j,h as Y,i as ti,j as ei,R as ii}from"./game-data-Bpa2kVIF.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const o of n.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function e(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(r){if(r.ep)return;r.ep=!0;const n=e(r);fetch(r.href,n)}})();class ai{constructor(){this.routes={},this.currentRoute=null,this.params={},window.addEventListener("hashchange",()=>this.handleRoute())}on(t,e){return this.routes[t]=e,this}navigate(t,e={}){this.params=e,window.location.hash=t}handleRoute(){const t=window.location.hash.slice(1)||"home",e=t.split("?")[0],i=t.split("?")[1];i&&i.split("&").forEach(r=>{const[n,o]=r.split("=");this.params[n]=decodeURIComponent(o)}),this.routes[e]?(this.currentRoute=e,this.routes[e](this.params),this.params={}):this.routes.home&&(this.currentRoute="home",this.routes.home({}))}start(){this.handleRoute()}}const $=new ai;function st(a){const t={guerrier:"./assets/characters/guerrier.png",mage:"./assets/characters/mage.png",arche:"./assets/characters/arche.png",assassin:"./assets/characters/assassin.png"};return t[a]||t.guerrier}const ue={};function B(a,t=null,e="rare"){return t&&ue[t]?ue[t]:st(a)}function re(a=!1){return a?new URL("data:image/png;base64,",import.meta.url).href:"./assets/characters/boss.png"}function ne(){return"./assets/characters/minion.png"}function ri(a){return Promise.all(a.map(t=>new Promise(e=>{const i=new Image;i.src=t,i.onload=e,i.onerror=e})))}function ni(){return[st("guerrier"),st("mage"),st("arche"),st("assassin"),re(),ne()]}function oi(){const a=document.getElementById("app"),t=P.filter(e=>e.starter);a.innerHTML=`
  ...
  `,t.forEach(e=>{document.getElementById(`starter-${e.id}`).addEventListener("click",async()=>{await g.chooseStarter(e.id),g.addArchireve(500),Se()})})}function Se(){const a=g.state,t=document.getElementById("app");if(a.profile||(g.state.profile={pseudo:"Forgeron",avatar:"https://api.dicebear.com/7.x/pixel-art/svg?seed=local_hero",region:"Offline",level:1,xp:0},g.save()),!a.starterChosen){oi();return}const e=g.getTeamInstances(),i=a.totalBattles>0?Math.round(a.totalWins/a.totalBattles*100):0,r=(a.ownedCharacters||[]).some(p=>p.isNew),n=(a.inventory||[]).some(p=>p.isNew),o=g.canFuseAny(),d=["enchantement","osiris","supplice","maragorh","imotep"],s={enchantement:"Enchantement",osiris:"Osiris",supplice:"Supplice",maragorh:"Maragorh",imotep:"Imotep"};let l=d[0],c=0;for(const p of d){let m=0;for(let u=0;u<20;u++)g.getLevelFlames(p,u)>0&&m++;const f=Math.round(m/20*100);f>c&&(c=f,l=p)}t.innerHTML=`
      ...
      <div style="flex:1;display:grid;grid-template-columns:290px 1fr 310px;gap:0;overflow:hidden;z-index:2">
        ...
        ">
          ...
          <div style="display:flex;flex-direction:column;gap:6px;margin-bottom:28px">
            ...
            ">
              ...
              FORGE DE FUSION
              ${o?'<div style="position:absolute;top:10px;right:10px;width:8px;height:8px;background:var(--ember);border-radius:50%;box-shadow:0 0 10px var(--ember-glow);animation:pulseRed 2s infinite"></div>':""}
            </button>
          </div>
          ...
          <div style="display:flex;flex-direction:column;gap:5px;margin-bottom:28px">
            ...
            ">
              ...
              SUCCÈS
              ${(()=>{const p=g.state.achievements||{},m=g.ACHIEVEMENTS?.length||12;return`<div style="position:absolute;right:10px;font-family:var(--font-stat);font-size:8px;color:var(--epique);background:rgba(163,53,238,0.1);padding:2px 6px;border-radius:2px;border:1px solid rgba(163,53,238,0.2)">${Object.keys(p).length}/${m}</div>`})()}
            </button>
          </div>
          ...
          <div style="display:flex;flex-direction:column;gap:10px">
            ${d.map(p=>{let m=0;for(let x=0;x<20;x++)g.getLevelFlames(p,x)>0&&m++;const f=Math.round(m/20*100),u=f===100;return`
                <div>
          ...
          <div style="display:grid;grid-template-columns:repeat(4,175px);gap:16px;z-index:1;margin-bottom:36px">
            ${[0,1,2,3].map(p=>{const m=e[p];if(m){const f=`var(--${m.rarity||"rare"})`;return`
                  ...
                  ">
                    ...
                    <img src="${B((m.type||"").split("/")[0])}" class="sprite sprite--xl sprite--animate" alt="${m.name}" style="margin:0 auto 10px;display:block">
        ...
        ">
          ...
          <div id="daily-missions-panel" style="display:flex;flex-direction:column;gap:8px;margin-bottom:28px">
            ${(()=>{const p=g.getDailyMissions(),m=p.every(f=>f.done);return p.map(f=>{const u=Math.min(100,Math.round(f.progress/f.target*100));return`
                  <div style="
                    padding:12px 14px;
          ...
          ">
            ...
            <div style="font-family:var(--font-title);font-size:11px;font-weight:700;color:var(--text-primary);letter-spacing:2px;margin-bottom:5px">${(s[l]||l).toUpperCase()}</div>
          ...
          <button class="btn btn--primary btn--full" id="btn-quick-play" style="
            ...
            margin-top:20px;
          ">
            ⚔ JOUER — ${(s[l]||l).toUpperCase()}
          </button>
        </div>
      </div>
    </div>
  `,si(),li(),di(),document.getElementById("btn-profile")?.addEventListener("click",()=>$.navigate("profile")),document.getElementById("btn-campaign")?.addEventListener("click",()=>$.navigate("campaign")),document.getElementById("btn-dungeon")?.addEventListener("click",()=>$.navigate("dungeon")),document.getElementById("btn-invocation")?.addEventListener("click",()=>$.navigate("invocation")),document.getElementById("btn-forge")?.addEventListener("click",()=>$.navigate("forge")),document.getElementById("btn-achievements")?.addEventListener("click",()=>$.navigate("achievements")),document.getElementById("btn-dashboard")?.addEventListener("click",()=>$.navigate("dashboard")),document.getElementById("btn-team")?.addEventListener("click",()=>{g.state.ownedCharacters&&(g.state.ownedCharacters.forEach(p=>delete p.isNew),g.save()),$.navigate("team")}),document.getElementById("btn-inventory")?.addEventListener("click",()=>{g.state.inventory&&(g.state.inventory.forEach(p=>delete p.isNew),g.save()),$.navigate("inventory")}),document.getElementById("btn-dashboard")?.addEventListener("click",()=>$.navigate("dashboard")),document.getElementById("btn-quick-play")?.addEventListener("click",()=>$.navigate("campaign"))}function si(){const a=document.getElementById("ember-particles");if(!a)return;let t="";for(let e=0;e<65;e++){const i=Math.random()*100,r=Math.random()*12,n=5+Math.random()*12,o=1+Math.random()*2.5,d=.12+Math.random()*.35,s=(Math.random()-.5)*80,l=["rgba(255,107,157,0.8)","rgba(255,141,182,0.6)","rgba(192,132,252,0.5)","rgba(252,211,77,0.4)","rgba(255,182,193,0.5)"],c=l[Math.floor(Math.random()*l.length)];t+=`<div style="
    ...
    "></div>`}a.innerHTML=t}function li(){const a=document.getElementById("floating-runes");if(!a)return;const t=["花","月","雷","火","風","光","水","雪","星","龍","剣","神"];let e="";for(let i=0;i<12;i++){const r=5+Math.random()*90,n=5+Math.random()*90,o=14+Math.random()*18,d=Math.random()*20,s=15+Math.random()*15;e+=`<div class="floating-rune" style="
      left:${r}%;top:${n}%;font-size:${o}px;
      animation-duration:${s}s;
      animation-delay:${d}s;
    ">${t[i]}</div>`}a.innerHTML=e}function di(){const a=document.getElementById("title-sparkles");if(!a)return;let t=setInterval(()=>{if(!document.getElementById("title-sparkles")){clearInterval(t);return}const e=document.createElement("div"),i=Math.random()*100,r=Math.random()*100,n=1+Math.random()*2,o=.8+Math.random()*.5,d=["#ff6b9d","#ff8db6","#c084fc","#fcd34d"],s=d[Math.floor(Math.random()*d.length)];e.style.cssText=`
      position:absolute;left:${i}%;top:${r}%;
      width:${n}px;height:${n}px;
      background:${s};border-radius:50%;
      box-shadow:0 0 ${n*4}px ${s};
      animation:titleSparkle ${o}s ease forwards;
      pointer-events:none;
    `,a.appendChild(e),setTimeout(()=>e.remove(),o*1e3+50)},300)}const Ae={enchantement:"#C89B3C",osiris:"#E85D20",supplice:"#4A7C59",maragorh:"#c084fc",imotep:"#DC2626",abysses:"#22D3EE",citadelle:"#A78BFA",terre_desolee:"#EF4444",nexus:"#F5D060",preludes:"#FDE68A",bifrost:"#818CF8",domaine:"#FBBF24"};let Nt=0;function Ce(){const a=document.getElementById("app");a.innerHTML=`
      ...
      <div style="flex:1;display:flex;overflow:hidden;z-index:2">
        ...
        ">
          ...
          <div style="display:flex;flex-direction:column;gap:2px;padding:0 8px 20px">
            ${N.map((t,e)=>{const i=g.isLevelUnlocked(t.id,0),r=t.levels||20,n=Object.keys(g.state.campaignProgress[t.id]||{}).length,o=Math.round(n/r*100),d=Ae[t.id]||"#C89B3C",s=e===Nt,l=e===0,c=t.tier===2&&(e===0||N[e-1]?.tier!==2),p=t.tier===3&&(e===0||N[e-1]?.tier!==3);return`
  ...
  `,document.getElementById("back-btn").addEventListener("click",()=>$.navigate("home")),document.querySelectorAll(".zone-list-btn").forEach(t=>{t.addEventListener("click",()=>{const e=parseInt(t.dataset.zoneIdx),i=N[e];!i||!g.isLevelUnlocked(i.id,0)||(Nt=e,Ce())})}),document.querySelectorAll(".level-tile-btn").forEach(t=>{t.addEventListener("click",e=>{const i=t.dataset.zone,r=parseInt(t.dataset.level),n=t.dataset.berserk==="true";$.navigate("vs",{zone:i,level:r,berserk:n})})})}function pi(a){const t=N[a];if(!t)return'<div style="flex:1;display:flex;align-items:center;justify-content:center;color:var(--text-muted)">Selectionnez une zone</div>';g.isLevelUnlocked(t.id,0);const e=t.levels||20,i=Object.keys(g.state.campaignProgress[t.id]||{}).length,r=g.getZoneStars(t.id),n=e*3,o=Math.round(i/e*100),d=Ae[t.id]||"#C89B3C",s=e>50?10:e>20?6:5;return`
    <!-- Zone Header with BG -->
    <div style="
    ...
    <div style="flex:1;overflow-y:auto;padding:24px 32px">
      ...
      <div style="display:grid;grid-template-columns:repeat(${s},1fr);gap:10px;max-width:${s===10?"900px":s===6?"800px":"700px"}">
        ${Array.from({length:e},(l,c)=>{const p=c===e-1,m=g.getLevelFlames(t.id,c),f=g.isLevelUnlocked(t.id,c),u=m>0,x=Array.from({length:3},(W,rt)=>'<span style="font-size:10px;color:'+(rt<m?d:"rgba(200,155,60,0.15)")+'">&#9670;</span>').join("");if(!f)return'<div style="padding:14px 8px;text-align:center;background:rgba(10,6,3,0.6);border:1px solid rgba(200,155,60,0.04);border-radius:6px;opacity:0.25"><div style="font-family:var(--font-stat);font-size:16px;color:var(--text-muted);margin-bottom:4px">&#9618;</div><div style="font-size:9px;color:var(--text-muted);letter-spacing:1px">VERR.</div></div>';const k=p?"linear-gradient(135deg,rgba(127,29,29,0.3),rgba(13,10,8,0.8))":u?"rgba(15,10,5,0.8)":"rgba(10,6,3,0.6)",b=p?"rgba(220,38,38,0.3)":u?d+"25":"rgba(200,155,60,0.06)",z=p?"var(--font-title)":"var(--font-stat)",R=p?"12px":"16px",C=p?"var(--danger)":u?d:"var(--text-primary)",y=p?"2px":"0",E=p?"BOSS":c+1,v=p?t.boss.name.split(" ")[0]:"NIV."+(t.levelRange[0]+c),S=g.isBerserkCleared(t.id,c)?'<div style="font-size:7px;color:#FBBF24;letter-spacing:1px;margin-top:2px">🔥 BERSERK</div>':"";return'<button class="level-tile-btn" data-zone="'+t.id+'" data-level="'+c+'" data-berserk="false" style="padding:14px 8px;text-align:center;background:'+k+";border:1px solid "+b+';border-radius:6px;cursor:pointer;transition:all 0.15s ease;color:var(--text-primary);position:relative"><div style="font-family:'+z+";font-size:"+R+";font-weight:700;color:"+C+";margin-bottom:4px;letter-spacing:"+y+'">'+E+'</div><div style="font-family:var(--font-stat);font-size:9px;color:var(--text-muted);margin-bottom:6px;letter-spacing:1px">'+v+'</div><div style="display:flex;justify-content:center;gap:2px">'+x+"</div>"+S+"</button>"}).join("")}
      </div>
    </div>
  `}const q=50,$t=6e3,ci=5e3,gi=35,fi=8,mi=.5,ui=1.5;class vi{constructor(t,e){this.playerTeam=t.map((i,r)=>({...i,stats:{...i.stats},currentHp:i.currentHp??i.stats.hp,maxHp:i.stats.hp,alive:!0,buffs:[],debuffs:[],atbGauge:Math.random()*20,atbMax:100,isPlayer:!0,isGuarding:!1,x:400,y:300+r*120})),this.enemyTeam=e.map((i,r)=>({...i,stats:{...i.stats},currentHp:i.currentHp??i.stats.hp??i.maxHp,maxHp:i.maxHp??i.stats.hp,alive:!0,buffs:i.buffs||[],debuffs:i.debuffs||[],atbGauge:Math.random()*15,atbMax:100,isPlayer:!1,weakness:i.weakness||"physique",breakGauge:i.breakGauge||0,breakMax:i.breakMax||100,isBroken:i.isBroken||!1,breakTimer:0,x:1300+(i.isBoss?0:r*30),y:300+r*120})),this.running=!1,this.paused=!1,this.gameOver=!1,this.winner=null,this.tickInterval=null,this.elapsedTime=0,this.turnCount=0,this.activeUnit=null,this.log=[],this.totalDmgDealt=0,this.onTick=null,this.onPlayerReady=null,this.onActionExecuted=null,this.onLog=null,this.onBreak=null,this.onGameOver=null}start(){this.running||(this.running=!0,this.paused=!1,this.addLog("⚔️ Le combat commence !"),this.tickInterval=setInterval(()=>this._tick(),q))}stop(){this.running=!1,this.tickInterval&&(clearInterval(this.tickInterval),this.tickInterval=null)}destroy(){this.stop(),this.onTick=null,this.onPlayerReady=null,this.onActionExecuted=null,this.onLog=null,this.onBreak=null,this.onGameOver=null}setSpeed(t){const e=Math.round(q/t);this.tickInterval&&(clearInterval(this.tickInterval),this.tickInterval=setInterval(()=>this._tick(),e))}_tick(){if(!this.running||this.gameOver||this.paused)return;this.elapsedTime+=q;for(const i of this.enemyTeam)i.isBroken&&i.alive&&(i.breakTimer-=q,i.breakTimer<=0&&(i.isBroken=!1,i.breakGauge=0,i.breakTimer=0));this.elapsedTime%1e3<q&&this._processStatusEffects();const t=[...this.playerTeam,...this.enemyTeam];for(const i of t){if(!i.alive||i.isBroken)continue;const n=i.stats.spd/50*q*100/$t;i.atbGauge=Math.min(i.atbMax,i.atbGauge+n)}const e=t.filter(i=>i.alive&&i.atbGauge>=i.atbMax).sort((i,r)=>r.stats.spd-i.stats.spd);if(e.length>0){const i=e[0];i.isPlayer?(this.paused=!0,this.activeUnit=i,this.onPlayerReady?.(i)):(this._executeEnemyAction(i),i.atbGauge=0)}this._checkWinCondition(),this.onTick?.({playerTeam:this.playerTeam,enemyTeam:this.enemyTeam,timeline:this.getTimeline(),elapsedTime:this.elapsedTime,activeUnit:this.activeUnit,paused:this.paused})}executePlayerAction(t,e){if(!this.paused||!this.activeUnit)return null;const i=this.activeUnit,r=i.skills[t];if(!r)return null;const n=this._resolveAction(i,r,e,!0),d=(r.recovery||2e3)/$t*100;return i.atbGauge=-d,i.isGuarding=!1,this.turnCount++,this.paused=!1,this.activeUnit=null,setTimeout(()=>this._checkWinCondition(),100),n}executeGuard(){if(!this.paused||!this.activeUnit)return;const t=this.activeUnit;t.isGuarding=!0,t.atbGauge=-20,this.addLog(`🛡️ ${t.name} se met en garde !`),this.onActionExecuted?.({actor:t,skill:{id:"guard",name:"Garde",icon:"🛡️",type:"guard"},targets:[],results:{guards:[t.id]},isPlayer:!0}),this.turnCount++,this.paused=!1,this.activeUnit=null}_executeEnemyAction(t){const e=t.skills||[{id:"attaque",name:"Attaque",type:"physical",power:80,accuracy:100,icon:"👊",recovery:1800}],i=this.playerTeam.filter(p=>p.alive);if(i.length===0)return;let r=null,n=null;const o=e.find(p=>p.type==="heal"),d=this.enemyTeam.filter(p=>p.alive),s=d.find(p=>p.currentHp/p.maxHp<.4);if(o&&s&&(r=o,n=[...d].sort((p,m)=>p.currentHp/p.maxHp-m.currentHp/m.maxHp)[0].id),!r){const p=e.find(m=>m.type==="buff");p&&(!t.buffs||t.buffs.length===0)&&this.turnCount<=6&&(r=p,n=t.id)}if(!r){const p=e.filter(m=>m.type==="physical"||m.type==="magical");if(t.isBoss){const m=p.find(u=>u.aoe),f=p.find(u=>!u.aoe);m&&i.length>=2&&this.turnCount%3===0?r=m:f?r=f:r=p[0]||e[0],n=[...i].sort((u,x)=>u.currentHp-x.currentHp)[0].id}else if(t.type==="assassin"){r=p.find(u=>u.critBonus||u.executeMult)||p[0]||e[0];const m=i.filter(u=>u.type==="mage"||u.type==="arche");n=[...m.length>0?m:i].sort((u,x)=>u.currentHp-x.currentHp)[0].id}else t.type==="mage"?(r=p.length>0?p[Math.floor(Math.random()*p.length)]:e[0],n=[...i].sort((m,f)=>m.stats.magDef-f.stats.magDef)[0].id):(r=p.length>0?p[Math.floor(Math.random()*p.length)]:e[0],n=[...i].sort((m,f)=>m.stats.def-f.stats.def)[0].id)}r||(r=e[0]),n||(n=i[0].id),this._resolveAction(t,r,n,!1);const c=(r.recovery||2e3)/$t*100;t.atbGauge=-c}_resolveAction(t,e,i,r){const n={hits:[],heals:[],buffs:[],misses:[]};if(Math.random()*100>(e.accuracy||100))return this.addLog(`${r?"🎯":"👹"} ${t.name} — RATÉ !`),n.misses.push(i),this.onActionExecuted?.({actor:t,skill:e,targets:[i],results:n,isPlayer:r}),n;if(e.type==="heal"){const d=this.findUnit(i);if(d&&d.alive){const s=Math.floor(e.power*(1+this._getEffectiveStat(t,"magAtk")/200));d.currentHp=Math.min(d.maxHp,d.currentHp+s),this.addLog(`💚 ${t.name} soigne ${d.name} (+${s} PV)`),n.heals.push({targetId:i,amount:s})}}else if(e.type==="buff"){const d=e.effect?.aoe?(r?this.playerTeam:this.enemyTeam).filter(s=>s.alive):[this.findUnit(i)].filter(Boolean);for(const s of d)e.effect?.type==="stealth"?(s.buffs.push({type:"stealth",turns:e.effect.turns}),this.addLog(`👤 ${t.name} se rend invisible !`)):e.effect&&(s.buffs.push({stat:e.effect.stat,boost:e.effect.boost,turns:e.effect.turns}),this.addLog(`✨ ${t.name} → ${e.name}`)),n.buffs.push({targetId:s.id})}else{const d=e.aoe?(r?this.enemyTeam:this.playerTeam).filter(s=>s.alive):[this.findUnit(i)].filter(Boolean);for(const s of d){if(!s||!s.alive)continue;const l=e.type==="magical"?this._getEffectiveStat(t,"magAtk"):this._getEffectiveStat(t,"atk");let c=e.type==="magical"?this._getEffectiveStat(s,"magDef"):this._getEffectiveStat(s,"def");e.ignoreDefPercent&&(c=Math.floor(c*(1-e.ignoreDefPercent)));let p=Math.floor(l*e.power/(c+50)*(.85+Math.random()*.3));const m=10+(t.type==="assassin"?15:0)+(e.critBonus||0),f=Math.random()*100<m;if(f&&(p=Math.floor(p*1.5)),e.executeMult&&s.currentHp/s.maxHp<.3&&(p=Math.floor(p*e.executeMult)),e.aoe&&(p=Math.floor(p*.7)),s.isBroken&&(p=Math.floor(p*ui)),s.isGuarding&&(p=Math.floor(p*(1-mi)),s.isGuarding=!1),p=Math.max(1,p),s.currentHp-=p,r&&(this.totalDmgDealt+=p),this.addLog(`${r?"⚔️":"👹"} ${t.name} → ${e.name} → ${s.name} : -${p}${f?" 💥CRIT!":""}${s.isBroken?" 🔥BREAK!":""}`),s.currentHp<=0&&(s.currentHp=0,s.alive=!1,this.addLog(`💀 ${s.name} vaincu !`)),e.effect?.type==="poison"&&s.alive&&(s.debuffs.push({type:"poison",damage:e.effect.damage,turns:e.effect.turns}),this.addLog(`☠️ ${s.name} empoisonné !`)),r&&s.alive&&!s.isBroken&&s.weakness){const x=e.element===s.weakness?gi:fi;s.breakGauge=Math.min(s.breakMax,(s.breakGauge||0)+x),s.breakGauge>=s.breakMax&&(s.isBroken=!0,s.breakTimer=ci,s.atbGauge=-60,this.addLog(`💥 ${s.name} est BRISÉ ! (+50% dégâts)`),this.onBreak?.(s))}n.hits.push({targetId:s.id,damage:p,isCrit:f,isBreakHit:s.isBroken})}}return this.onActionExecuted?.({actor:t,skill:e,targets:n.hits.map(d=>d.targetId),results:n,isPlayer:r}),n}getTimeline(){const t=[...this.playerTeam,...this.enemyTeam].filter(i=>i.alive),e=[];for(const i of t){const r=i.atbMax-i.atbGauge,o=i.stats.spd/50*q*100/$t,s=(r>0?Math.ceil(r/o):0)*q;e.push({id:i.id,name:i.name,type:i.type,isPlayer:i.isPlayer,isBoss:i.isBoss,atbPct:Math.max(0,Math.min(100,i.atbGauge/i.atbMax*100)),msToReady:s,isReady:i.atbGauge>=i.atbMax,isBroken:i.isBroken,rarity:i.rarity})}return e.sort((i,r)=>i.msToReady-r.msToReady),e}findUnit(t){return this.playerTeam.find(e=>e.id===t)||this.enemyTeam.find(e=>e.id===t)}_getEffectiveStat(t,e){let i=t.stats[e];for(const r of t.buffs||[])r.stat===e&&(i=Math.floor(i*(1+r.boost)));return i}_processStatusEffects(){const t=[...this.playerTeam,...this.enemyTeam];for(const e of t)e.alive&&(e.debuffs=(e.debuffs||[]).filter(i=>(i.type==="poison"&&(e.currentHp-=i.damage,e.currentHp<=0&&(e.currentHp=0,e.alive=!1,this.addLog(`💀 ${e.name} succombe au poison !`))),i.turns--,i.turns>0)),e.buffs=(e.buffs||[]).filter(i=>(i.turns--,i.turns>0)))}_checkWinCondition(){const t=this.playerTeam.filter(i=>i.alive).length,e=this.enemyTeam.filter(i=>i.alive).length;t===0&&!this.gameOver&&(this.gameOver=!0,this.winner="enemy",this.addLog("💀 Défaite... Votre équipe a été vaincue."),this.stop(),this.onGameOver?.("enemy")),e===0&&!this.gameOver&&(this.gameOver=!0,this.winner="player",this.addLog("🏆 Victoire ! Les ennemis sont vaincus !"),this.stop(),this.onGameOver?.("player"))}addLog(t){this.log.push({message:t,time:this.elapsedTime}),this.onLog?.(t)}getSummary(){return{won:this.winner==="player",turnsPlayed:this.turnCount,playerTeamState:this.playerTeam,enemyTeamState:this.enemyTeam,log:this.log,totalDmgDealt:this.totalDmgDealt}}}const ve={character:{frameW:48,frameH:48,idle:{row:0,frames:6,fps:8,loop:!0,holdLast:!1},walk:{row:1,frames:8,fps:12,loop:!0,holdLast:!1},attack:{row:2,frames:6,fps:14,loop:!1,holdLast:!1},hurt:{row:3,frames:3,fps:16,loop:!1,holdLast:!1},death:{row:4,frames:7,fps:8,loop:!1,holdLast:!0}},boss:{frameW:96,frameH:96,idle:{row:0,frames:6,fps:6,loop:!0,holdLast:!1},attack:{row:1,frames:6,fps:10,loop:!1,holdLast:!1},hurt:{row:2,frames:3,fps:14,loop:!1,holdLast:!1},death:{row:3,frames:8,fps:7,loop:!1,holdLast:!0}},minion:{frameW:48,frameH:48,idle:{row:0,frames:6,fps:10,loop:!0,holdLast:!1},walk:{row:1,frames:8,fps:14,loop:!0,holdLast:!1},attack:{row:2,frames:5,fps:14,loop:!1,holdLast:!1},hurt:{row:3,frames:3,fps:16,loop:!1,holdLast:!1},death:{row:4,frames:6,fps:8,loop:!1,holdLast:!0}}},Le={guerrier:"/assets/characters/guerrier_sheet.png",mage:"/assets/characters/mage_sheet.png",arche:"/assets/characters/arche_sheet.png",assassin:"/assets/characters/assassin_sheet.png",boss:"/assets/characters/boss_sheet.png",minion:"/assets/characters/minion_sheet.png"},kt={};async function xi(a){return kt[a]!==void 0?kt[a]:new Promise(t=>{const e=new Image;e.onload=()=>{kt[a]=!0,t(!0)},e.onerror=()=>{kt[a]=!1,t(!1)},e.src=Le[a]})}class bi{constructor(t,e,i="character"){this.el=t,this.type=e,this.config=ve[i]||ve.character,this.currentAnim=null,this.currentFrame=0,this.lastTime=0,this.rafId=null,this.onAnimEnd=null,this.hasSheet=!1,this._queue=null,this._init()}async _init(){const t=await xi(this.type);if(this.hasSheet=t,t){const{frameW:e,frameH:i}=this.config;this.el.style.backgroundImage=`url('${Le[this.type]}')`,this.el.style.backgroundRepeat="no-repeat",this.el.style.backgroundSize="auto",this.el.style.imageRendering="pixelated",this.el.style.width=e+"px",this.el.style.height=i+"px";const r=this.el.querySelector("img");r&&(r.style.display="none"),this.play("idle")}}play(t,e=null){if(!this.hasSheet){this._triggerCSSFallback(t),e&&e();return}this.config[t]&&(this.currentAnim==="death"&&t!=="death"||(this.currentAnim=t,this.currentFrame=0,this.lastTime=performance.now(),this.onAnimEnd=e,this._queue=null,this.rafId&&cancelAnimationFrame(this.rafId),this._tick(this.lastTime)))}playThen(t,e){this.play(t,()=>this.play(e))}stop(){this.rafId&&cancelAnimationFrame(this.rafId),this.rafId=null}destroy(){this.stop(),this.el=null}_tick(t){if(!this.el)return;const e=this.config[this.currentAnim];if(!e)return;const i=1e3/e.fps,r=t-this.lastTime;if(r>=i&&(this.lastTime=t-r%i,this._renderFrame(e),this.currentFrame++,this.currentFrame>=e.frames))if(e.loop)this.currentFrame=0;else if(e.holdLast){this.currentFrame=e.frames-1,this._renderFrame(e),this.onAnimEnd&&(this.onAnimEnd(),this.onAnimEnd=null);return}else{this.currentFrame=0,this.onAnimEnd&&(this.onAnimEnd(),this.onAnimEnd=null);return}this.rafId=requestAnimationFrame(n=>this._tick(n))}_renderFrame(t){if(!this.el)return;const{frameW:e,frameH:i}=this.config,r=-(this.currentFrame*e),n=-(t.row*i);this.el.style.backgroundPosition=`${r}px ${n}px`}_triggerCSSFallback(t){if(!this.el)return;const i={attack:"combat-unit--attack-player",hurt:"combat-unit--hit",death:"combat-unit--death"}[t];i&&(this.el.classList.add(i),setTimeout(()=>this.el?.classList.remove(i),600))}}const Pt=new Map;function yi(a,t){Pt.set(a,t)}function Me(){Pt.forEach(a=>a.destroy()),Pt.clear()}function Z(a,t,e=null){const i=Pt.get(a);i&&i.play(t,e)}let h=null,F=null,V=null,Wt=[],K=null,M=null,X=!1,_=1,U=!1,et=0;function hi(a,t,e){a.addEventListener(t,e),Wt.push({target:a,type:t,fn:e})}function xt(){Wt.forEach(({target:a,type:t,fn:e})=>a.removeEventListener(t,e)),Wt=[],h&&(h.destroy(),h=null),K&&(clearInterval(K),K=null),Me(),M=null,X=!1,_=1,U=!1,et=0}const oe={feu:"🔥",glace:"❄️",foudre:"⚡",nature:"🌿",tenebres:"💀",physique:"⚔️"},Ut={feu:"#E85D20",glace:"#60A5FA",foudre:"#FBBF24",nature:"#4ADE80",tenebres:"#A855F7",physique:"#F87171"};function Zt(a={}){const t=a.zone||F,e=parseInt(a.level??V??0);U=!!a.berserk,F=t,V=e,et=0;const i=N.find(s=>s.id===t);if(!i){xt(),$.navigate("campaign");return}const r=g.getTeamInstances();if(r.length===0){xt(),$.navigate("team");return}const n=e===(i.levels||20)-1,o=Je(t,e,g.state.playerLevel);h=new vi(r,o),h.onTick=s=>{document.getElementById("atb-battlefield")&&($i(s.timeline),Si(),Di())},h.onPlayerReady=s=>{if(X){const l=s.skills||[],c=l.filter(b=>b.type==="physical"||b.type==="magical"),p=l.filter(b=>b.type==="heal"),f=h.playerTeam.filter(b=>b.alive).find(b=>b.currentHp/b.maxHp<.4);let u=0,x=null;if(p.length&&f)u=l.indexOf(p[0]),x=f.id;else if(c.length){const b=c.sort((C,y)=>y.power-C.power)[0];u=l.indexOf(b),x=h.enemyTeam.filter(C=>C.alive).sort((C,y)=>C.currentHp-y.currentHp)[0]?.id}const k=_>=4?80:200;setTimeout(()=>{h&&x!==null&&(M=x,se(u,s))},k);return}Ci(s),Ai(s.id)},h.onActionExecuted=s=>{Li(s)},h.onLog=s=>{const l=document.getElementById("atb-combat-log");l&&(l.textContent=s)},h.onBreak=s=>{Pi(s.id)},h.onGameOver=s=>{setTimeout(()=>_i(i,n),600)};const d=h.enemyTeam.find(s=>s.alive);d&&(M=d.id),wi(i),h.start()}function wi(a,t){const e=document.getElementById("app");e.innerHTML=`
  ...
  `,Ii(),Ei(),hi(window,"keydown",r=>{if(!h||!h.paused)return;const n=h.activeUnit;if(!n)return;const d={a:0,z:1,e:2,r:3}[r.key.toLowerCase()];d!==void 0&&n.skills[d]&&se(d,n),r.code==="Space"&&(r.preventDefault(),h.executeGuard(),Kt())}),document.getElementById("flee-btn").addEventListener("click",()=>{confirm("Fuir le combat ?")&&(xt(),$.navigate("campaign"))}),document.getElementById("speed-btn").addEventListener("click",()=>{_=_===1?2:_===2?4:1;const r=document.getElementById("speed-btn");r&&(r.textContent=`⚡ x${_}`,r.style.color=_===1?"var(--text-bright)":_===2?"#FBBF24":"#FF6B2C",r.style.borderColor=_===1?"rgba(200,155,60,0.3)":_===2?"rgba(251,191,36,0.5)":"rgba(255,107,44,0.5)"),h&&h.setSpeed(_)}),document.getElementById("auto-btn").addEventListener("click",()=>{X=!X;const r=document.getElementById("auto-btn");r&&(r.style.color=X?"#4ADE80":"var(--text-muted)",r.style.borderColor=X?"rgba(74,222,128,0.5)":"rgba(200,155,60,0.3)",r.style.background=X?"rgba(74,222,128,0.1)":"rgba(0,0,0,0.6)",r.textContent=X?"🤖 AUTO":"AUTO")}),document.getElementById("atb-guard-btn").addEventListener("click",()=>{h?.paused&&(h.executeGuard(),Kt())}),Oi(a.id)}function $i(a){const t=document.getElementById("atb-timeline-track");if(!t)return;const e=a.slice(0,10);t.innerHTML=e.map((i,r)=>{const n=i.isPlayer?"var(--accent-light)":"var(--danger)",o=i.isReady?"#fff":i.isPlayer?"var(--accent)":"rgba(220,38,38,0.5)",d=Math.min(100,i.atbPct),s=i.name.split(" ")[0].substring(0,5),l=i.isBroken?"atb-portrait--broken":"",c=i.isReady?"atb-portrait--ready":"";return`
      <div class="atb-portrait ${l} ${c}" style="--atb-pct:${d}%;border-color:${o}" title="${i.name}">
        ...
        <div class="atb-portrait-icon">${i.isPlayer?ki(i.type):i.isBoss?"💀":"👹"}</div>
        <div class="atb-portrait-name">${s}</div>
      </div>
    `}).join("")}function ki(a){return{guerrier:"⚔️",mage:"🔮",arche:"🏹",assassin:"🗡️"}[a]||"⚔️"}function Ei(){const a=document.getElementById("player-portraits");!a||!h||(a.innerHTML=h.playerTeam.map(t=>{const e=t.currentHp/t.maxHp*100,i=Math.max(0,t.atbGauge/t.atbMax*100);return`
    ...
    `}).join(""))}function zi(){if(h)for(const a of h.playerTeam){const t=document.querySelector(`[data-hp-bar="${a.id}"]`),e=document.querySelector(`[data-atb-bar="${a.id}"]`);if(t){const r=Math.max(0,a.currentHp/a.maxHp*100);t.style.width=r+"%";const n=r<=25?"low":r<=50?"medium":"";t.className=`bar-fill bar-fill--hp ${n}`}if(e){const r=Math.max(0,Math.min(100,a.atbGauge/a.atbMax*100));e.style.width=r+"%"}const i=document.querySelector(`[data-portrait-id="${a.id}"]`);i&&(i.style.opacity=a.alive?"1":"0.3",i.style.filter=a.alive?"":"grayscale(1)")}}function Be(){const a=document.getElementById("target-info-panel");if(!a||!h)return;const t=M?h.findUnit(M):null;if(!t||!t.alive||t.isPlayer){a.style.opacity="0";return}a.style.opacity="1";const e=t.currentHp/t.maxHp*100,i=(t.breakGauge||0)/(t.breakMax||100)*100,r=oe[t.weakness]||"⚔️",n=Ut[t.weakness]||"#F87171";a.innerHTML=`
  ...
  `}function Ii(){const a=document.getElementById("unit-container");if(!a||!h)return;const t=[...h.playerTeam,...h.enemyTeam];a.innerHTML=t.map(e=>Ti(e)).join(""),Me(),t.forEach(e=>{if(!e.alive)return;const i=a.querySelector(`[data-unit-id="${e.id}"] img.sprite`);if(!i)return;const r=e.isBoss?"boss":e.isEnemy?"minion":e.type||"guerrier",n=e.isBoss?"boss":e.isEnemy?"minion":"character",o=new bi(i.parentElement,r,n);yi(e.id,o)}),a.querySelectorAll(".enemy-unit").forEach(e=>{e.addEventListener("click",()=>{const i=e.dataset.unitId,r=h?.findUnit(i);r&&!r.isPlayer&&r.alive&&(M=i,Be(),Re())})})}function Ti(a){const t=Math.max(0,a.currentHp/a.maxHp)*100,e=a.isBoss,i=a.isPlayer,r=e?re(a.useNewBossSprite):a.isEnemy?ne():B(a.type),n=a.x,o=a.id===M,d=!i&&a.weakness&&oe[a.weakness]||"";return`
    <div class="${i?"player-unit":"enemy-unit"} combat-unit"
      ...
      ${!i&&a.weakness?`
        <div class="atb-weakness-badge" style="--weak-color:${Ut[a.weakness]||"#F87171"}">
          ${d}
        </div>
      `:""}
  ...
  `}function Si(){if(!h)return;const a=[...h.playerTeam,...h.enemyTeam];for(const t of a){const e=document.querySelector(`[data-unit-id="${t.id}"]`);if(!e)continue;const i=document.querySelector(`[data-unit-hp="${t.id}"]`);if(i){const o=Math.max(0,t.currentHp/t.maxHp*100);i.style.width=o+"%";const d=o<=25?"low":o<=50?"medium":"";i.className=`bar-fill bar-fill--hp ${d}`}const r=document.querySelector(`[data-unit-hp-text="${t.id}"]`);r&&(r.textContent=`${Math.max(0,t.currentHp)}/${t.maxHp}`),t.alive||(e.style.opacity="0.2",e.style.filter="grayscale(1)",e.style.pointerEvents="none");const n=document.querySelector(`[data-break-ring="${t.id}"] circle:nth-child(2)`);if(n){const o=(t.breakGauge||0)/(t.breakMax||100),d=2*Math.PI*18;n.setAttribute("stroke-dashoffset",d*(1-o)),n.setAttribute("stroke",t.isBroken?"#FF6B35":"#FBBF24")}}if(M){const t=h.findUnit(M);if(!t||!t.alive){const e=h.enemyTeam.find(i=>i.alive);M=e?e.id:null}}zi(),Be(),Re()}function Re(){if(document.querySelectorAll(".selection-ring").forEach(a=>a.remove()),M){const a=document.querySelector(`[data-unit-id="${M}"]`);if(a&&!a.querySelector(".selection-ring")){const t=document.createElement("div");t.className="selection-ring",t.style.left="50%",a.insertBefore(t,a.firstChild)}}}function Ai(a){document.querySelectorAll(".atb-active-highlight").forEach(i=>i.remove());const t=document.querySelector(`[data-unit-id="${a}"]`);if(t){const i=document.createElement("div");i.className="atb-active-highlight",t.appendChild(i)}document.querySelectorAll(".atb-hero-portrait").forEach(i=>i.classList.remove("atb-hero-portrait--active"));const e=document.querySelector(`[data-portrait-id="${a}"]`);e&&e.classList.add("atb-hero-portrait--active")}function Ci(a,t,e){const i=document.getElementById("atb-skill-buttons");if(!i)return;i.innerHTML=a.skills.map((n,o)=>{const d=n.speed==="fast"?"atb-skill--fast":n.speed==="heavy"?"atb-skill--heavy":"atb-skill--medium",s=n.speed==="fast"?"⚡ Rapide":n.speed==="heavy"?"🐢 Lourd":"⚖️ Normal",l=((n.recovery||2e3)/1e3).toFixed(1),c=n.element&&oe[n.element]||"",p=n.element&&Ut[n.element]||"#F87171",m=n.type==="heal"?"💚 Soin":n.type==="buff"?"✨ Buff":n.type==="magical"?"🔮 Magique":"⚔️ Physique",f=n.power?`${n.power}%`:"—",u=M?h?.findUnit(M):null,x=u&&u.weakness&&n.element===u.weakness;return`
      <button class="atb-skill-btn ${d}" data-skill-idx="${o}" style="position:relative">
    ...
    `}).join(""),i.querySelectorAll(".atb-skill-btn").forEach(n=>{const o=n.querySelector(".skill-tooltip");o&&(n.addEventListener("mouseenter",()=>{o.style.opacity="1"}),n.addEventListener("mouseleave",()=>{o.style.opacity="0"}))}),i.querySelectorAll(".atb-skill-btn").forEach(n=>{n.addEventListener("click",()=>{const o=parseInt(n.dataset.skillIdx);se(o,a)})});const r=document.getElementById("atb-action-panel");r&&r.classList.add("atb-action-panel--active")}function se(a,t){if(!h?.paused)return;const e=t.skills[a];if(e){if(e.type==="heal"||e.type==="buff")h.executePlayerAction(a,t.id);else if(M)h.executePlayerAction(a,M);else{const i=document.getElementById("atb-combat-log");i&&(i.textContent="🎯 Ciblez un ennemi (Clic Gauche) !");return}Kt()}}function Kt(){const a=document.getElementById("atb-action-panel");a&&a.classList.remove("atb-action-panel--active"),document.querySelectorAll(".atb-active-highlight").forEach(e=>e.remove()),document.querySelectorAll(".atb-hero-portrait--active").forEach(e=>e.classList.remove("atb-hero-portrait--active"));const t=document.getElementById("atb-skill-buttons");t&&(t.innerHTML='<div style="color:var(--text-muted);font-size:11px;padding:10px;letter-spacing:1px">⏳ ATB en cours...</div>')}function Li(a){const{actor:t,skill:e,results:i,isPlayer:r}=a,n=document.querySelector(`[data-unit-id="${t.id}"]`);n&&(e.type==="physical"?(n.classList.add(r?"combat-unit--dash-right":"combat-unit--dash-left"),Z(t.id,"attack",()=>Z(t.id,"idle")),setTimeout(()=>n.classList.remove("combat-unit--dash-right","combat-unit--dash-left"),600)):(n.classList.add("combat-unit--casting"),Z(t.id,"attack",()=>Z(t.id,"idle")),setTimeout(()=>n.classList.remove("combat-unit--casting"),600))),t.type==="mage"&&e.type!=="heal"&&e.type!=="buff"&&i.hits?.length>0&&Mi(t,i.hits[0].targetId,e),setTimeout(()=>{let o=!1,d=0;if(i.hits&&(i.hits.forEach(s=>{s.isCrit&&(o=!0),d+=s.damage||0,Bi(s.targetId,s.isCrit),xe(s.targetId,s.damage,s.isCrit,!1);const l=h?.findUnit(s.targetId);l&&!l.alive&&setTimeout(()=>Ri(s.targetId),300)}),d>0&&r&&(g.updateDailyStat("damage",d),et+=d),o)){const s=document.querySelector(".combat-screen");s&&(s.classList.add("screen--shake"),setTimeout(()=>s.classList.remove("screen--shake"),400))}i.heals&&i.heals.forEach(s=>{xe(s.targetId,s.amount,!1,!0)})},350)}function Mi(a,t,e){const i=document.getElementById("atb-battlefield"),r=document.querySelector(`[data-unit-id="${t}"]`);if(!i||!r)return;const n=i.getBoundingClientRect(),o=r.getBoundingClientRect(),d=o.left-n.left+o.width/2,s=o.top-n.top+o.height/2,l=a.x+55,c=a.y+60,p=e.element&&Ut[e.element]||"#ff6b9d",m=document.createElement("div");m.style.cssText=`position:absolute; left:${l}px; top:${c}px; width:24px; height:24px;
    background:radial-gradient(circle, ${p} 20%, transparent); border-radius:50%;
    box-shadow:0 0 15px ${p}; z-index:20; transition: all 0.45s cubic-bezier(0.4,0,0.2,1);`,i.appendChild(m),requestAnimationFrame(()=>{m.style.left=d+"px",m.style.top=s+"px",m.style.transform="scale(1.5)"}),setTimeout(()=>m.remove(),500)}function Bi(a,t){const e=document.querySelector(`[data-unit-id="${a}"]`);if(!e)return;const i=t?"combat-unit--crit":"combat-unit--hit";e.classList.add(i),Z(a,"hurt",()=>Z(a,"idle")),setTimeout(()=>e.classList.remove(i),500)}function Ri(a){const t=document.querySelector(`[data-unit-id="${a}"]`);t&&(t.classList.add("combat-unit--death"),Z(a,"death"))}function Pi(a){const t=document.querySelector(`[data-unit-id="${a}"]`),e=document.getElementById("atb-battlefield");if(!t||!e)return;t.classList.add("combat-unit--break"),setTimeout(()=>t.classList.remove("combat-unit--break"),700);const i=document.createElement("div");i.style.cssText="position:absolute;inset:0;background:rgba(251,191,36,0.15);z-index:30;pointer-events:none;animation:fadeIn 0.1s ease, fadeOut 0.5s ease 0.2s forwards",e.appendChild(i),setTimeout(()=>i.remove(),700);const r=document.querySelector(".combat-screen");r&&(r.classList.add("screen--shake"),setTimeout(()=>r.classList.remove("screen--shake"),400));const n=t.getBoundingClientRect(),o=e.getBoundingClientRect(),d=document.createElement("div");d.style.cssText=`position:absolute;left:${n.left-o.left+n.width/2}px;top:${n.top-o.top-20}px;
    ...
    animation:damageFloat 1.2s ease forwards;pointer-events:none;z-index:35;letter-spacing:3px`,d.textContent="💥 BREAK!",e.appendChild(d),setTimeout(()=>d.remove(),1200)}function xe(a,t,e,i){const r=document.querySelector(`[data-unit-id="${a}"]`);if(!r)return;const n=document.createElement("div");n.className=`damage-number ${i?"damage-number--heal":""} ${e?"damage-number--crit":""}`,n.textContent=`${i?"+":"-"}${t}`,r.appendChild(n),setTimeout(()=>n.remove(),1e3)}function Di(){if(!h)return;const a=Math.floor(h.elapsedTime/1e3),t=Math.floor(a/60),e=a%60,i=document.getElementById("atb-timer");i&&(i.textContent=`${String(t).padStart(2,"0")}:${String(e).padStart(2,"0")}`);const r=document.getElementById("atb-dmg-total");r&&(r.textContent=`⚔ ${(h.totalDmgDealt||0).toLocaleString()} dmg`)}const be={enchantement:{emoji:"✨",count:15,speed:4,opacity:.6,sway:40},osiris:{emoji:"🏜️",count:20,speed:3,opacity:.4,sway:60,altEmoji:"💨"},supplice:{emoji:"🫧",count:12,speed:5,opacity:.5,sway:30},maragorh:{emoji:"🍃",count:18,speed:3.5,opacity:.5,sway:50,altEmoji:"🌿"},imotep:{emoji:"🌋",count:15,speed:2.5,opacity:.4,sway:20,altEmoji:"✦"},abysses:{emoji:"🫧",count:20,speed:6,opacity:.5,sway:60,altEmoji:"💎"},citadelle:{emoji:"⚡",count:12,speed:2,opacity:.4,sway:30,altEmoji:"✦"},terre_desolee:{emoji:"🔥",count:25,speed:3,opacity:.5,sway:20,altEmoji:"💀"},nexus:{emoji:"🌌",count:18,speed:5,opacity:.6,sway:50,altEmoji:"💫"}};function Oi(a){const t=document.getElementById("ambient-particles");if(!t)return;const e=be[a]||be.enchantement;K&&clearInterval(K);function i(){if(!document.getElementById("ambient-particles")){clearInterval(K);return}const r=document.createElement("div"),n=e.altEmoji&&Math.random()>.6,o=(Math.random()-.5)*2*e.sway,d=(Math.random()-.5)*720,s=Math.random()*100,l=e.speed+Math.random()*3,c=8+Math.random()*12;r.textContent=n?e.altEmoji:e.emoji,r.style.cssText=`position:absolute;left:${s}%;top:-20px;font-size:${c}px;
      --p-sway:${o}px;--p-rot:${d}deg;--p-opacity:${e.opacity};
      animation:ambientFall ${l}s linear forwards;pointer-events:none;z-index:0;`,t.appendChild(r),setTimeout(()=>r.remove(),l*1e3+100)}for(let r=0;r<Math.floor(e.count/3);r++)setTimeout(i,r*200);K=setInterval(i,1e4/e.count)}function _i(a,t){if(!h)return;const e=h.winner==="player",i=document.getElementById("victory-overlay");if(i)if(e){const r=h.playerTeam,n=r.reduce((v,w)=>v+w.maxHp,0),d=r.reduce((v,w)=>v+Math.max(0,w.currentHp),0)/n,s=d>=.7?3:d>=.35?2:1,l=g.getLevelFlames(F,V),c=l===0,p=s>l;let f=(t?me.boss:me.normal)[s]||0;!c&&!p&&(f=Math.floor(f*.3));const u=V+1,x=Math.floor(t?u*8+150:s===3?u*5+80:s===2?u*3+50:u*2+30);let k=c?x:Math.floor(x*.3),b=Math.floor(k/3);g.completeLevel(F,V,s),g.addArchireve(f);const z=g.addTeamXp(k);g.addProfileXp(b),g.recordBattle(!0),g.updateDailyStat("wins",1),g.updateDailyStat("levels",1),g.checkAchievements(),g.getTeamInstances().forEach(v=>{const w=g.state.ownedCharacters.find(S=>S.id===v.id);w&&(w.currentHp=void 0)});const R=Math.floor(h.elapsedTime/1e3),C=`${Math.floor(R/60)}:${String(R%60).padStart(2,"0")}`,y=h.totalDmgDealt||et||0;g.recordCombat({zone:F,won:!0,timeSeconds:R,totalDamage:y,flames:s,type:"campaign",isBerserk:U}),U&&g.setBerserkClear(F,V);const E=document.createElement("div");E.className="victory-banner",E.innerHTML=`
      <div style="font-family:var(--font-title);font-size:44px;letter-spacing:6px;color:#ff6b9d;text-shadow:0 0 30px rgba(255,107,157,0.5);margin-bottom:${U?8:16}px">VICTOIRE</div>
      ${U?'<div style="font-size:13px;color:#FBBF24;letter-spacing:2px;margin-bottom:8px;background:rgba(251,191,36,0.1);padding:4px 16px;border-radius:20px;border:1px solid rgba(251,191,36,0.3)">🔥 MODE BERSERK · RÉCOMPENSES DOUBLÉES</div>':""}
      ...
      <div style="font-size:10px;color:var(--text-muted);margin-bottom:12px">⏱ ${C} · ⚔ ${y.toLocaleString()} dégâts</div>
      <div style="display:flex;justify-content:center;gap:14px;margin:16px 0 24px">
        ${Array.from({length:3},(v,w)=>`<span style="font-size:36px;filter:drop-shadow(0 0 12px #E85D20);transition:all 0.3s ease;${w>=s?"opacity:0.18;filter:grayscale(1)":""}">${t?"🔥":"🍃"}</span>`).join("")}
      </div>
      <div style="display:flex;flex-direction:column;align-items:center;gap:10px;padding:16px 24px;background:rgba(0,0,0,0.25);border-radius:var(--radius-xl);border:1px solid rgba(255,255,255,0.06);margin-bottom:8px">
        ...
        ${z.some(v=>v.leveled)?'<div style="font-size:11px;color:var(--legendaire);font-weight:700">⬆️ Level Up !</div>':""}
        ${!c&&!p?'<div style="font-size:9px;color:var(--text-muted)">Récompenses réduites (déjà complété)</div>':""}
      </div>
    `,i.appendChild(E),z.some(v=>v.leveled)&&setTimeout(()=>ji(z),700),setTimeout(()=>{const v=document.createElement("div");v.style.cssText="position:absolute;bottom:60px;left:50%;transform:translateX(-50%);z-index:50;display:flex;gap:12px;animation:fadeIn 0.5s ease";const w=V+1,S=N.find(rt=>rt.id===F),W=S&&w<S.levels;v.innerHTML=`
        ${W?'<button id="next-level-btn" class="btn btn--primary" style="border-radius:var(--radius-xl);padding:14px 28px;font-size:13px;letter-spacing:1px">▶ Niveau suivant</button>':""}
      ...
      `,i.appendChild(v),document.getElementById("next-level-btn")?.addEventListener("click",()=>{M=null,Zt({zone:F,level:w,berserk:U})}),document.getElementById("back-campaign-btn")?.addEventListener("click",()=>{xt(),$.navigate("campaign")})},1500)}else{const r=Math.floor((h?.elapsedTime||0)/1e3);g.recordCombat({zone:F,won:!1,timeSeconds:r,totalDamage:et,flames:0,type:"campaign",isBerserk:U}),g.recordBattle(!1),i.innerHTML=`
      <div style="position:absolute; inset:0; background:rgba(0,0,0,0.8); display:flex; flex-direction:column; align-items:center; justify-content:center; z-index:100; animation: fadeIn 0.5s ease">
        ...
        <div style="font-size:10px;color:var(--text-muted);margin-bottom:6px">⏱ ${r}s · ⚔ ${et.toLocaleString()} dégâts</div>
    ...
    `,document.getElementById("retry-btn").onclick=()=>Zt({zone:F,level:V,berserk:U}),document.getElementById("back-btn").onclick=()=>{xt(),$.navigate("campaign")}}}function ji(a){const t=a.filter(n=>n.leveled);if(!t.length)return;const e=document.createElement("div");e.style.cssText=`
  ...
  `;const i=t.map(n=>`
    <div style="
      ...
      min-width:180px;
    ">
      <div style="font-size:40px;margin-bottom:8px;filter:drop-shadow(0 0 20px rgba(200,155,60,0.6))">${n.icon||"⭐"}</div>
      ...
      <div style="font-family:var(--font-title);font-size:18px;font-weight:700;color:var(--text-bright);margin-bottom:8px">${n.name||"Héros"}</div>
  ...
  `,document.body.appendChild(e);const r=setTimeout(()=>e.remove(),3e3);e.addEventListener("click",()=>{clearTimeout(r),e.remove()})}const qt=75,Gt=15;function Qt(){const a=document.getElementById("app"),t=g.state,e=t.pityCount||0,i=t.pityEpic||0,r=t.scories||0,n=Math.min(100,Math.round(e/qt*100)),o=Math.min(100,Math.round(i/Gt*100)),d=t.archireve>=J.single,s=t.archireve>=J.multi;a.innerHTML=`
        ...
        <!-- Portal Animation -->
          ...
          <div style="display:flex;flex-direction:column;gap:10px;width:100%">
            <button class="btn btn--primary btn--full" id="char-pull-single" ${d?"":"disabled"}
              ...
              <span style="font-size:9px;opacity:0.7;letter-spacing:1px">◆ ${J.single.toLocaleString()} · ×1 Héros</span>
            </button>
            <button class="btn btn--star btn--full" id="char-pull-multi" ${s?"":"disabled"}
              ...
              <span style="font-size:9px;opacity:0.7;letter-spacing:1px">◆ ${J.multi.toLocaleString()} · ×10 — Epique+ garanti</span>
            </button>
          </div>
        </div>
        ...
        <div style="flex:1;min-width:380px;max-width:480px;display:flex;flex-direction:column;align-items:center;
          ...
          <div style="display:flex;flex-direction:column;gap:10px;width:100%">
            <button class="btn btn--full" id="item-pull-single" ${d?"":"disabled"}
              ...
              <span style="font-size:9px;opacity:0.7;letter-spacing:1px">◆ ${J.single.toLocaleString()} · ×1 Item</span>
            </button>
      ...
      <div style="display:flex;gap:24px;justify-content:center;padding:0 48px;flex-wrap:wrap;max-width:1020px;margin:0 auto;width:100%">
        ...
        <div style="flex:1;min-width:280px;max-width:480px">
          ...
          <div class="pity-container" style="margin-bottom:12px">
            <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:6px">
              ...
              <div style="font-family:var(--font-stat);font-size:12px;color:var(--epique)">${i} / ${Gt}</div>
            </div>
            ...
            <div style="font-size:9px;color:var(--text-muted);letter-spacing:1px">${Gt-i} invocations avant un Epique garanti</div>
          </div>
          <!-- Scories -->
        ...
        <div class="glass" style="flex:1;min-width:280px;max-width:480px;padding:20px;border-radius:16px">
          ...
          <div style="display:flex;flex-direction:column;gap:8px">
            ${[{name:"Rare",color:"var(--rare)",pct:wt.rare},{name:"Epique",color:"var(--epique)",pct:wt.epique},{name:"Legendaire",color:"var(--legendaire)",pct:wt.legendaire},{name:"ULTIMATE",color:"var(--ultimate)",pct:wt.ultimate}].map(l=>`
  ...
  `,document.getElementById("back-btn").addEventListener("click",()=>$.navigate("home")),document.getElementById("char-pull-single").addEventListener("click",()=>{const l=Ye();l.success?(Et(1,l.results[0]?.rarity),g.updateDailyStat("pulls",1),zt(l.results)):It(l.error,"error")}),document.getElementById("char-pull-multi").addEventListener("click",()=>{const l=We();l.success?(Et(10,null,l.characters.map(c=>c.rarity)),g.updateDailyStat("pulls",10),zt(l.characters)):It(l.error,"error")}),document.getElementById("item-pull-single").addEventListener("click",()=>{const l=Ze();l.success?(Et(1,l.results[0]?.rarity),g.updateDailyStat("pulls",1),zt(l.results)):It(l.error,"error")}),document.getElementById("item-pull-multi").addEventListener("click",()=>{const l=Ke();l.success?(Et(10,null,l.characters.map(c=>c.rarity)),g.updateDailyStat("pulls",10),zt(l.characters)):It(l.error,"error")})}function Et(a,t,e){const i=g.state;i.pityCount=(i.pityCount||0)+a,i.pityEpic=(i.pityEpic||0)+a,i.scories=(i.scories||0)+a*10;const r=e||(t?[t]:[]);for(const n of r)n==="legendaire"||n==="ultimate"?(i.pityCount=0,i.pityEpic=0):n==="epique"&&(i.pityEpic=0);g.save?.()}function zt(a){const t=document.createElement("div");t.className="modal-overlay",t.style.cssText="flex-direction:column;gap:0;background:rgba(0,0,0,0.97)";let e=0;const i={rare:{color:"#4a9eff",glow:"rgba(74,158,255,0.4)",name:"RARE"},epique:{color:"#c44aff",glow:"rgba(196,74,255,0.5)",name:"EPIQUE"},legendaire:{color:"#ffb84a",glow:"rgba(255,184,74,0.5)",name:"LEGENDAIRE"},ultimate:{color:"#ff4a6a",glow:"rgba(255,74,106,0.6)",name:"ULTIMATE"}},r={rare:0,epique:1,legendaire:2,ultimate:3};function n(d){const s=a[d],l=s.rarity||"rare",c=i[l]||i.rare,p=r[l]||0;t.innerHTML=`
      <div style="display:flex;flex-direction:column;align-items:center;justify-content:center;width:100%;height:100%;position:relative;cursor:pointer" id="forge-phase">
        ...
        <div style="position:relative;width:160px;height:160px;display:flex;align-items:center;justify-content:center">
          ...
          <div style="font-size:64px;filter:drop-shadow(0 0 30px ${c.glow});animation:crystalGlow 1.5s ease infinite alternate;color:${c.color}">${s.type==="item"?"📦":"&#9874;"}</div>
    ...
    `;const m=document.getElementById("forge-sparks");if(m){for(let u=0;u<30;u++)setTimeout(()=>{const x=document.createElement("div"),k=Math.random()*Math.PI*2,b=80+Math.random()*200;x.style.cssText="position:absolute;left:50%;top:50%;width:"+(2+Math.random()*3)+"px;height:"+(4+Math.random()*8)+"px;background:linear-gradient("+c.color+",transparent);border-radius:50% 50% 0 0;opacity:0;transform-origin:bottom center;animation:particleBurst 1.2s "+(.6+Math.random()*.6)+"s ease forwards;--dx:"+Math.cos(k)*b+"px;--dy:"+Math.sin(k)*b+"px;",m.appendChild(x)},u*40);const f=document.createElement("style");f.textContent="@keyframes particleBurst { 0%{transform:translate(-50%,-50%) scale(0);opacity:1} 100%{transform:translate(calc(-50% + var(--dx)),calc(-50% + var(--dy))) scale(0.2);opacity:0} }",t.appendChild(f)}document.getElementById("forge-phase").addEventListener("click",()=>o(d))}function o(d){const s=a[d],l=s.type==="item",c=s.rarity||"rare",p=i[c]||i.rare;let m,f,u,x,k;if(l&&s.item){const b=s.item,z=at[b.slot]||{name:b.slot,icon:""};m=b.name,f=b.desc||"",u='<div style="font-size:72px;margin:16px 0;filter:drop-shadow(0 0 25px '+p.glow+')">'+(b.icon||"📦")+"</div>";const R=Object.entries(b.stats||{}).map(C=>C[0].toUpperCase()+" +"+C[1]).join(" · ");x='<span class="type-badge" style="background:rgba(74,158,255,0.15);color:#4a9eff">'+z.icon+" "+z.name+'</span><span class="rarity-badge rarity-badge--'+c+'">'+c.toUpperCase()+"</span>",f+='<br><span style="color:var(--accent);font-size:10px;letter-spacing:1px">'+R+"</span>",k="📦 ITEM"}else{const b=s.character;m=b.name,f=b.desc,u='<img src="'+B(b.type)+'" class="sprite sprite--xxl" alt="'+b.name+'" style="filter:drop-shadow(0 0 25px '+p.glow+') drop-shadow(0 4px 8px rgba(0,0,0,0.5));animation:pullRevealSprite 0.6s ease">',x='<span class="type-badge type-badge--'+b.type+'">'+b.type.toUpperCase()+'</span><span class="rarity-badge rarity-badge--'+b.rarity+'">'+b.rarity.toUpperCase()+"</span>",k="⚔️ HÉROS"}t.innerHTML='<div class="modal" style="text-align:center;border-color:'+p.color+";box-shadow:0 0 60px "+p.glow+';min-width:320px;max-width:380px;border-radius:var(--radius-xl);overflow:hidden;position:relative;padding:0;animation:revealSlam 0.5s cubic-bezier(0.2,1.5,0.3,1)"><div style="height:3px;background:linear-gradient(90deg,transparent,'+p.color+',transparent)"></div><div style="padding:var(--space-xl) var(--space-lg)"><div style="font-family:var(--font-stat);font-size:9px;color:'+p.color+';letter-spacing:3px;margin-bottom:4px;opacity:0.7">'+k+'</div><div style="font-family:var(--font-title);font-size:11px;color:'+p.color+";letter-spacing:4px;margin-bottom:var(--space-sm);text-shadow:0 0 15px "+p.glow+'">◆ '+p.name+" ◆</div>"+(s.isNew?'<div style="color:var(--success);font-size:11px;font-weight:700;margin-bottom:var(--space-xs);letter-spacing:2px">NOUVEAU !</div>':"")+(s.levelUp?'<div style="color:var(--warning);font-size:11px;font-weight:700;margin-bottom:var(--space-xs);letter-spacing:2px">NIVEAU + !</div>':"")+'<div style="position:relative;margin:var(--space-md) auto;width:fit-content">'+u+'<div style="position:absolute;inset:-20px;background:radial-gradient(circle,'+p.glow+',transparent 60%);z-index:-1;filter:blur(20px)"></div></div><div style="font-family:var(--font-title);font-size:18px;color:'+p.color+";font-weight:800;margin:var(--space-md) 0 var(--space-sm);letter-spacing:1px;text-shadow:0 0 10px "+p.glow+'">'+m+'</div><div style="display:flex;justify-content:center;gap:var(--space-sm);margin-bottom:var(--space-sm)">'+x+'</div><p style="font-size:11px;color:var(--text-secondary);line-height:1.6;margin-bottom:var(--space-lg)">'+f+'</p><div style="font-size:10px;color:var(--text-muted);margin-bottom:var(--space-md);letter-spacing:1px">'+(d+1)+" / "+a.length+'</div><button class="btn btn--primary btn--full" id="pull-next" style="border-radius:var(--radius-lg)">'+(d<a.length-1?"SUIVANT":"TERMINER")+"</button>"+(a.length>1&&d<a.length-1?'<button class="btn btn--ghost btn--full btn--sm" id="skip-all" style="margin-top:var(--space-xs);font-size:9px;letter-spacing:2px">PASSER TOUT</button>':"")+"</div></div><style>@keyframes pullRevealSprite { 0%{transform:scale(0.2) rotate(-15deg);opacity:0;filter:brightness(3)} 50%{transform:scale(1.15) rotate(3deg)} 100%{transform:scale(1) rotate(0);opacity:1} }@keyframes revealSlam { 0%{transform:scale(0.5) translateY(30px);opacity:0} 60%{transform:scale(1.05) translateY(-5px)} 100%{transform:scale(1) translateY(0);opacity:1} }</style>",document.getElementById("pull-next").addEventListener("click",()=>{d<a.length-1?(e++,n(e)):(t.remove(),Qt())}),document.getElementById("skip-all")?.addEventListener("click",()=>{t.remove(),Qt()})}document.body.appendChild(t),n(0)}function It(a,t="warning"){const e=document.createElement("div");e.className="toast toast--"+t,e.textContent=a,document.body.appendChild(e),setTimeout(()=>e.remove(),3e3)}let At="all",Ct="all",lt="rarity";const tt={guerrier:"#f87171",mage:"#c084fc",arche:"#86efac",assassin:"#ff6b9d"},gt={hp:"HP",atk:"ATK",def:"DEF",spd:"SPD",magAtk:"MAG",magDef:"RES"},ye=["ultimate","legendaire","epique","rare"];function H(){const a=document.getElementById("app"),t=g.state,e=t.team,i=g.getTeamInstances(),r=g.getOwnedInstances();let n=[...r];At!=="all"&&(n=n.filter(s=>s.type===At)),Ct!=="all"&&(n=n.filter(s=>s.rarity===Ct)),n.sort((s,l)=>lt==="rarity"?ye.indexOf(s.rarity||"rare")-ye.indexOf(l.rarity||"rare"):lt==="level"?l.level-s.level:lt==="atk"?l.stats.atk+l.stats.magAtk-(s.stats.atk+s.stats.magAtk):0);const o=Ni(i),d=i.reduce((s,l)=>s+Object.values(l.stats).reduce((c,p)=>c+p,0),0);a.innerHTML=`
        ...
        ">
          ...
          <div style="padding:0 28px;flex-shrink:0">
            <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:14px;margin-bottom:24px">
              ${[0,1,2,3].map(s=>{const l=e[s];if(l){const c=t.ownedCharacters.find(m=>m.id===l),p=vt(l,c?.level||1)||g.getFusedCharacterData(l);if(p){const m=`var(--${p.rarity||"rare"})`,f=tt[p.type]||"var(--accent)",u=Math.floor(100*Math.pow(1.1,p.level-1)),x=Math.round((c?.xp||0)/u*100);return`
                      <div class="team-slot-card" data-slot="${s}" data-char-id="${l}" style="
                        ...
                        <div style="display:flex;justify-content:space-around;margin-top:10px">
                          ${["hp","atk","spd"].map(k=>`
                            <div style="text-align:center">
                              ...
                              <div style="font-size:7px;color:var(--text-muted);letter-spacing:1px">${gt[k]}</div>
                            </div>
                          `).join("")}
                        </div>
                      </div>
              ...
              <table style="width:100%;border-collapse:collapse;font-family:var(--font-ui)">
                <thead>
                  <tr>
                    ...
                    ${Object.values(gt).map(s=>`<th style="text-align:center;padding:6px 4px;font-size:8px;letter-spacing:1px;color:var(--text-muted);border-bottom:1px solid var(--border-metal)">${s}</th>`).join("")}
                  </tr>
                </thead>
                <tbody>
                  ${i.map((s,l)=>(tt[s.type],`
                      <tr style="background:${l%2?"transparent":"rgba(200,155,60,0.015)"}">
                        ...
                        ${Object.keys(gt).map(c=>{const p=Math.max(...i.map(u=>u.stats[c]||0)),m=s.stats[c]||0;return`<td style="padding:6px 4px;text-align:center;border-bottom:1px solid rgba(200,155,60,0.03)">
        ...
        ">
          ...
          ">
            ...
            <div style="display:flex;gap:8px;margin-bottom:12px;flex-wrap:wrap">
              ${["all","guerrier","mage","arche","assassin"].map(s=>{const l=s===At,c=s==="all"?"var(--accent)":tt[s]||"var(--accent)";return`
            ...
            <div style="display:flex;gap:8px;align-items:center;flex-wrap:wrap">
              ${["all","rare","epique","legendaire","ultimate"].map(s=>{const l=s===Ct,c=s==="all"?"var(--text-muted)":`var(--${s})`;return`
              ...
              ${["rarity","level","atk"].map(s=>{const l=s===lt;return`
          ...
          <div style="flex:1;overflow-y:auto;padding:20px 28px;scrollbar-width:thin;scrollbar-color:rgba(200,155,60,0.1) transparent">
            ...
            `:`
              <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(170px,1fr));gap:14px">
                ${n.map(s=>{const l=e.includes(s.id),c=`var(--${s.rarity||"rare"})`,p=tt[s.type]||"var(--accent)",m=t.ownedCharacters.find(x=>x.id===s.id),f=Math.floor(100*Math.pow(1.1,s.level-1)),u=Math.round((m?.xp||0)/f*100);return`
                    <div class="roster-card ${l?"roster-card--in-team":""}" data-char-id="${s.id}" style="
                    ...
                    ">
                      ...
                      <!-- Rarity badge -->
                      <div style="position:absolute;top:7px;left:8px;font-family:var(--font-stat);font-size:7px;font-weight:700;color:${c};letter-spacing:1px">${(s.rarity||"").toUpperCase()}</div>

                      <img src="${B((s.type||"").split("/")[0])}" class="sprite sprite--md" alt="${s.name}" style="margin:6px auto 8px;display:block">

                      <div style="font-family:var(--font-title);font-size:10px;color:${c};font-weight:700;letter-spacing:0.5px;margin-bottom:3px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis">${s.name}</div>
                      ...
                      <div style="display:flex;justify-content:space-around">
                        ${[{stat:"hp",icon:"♥",color:"#EF4444"},{stat:"atk",icon:"⚔",color:"#f87171"},{stat:"spd",icon:"↗",color:"#C89B3C"}].map(x=>`
                          <div style="text-align:center">
                            ...
                            <div style="font-family:var(--font-stat);font-size:10px;font-weight:700;color:var(--text-secondary)">${s.stats[x.stat]}</div>
                          </div>
                        `).join("")}
                      </div>
                    </div>
  ...
  `,Fi(t,e)}function Fi(a,t){document.getElementById("back-btn")?.addEventListener("click",()=>$.navigate("home")),document.querySelectorAll(".filter-type-btn").forEach(e=>{e.addEventListener("click",()=>{At=e.dataset.filterType,H()})}),document.querySelectorAll(".filter-rarity-btn").forEach(e=>{e.addEventListener("click",()=>{Ct=e.dataset.filterRarity,H()})}),document.querySelectorAll(".sort-btn").forEach(e=>{e.addEventListener("click",()=>{lt=e.dataset.sort,H()})}),document.querySelectorAll(".remove-from-team").forEach(e=>{e.addEventListener("click",i=>{i.stopPropagation();const r=[...a.team];r[parseInt(e.dataset.slot)]=null,g.setTeam(r),H()})}),document.querySelectorAll(".roster-card:not(.roster-card--in-team)").forEach(e=>{e.addEventListener("click",()=>{const i=e.dataset.charId;if(t.includes(i))return;const r=t.indexOf(null);if(r===-1){Hi(i);return}const n=[...a.team];n[r]=i,g.setTeam(n),Ui(e),setTimeout(()=>H(),250)}),e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-4px) scale(1.02)",e.style.borderColor="rgba(200,155,60,0.25)",e.style.boxShadow="0 8px 30px rgba(0,0,0,0.5), 0 0 15px rgba(192,57,11,0.08)"}),e.addEventListener("mouseleave",()=>{e.style.transform="",e.style.borderColor="",e.style.boxShadow=""}),e.addEventListener("contextmenu",i=>{i.preventDefault(),he(e.dataset.charId)})}),document.querySelectorAll(".team-slot-card").forEach(e=>{e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-3px)",e.style.borderColor="rgba(200,155,60,0.25)",e.style.boxShadow="0 6px 20px rgba(0,0,0,0.5), 0 0 12px rgba(192,57,11,0.1)"}),e.addEventListener("mouseleave",()=>{e.style.transform="",e.style.borderColor="",e.style.boxShadow=""}),e.addEventListener("click",i=>{i.target.closest(".remove-from-team")||he(e.dataset.charId)})}),document.getElementById("btn-optimize")?.addEventListener("click",()=>{const e=qi();e&&(g.setTeam(e),H())}),document.getElementById("btn-clear-all")?.addEventListener("click",()=>{g.setTeam([null,null,null,null]),H()})}function Ui(a){a.style.transition="all 0.25s cubic-bezier(0.34,1.56,0.64,1)",a.style.transform="scale(0.92)",a.style.opacity="0.5"}function Hi(a){const t=g.state,e=document.createElement("div");e.className="modal-overlay";const i=t.ownedCharacters.find(o=>o.id===a),r=vt(a,i?.level||1)||g.getFusedCharacterData(a);if(!r)return;const n=`var(--${r.rarity||"rare"})`;e.innerHTML=`
    <div class="modal" style="text-align:center;max-width:400px;border-radius:12px;padding:32px">
      ...
      <div style="display:flex;flex-direction:column;gap:8px">
        ${t.team.map((o,d)=>{if(!o)return"";const s=t.ownedCharacters.find(p=>p.id===o),l=vt(o,s?.level||1)||g.getFusedCharacterData(o);if(!l)return"";const c=tt[l.type]||"var(--accent)";return`
  ...
  `,document.body.appendChild(e),e.querySelectorAll(".swap-btn").forEach(o=>{o.addEventListener("mouseenter",()=>{o.style.borderColor="var(--accent)",o.style.background="rgba(192,57,11,0.08)"}),o.addEventListener("mouseleave",()=>{o.style.borderColor="var(--border-metal)",o.style.background="rgba(20,12,6,0.8)"}),o.addEventListener("click",()=>{const d=[...t.team];d[parseInt(o.dataset.slot)]=a,g.setTeam(d),e.remove(),H()})}),document.getElementById("swap-cancel").addEventListener("click",()=>e.remove()),e.addEventListener("click",o=>{o.target===e&&e.remove()})}function he(a){const e=g.state.ownedCharacters.find(f=>f.id===a);if(!e)return;const i=vt(a,e.level)||g.getFusedCharacterData(a);if(!i)return;const r=tt[i.type]||"var(--accent)",n=`var(--${i.rarity||"rare"})`,o=g.getCharacterBonusStats(a);Object.values(o).some(f=>f>0);const d=Math.floor(100*Math.pow(1.1,i.level-1)),s=Math.round((e?.xp||0)/d*100),l=120,c=we(i.stats,l*.42),p=[.33,.66,1].map(f=>we({hp:1,atk:1,def:1,spd:1,magAtk:1,magDef:1},l*.42*f)),m=document.createElement("div");m.className="modal-overlay",m.innerHTML=`
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;margin-bottom:24px">
          ...
          <div style="background:rgba(0,0,0,0.2);border:1px solid var(--border);border-radius:10px;padding:16px;display:flex;align-items:center;justify-content:center">
            <svg viewBox="0 0 ${l} ${l}" style="width:${l}px;height:${l}px">
              ...
              ${Gi(l*.42,l/2).map(([f,u])=>`<line x1="${l/2}" y1="${l/2}" x2="${f}" y2="${u}" stroke="rgba(200,155,60,0.06)" stroke-width="0.5"/>`).join("")}
          ...
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px">
            ${Object.entries(gt).map(([f,u])=>{const x=i.stats[f]||0,k=o[f]||0,b=x+k;return`
  ...
  `,document.body.appendChild(m),document.getElementById("detail-close").addEventListener("click",()=>m.remove()),m.addEventListener("click",f=>{f.target===m&&m.remove()})}function Ni(a){if(!a.length)return{label:"Equipe vide",bonus:""};const t={};a.forEach(r=>{t[r.type]=(t[r.type]||0)+1});const e=Object.entries(t).sort((r,n)=>n[1]-r[1])[0],i=e[0].charAt(0).toUpperCase()+e[0].slice(1);return e[1]===4?{label:`Meute ${i}`,bonus:`+15% toutes les stats (${i})`}:e[1]===3?{label:`Formation ${i}`,bonus:`+10% ATK +5% SPD (${i})`}:e[1]===2?{label:`Duo ${i}`,bonus:`+5% ATK (${i})`}:Object.keys(t).length===4?{label:"Composition Mixte",bonus:"+3% SPD globale (flexibilite)"}:{label:"Standard",bonus:""}}function qi(){const a=g.state.ownedCharacters;return a.length<1?null:a.map(e=>{const i=P.find(n=>n.id===e.id)||g.getFusedCharacterData(e.id);if(!i)return null;const r={rare:1,epique:1.3,legendaire:1.7,ultimate:2.2,semi_ultimate:3.4,supreme:22}[i.rarity]||1;return{id:e.id,score:e.level*r}}).filter(Boolean).sort((e,i)=>i.score-e.score).slice(0,4).map(e=>e.id)}const le=["hp","atk","def","spd","magAtk","magDef"],de=a=>a*2*Math.PI/6-Math.PI/2;function we(a,t){const e={hp:800,atk:200,def:200,spd:150,magAtk:220,magDef:200};return le.map((i,r)=>{const d=Math.min(a[i]||0,e[i])/(e[i]||1)*t,s=de(r),l=60+d*Math.cos(s),c=60+d*Math.sin(s);return`${l.toFixed(1)},${c.toFixed(1)}`}).join(" ")}function Gi(a,t){return le.map((e,i)=>{const r=de(i);return[t+a*Math.cos(r),t+a*Math.sin(r)]})}function Vi(a,t,e){return le.map((i,r)=>{const n=de(r),o=t+14,d=e+o*Math.cos(n),s=e+o*Math.sin(n);return`<text x="${d.toFixed(1)}" y="${s.toFixed(1)}" text-anchor="middle" dominant-baseline="middle" fill="rgba(255,107,157,0.6)" font-size="8" font-family="DM Sans">${gt[i]}</text>`}).join("")}const Xi=[{id:"warrior",emoji:"⚔️",label:"Guerrier"},{id:"mage",emoji:"🔮",label:"Mage"},{id:"archer",emoji:"🏹",label:"Archer"},{id:"assassin",emoji:"🗡️",label:"Assassin"},{id:"paladin",emoji:"🛡️",label:"Paladin"},{id:"necro",emoji:"💀",label:"Nécromant"},{id:"dragon",emoji:"🐉",label:"Dragon"},{id:"wolf",emoji:"🐺",label:"Loup"},{id:"demon",emoji:"😈",label:"Démon"},{id:"phoenix",emoji:"🦅",label:"Phénix"},{id:"ghost",emoji:"👻",label:"Spectre"},{id:"king",emoji:"👑",label:"Roi"},{id:"samurai",emoji:"🥷",label:"Shinobi"},{id:"fire",emoji:"🔥",label:"Brasier"},{id:"skull",emoji:"💠",label:"Runique"},{id:"star",emoji:"⭐",label:"Étoile"}],nt=[{id:"gold",label:"Or",from:"#7A5A1A",to:"#E8B84C"},{id:"ember",label:"Braise",from:"#8B2500",to:"#F07030"},{id:"royal",label:"Royal",from:"#1A0A4A",to:"#7B3FEE"},{id:"blood",label:"Sang",from:"#4A0808",to:"#CC2222"},{id:"ocean",label:"Océan",from:"#0A2040",to:"#0070DD"},{id:"forest",label:"Forêt",from:"#0A2A10",to:"#ABD473"},{id:"silver",label:"Acier",from:"#1A1A2A",to:"#9D9D9D"},{id:"sakura",label:"Sakura",from:"#2A0A1A",to:"#FF6B9D"}];function Pe(){const a=document.getElementById("app"),t=g.state,e=t.profile||{},i=e.pseudo||"Héros",r=e.avatar||"⚔️",n=e.avatarType||"preset",o=e.customImg||null,d=e.bannerId||"gold",s=e.region||"Monde",l=e.level||1,c=e.xp||0,p=l*100,m=Math.min(100,Math.round(c/p*100)),f=t.totalBattles||0,u=t.totalWins||0,x=f-u,k=f>0?Math.round(u/f*100):0,b=nt.find(y=>y.id===d)||nt[0];a.innerHTML=`
        ...
        <div style="max-width:900px;margin:0 auto;display:grid;grid-template-columns:340px 1fr;gap:24px;align-items:start">
          ...
          <div style="display:flex;flex-direction:column;gap:16px">
            ...
            ">
              ...
              ">
                <div id="avatar-display" style="
                  ...
                  position:relative;overflow:hidden;
                ">
                  ${n==="custom"&&o?`<img src="${o}" style="width:100%;height:100%;object-fit:cover">`:`<span>${r}</span>`}
                  <!-- Level badge -->
                  <div style="
            ...
            <div style="
              ...
              overflow:hidden;
            ">
              ${[{label:"COMBATS",val:f,color:"var(--text-bright)"},{label:"VICTOIRES",val:u,color:"var(--peucommun)"},{label:"DÉFAITES",val:x,color:"var(--danger)"},{label:"WIN RATE",val:k+"%",color:"var(--accent-light)"},{label:"HÉROS",val:t.ownedCharacters.length,color:"var(--rare-light)"}].map((y,E)=>`
                <div style="
          ...
          <div style="display:flex;flex-direction:column;gap:16px">
            ...
            ">
              ...
              <div style="display:flex;gap:10px;align-items:center">
                ...
                ">
                  ${n==="custom"&&o?`<img src="${o}" style="width:100%;height:100%;object-fit:cover">`:"🖼️"}
                </div>
                <div style="flex:1">
  ...
  `;const z=document.getElementById("pseudo-input");z.addEventListener("focus",()=>{z.style.borderColor="rgba(200,150,60,0.55)",z.style.boxShadow="0 0 0 2px rgba(200,150,60,0.08)"}),z.addEventListener("blur",()=>{z.style.borderColor="rgba(200,150,60,0.25)",z.style.boxShadow="none"}),z.addEventListener("input",()=>{document.getElementById("pseudo-count").textContent=`${z.value.length}/18`}),document.getElementById("save-pseudo").addEventListener("click",()=>{const y=z.value.trim(),E=document.getElementById("pseudo-feedback");if(!y||y.length<2){E.textContent="Minimum 2 caractères !",E.style.color="var(--danger)";return}g.state.profile.pseudo=y,g.save(),document.getElementById("pseudo-display").textContent=y,E.textContent="✓ Nom sauvegardé",E.style.color="var(--peucommun)",setTimeout(()=>{E.textContent=""},2500)});const R=["Lord","Dark","Dire","Iron","Storm","Shadow","Blood","Silent","Brave","Void"],C=["Fang","Blade","Rune","Crest","Ash","Forge","Bane","Soul","Claw","Mark"];document.getElementById("random-pseudo").addEventListener("click",()=>{const y=R[Math.floor(Math.random()*R.length)],E=C[Math.floor(Math.random()*C.length)];z.value=y+E,document.getElementById("pseudo-count").textContent=`${z.value.length}/18`,z.focus()}),document.querySelectorAll(".avatar-btn").forEach(y=>{y.addEventListener("click",()=>{const E=y.dataset.emoji;document.querySelectorAll(".avatar-btn").forEach(v=>{v.style.background="rgba(0,0,0,0.5)",v.style.borderColor="rgba(200,150,60,0.08)"}),y.style.background="rgba(200,150,60,0.18)",y.style.borderColor="rgba(200,150,60,0.5)",document.getElementById("avatar-display").innerHTML=`
        <span>${E}</span>
      ...
      `,g.state.profile.avatar=E,g.state.profile.avatarType="preset",g.state.profile.customImg=null,g.save(),G("Emblème mis à jour !")})}),document.getElementById("upload-avatar").addEventListener("click",()=>{document.getElementById("avatar-file").click()}),document.getElementById("avatar-file").addEventListener("change",y=>{const E=y.target.files[0];if(!E)return;if(E.size>2*1024*1024){G("Image trop lourde (max 2MB)","error");return}const v=new FileReader;v.onload=w=>{const S=w.target.result;document.getElementById("custom-preview").innerHTML=`
        <img src="${S}" style="width:100%;height:100%;object-fit:cover">
      `,document.getElementById("avatar-display").innerHTML=`
        <img src="${S}" style="width:100%;height:100%;object-fit:cover">
        <div style="position:absolute;bottom:-1px;right:-1px;background:linear-gradient(180deg,#8B6914,#C8963C);color:#1A0A00;font-family:var(--font-title);font-weight:900;font-size:10px;padding:3px 7px;border-radius:2px 0 4px 0;">${l}</div>
      `,document.querySelectorAll(".avatar-btn").forEach(W=>{W.style.background="rgba(0,0,0,0.5)",W.style.borderColor="rgba(200,150,60,0.08)"}),g.state.profile.avatarType="custom",g.state.profile.customImg=S,g.save(),G("Image sauvegardée !")},v.readAsDataURL(E)}),document.querySelectorAll(".banner-btn").forEach(y=>{y.addEventListener("click",()=>{const E=y.dataset.bannerId,v=nt.find(w=>w.id===E);v&&(document.querySelectorAll(".banner-btn").forEach(w=>{w.style.border="2px solid rgba(0,0,0,0.5)",w.querySelector("div")?.remove(),w.innerHTML=`<div style="position:absolute;bottom:0;left:0;right:0;background:rgba(0,0,0,0.5);padding:2px 4px;font-family:var(--font-title);font-size:7px;letter-spacing:1px;text-align:center;color:rgba(255,255,255,0.8)">${nt.find(S=>S.id===w.dataset.bannerId)?.label.toUpperCase()}</div>`}),y.style.border="2px solid rgba(255,255,255,0.6)",y.innerHTML=`
      ...
      `,document.getElementById("profile-banner").style.background=`linear-gradient(135deg,${v.from},${v.to})`,g.state.profile.bannerId=E,g.save(),G("Bannière mise à jour !"))})}),document.getElementById("back-btn").addEventListener("click",()=>$.navigate("home")),document.getElementById("export-save").addEventListener("click",()=>{const y=JSON.stringify(g.state,null,2),E=new Blob([y],{type:"application/json"}),v=URL.createObjectURL(E),w=document.createElement("a");w.href=v,w.download=`rytiger_save_${new Date().toISOString().slice(0,10)}.json`,w.click(),URL.revokeObjectURL(v),G("Sauvegarde exportée !")}),document.getElementById("import-save").addEventListener("click",()=>{document.getElementById("import-file").click()}),document.getElementById("import-file").addEventListener("change",y=>{const E=y.target.files[0];if(!E)return;const v=new FileReader;v.onload=w=>{try{const S=JSON.parse(w.target.result);if(!S.ownedCharacters||!S.team){G("Fichier invalide !","error");return}if(!confirm("Écraser la sauvegarde actuelle ?"))return;Object.assign(g.state,S),g.save(),G("Importée ! Rechargement..."),setTimeout(()=>Pe(),600)}catch{G("Erreur de lecture","error")}},v.readAsText(E)}),document.getElementById("reset-save").addEventListener("click",()=>{confirm(`⚠️ Supprimer TOUTE la progression ?
Cette action est irréversible !`)&&g.reset()})}function G(a,t="success"){const e={success:{bg:"rgba(30,255,0,0.06)",border:"rgba(30,255,0,0.25)",text:"#1EFF00"},error:{bg:"rgba(200,34,34,0.1)",border:"rgba(200,34,34,0.35)",text:"#FF6060"}},i=e[t]||e.success,r=document.createElement("div");r.style.cssText=`
  ...
  `,document.getElementById("flee-btn").addEventListener("click",()=>{confirm("Fuir l'épreuve ?")&&(mt(),i())}),sa(t),Ji(t)}function Ji(a,t){let e=0;ft=setInterval(()=>{const i=document.getElementById("attack-lane");if(!i){clearInterval(ft);return}e++,e%2===0?ta(i,a):ea(i,a),e%4===0&&_e(i)},1100)}function ta(a,t){const e=["#4ADE80","#60A5FA","#FBBF24","#F87171","#A78BFA","#34D399"],i=e[Math.floor(Math.random()*e.length)],r=30+Math.random()*25,n=document.createElement("div");n.style.cssText=`position:absolute;left:180px;top:${r}%;
    ...
    animation:projRight 0.5s cubic-bezier(0.25,0.1,0.85,1) forwards;z-index:10`,a.appendChild(n),setTimeout(()=>{n.remove(),Oe(a,"72%",r,i,"right");const o=document.getElementById("boss-sprite");o&&(o.style.animation="bossHitFlash 0.35s ease-out",setTimeout(()=>{o.style.animation=`bossRage ${t.floor===5?"1.8":"3"}s ease-in-out infinite`},360))},470)}function ea(a,t){const e=t.accentColor||"#ff2244",i=32+Math.random()*22,r=document.createElement("div");r.style.cssText=`position:absolute;right:200px;top:${i}%;
    ...
    animation:projLeft 0.48s cubic-bezier(0.25,0.1,0.85,1) forwards;z-index:10`,a.appendChild(r),setTimeout(()=>{r.remove(),Oe(a,"12%",i,e,"left"),pe()},460)}function Oe(a,t,e,i,r){const n=document.createElement("div");n.style.cssText=`position:absolute;${r}:${t};top:${e}%;
    ...
    animation:impactBurst 0.4s ease-out forwards;z-index:11`,a.appendChild(n),setTimeout(()=>n.remove(),420)}function _e(a){const t=document.createElement("div");t.style.cssText=`position:absolute;bottom:168px;left:8%;height:2px;width:0;
    background:linear-gradient(90deg,transparent,rgba(255,80,0,0.9),rgba(255,200,0,0.7),transparent);
    animation:groundCrack 0.7s ease-out forwards;z-index:12;pointer-events:none`,a.appendChild(t),setTimeout(()=>t.remove(),720)}function pe(){const a=document.getElementById("dungeon-combat-screen");a&&(a.style.animation="hellShake 0.32s ease-out",setTimeout(()=>{a.style.animation=""},340))}function ia(a,t,e){const{playerTeam:i,boss:r,elapsedTime:n,dpsTracker:o,minDuration:d,gameOver:s,winner:l}=a,c=Math.floor(n/1e3),p=Math.max(0,r.currentHp/r.maxHp*100),m=document.getElementById("boss-hp-bar");m&&(m.style.width=`${p}%`,m.style.background=p>60?"linear-gradient(90deg,#990020,#dd2244,#ff6644)":p>30?"linear-gradient(90deg,#cc4400,#ff6600,#ffaa00)":"linear-gradient(90deg,#660000,#aa0000,#ff2200)");const f=document.getElementById("boss-hp-text");f&&(f.textContent=`${Math.max(0,r.currentHp).toLocaleString()} / ${r.maxHp.toLocaleString()}`);const u=document.getElementById("boss-shield-text");u&&(u.textContent=r.shieldValue>0?`🛡️ ${r.shieldValue.toLocaleString()}`:"");const x=r.currentPhase||1;x!==te&&(te=x,aa(x));const k=document.getElementById("boss-phase-badge");if(k){const v={1:"PHASE I",2:"⚡ PHASE II",3:"💀 PHASE III — ARMAGEDDON"};k.textContent=v[x]||"",k.style.color=x===3?"#ff2244":x===2?"#cc44ff":t.accentColor}if(t.floor===5&&x>=2&&!Jt){Jt=!0;const v=document.getElementById("domain-overlay");v&&(v.style.display="block");const w=document.getElementById("boss-domain-sigil");w&&(w.style.opacity="1")}const b=document.getElementById("timer-display");b&&(b.textContent=`⏱️ ${Math.floor(c/60)}:${String(c%60).padStart(2,"0")}`);const z=document.getElementById("min-timer-display");if(z){const v=Math.max(0,Math.floor(d/1e3)-c);z.textContent=v>0?`⏳ ${Math.floor(v/60)}:${String(v%60).padStart(2,"0")} restant`:"✅ Durée ok",z.style.color=v>0?"#ff8800":"#4ADE80"}const R=document.getElementById("boss-invisible-overlay");R&&(R.style.display=r.isInvisible?"block":"none");const C=document.getElementById("boss-sprite");C&&(C.style.opacity=r.isInvisible?"0.12":"1");const y=document.getElementById("player-sprites");y&&(y.innerHTML=i.map(v=>{const w=Math.max(0,v.currentHp/v.maxHp*100);return`
        <div id="ps-${v.id}" style="display:flex;align-items:center;gap:8px;
          ...
          <div style="position:relative">
            ...
            <div style="position:absolute;bottom:-5px;left:2px;right:2px;height:4px;
              ...
              <div style="height:100%;width:${w}%;border-radius:2px;transition:width 0.3s;
                background:${w>55?"#4ADE80":w>25?"#FBBF24":"#ff2244"}"></div>
            </div>
            ${v.alive?"":'<div style="position:absolute;inset:0;display:flex;align-items:center;justify-content:center;font-size:22px">💀</div>'}
          </div>
        </div>`}).join(""));const E=document.getElementById("player-hud-bottom");E&&(E.innerHTML=i.map(v=>{const w=Math.max(0,v.currentHp/v.maxHp*100),S=o[v.id]||0,W=e?e.getAutoAttackProgress(v.id)*100:0;return`<div style="flex:1;background:rgba(15,0,5,0.85);border-radius:8px;padding:8px;
        ...
        <div style="display:flex;align-items:center;gap:6px;margin-bottom:5px">
          ...
          <div>
            ...
            <div style="font-size:8px;color:rgba(255,255,255,0.35)">${S>0?Math.round(S/Math.max(1,c))+" DPS":v.type}</div>
          </div>
        </div>
        <div style="height:5px;background:rgba(0,0,0,0.55);border-radius:3px;margin-bottom:3px;overflow:hidden">
          <div style="height:100%;width:${w}%;border-radius:3px;transition:width 0.2s;
            background:${w>55?"#4ADE80":w>25?"#ff8800":"#ff2244"}"></div>
        </div>
        <div style="height:3px;background:rgba(255,255,255,0.06);border-radius:2px;margin-bottom:5px;overflow:hidden">
          <div style="height:100%;width:${W}%;background:rgba(255,200,50,0.75);transition:width 0.1s linear;border-radius:2px"></div>
        </div>
        <div style="display:flex;gap:3px;flex-wrap:wrap">
          ${(v.skills||[]).slice(0,4).map((rt,fe)=>{const Ht=e?e.getSkillCooldownPct(v.id,fe)*100:0;return`<button class="dsk" data-char="${v.id}" data-skill="${fe}"
    ...
    border-radius:4px;animation:bannerIn 0.5s ease">${r.t}</div>`,t.style.display="block",i==="domain"){const n=document.getElementById("domain-overlay");n&&(n.style.display="block")}["domain","emerge_burst","revive","3"].includes(String(i))&&pe(),setTimeout(()=>{t.style.display="none"},a?.newPhase?3e3:2200)}function ra(a){const t=document.getElementById("dungeon-log");if(!t)return;const e=document.createElement("div");for(e.textContent=a,e.style.cssText="font-size:9px;color:rgba(255,180,180,0.75);padding:2px 6px;background:rgba(0,0,0,0.55);border-left:2px solid rgba(200,10,30,0.5);border-radius:0 3px 3px 0;animation:fadeIn 0.3s ease",t.prepend(e);t.children.length>11;)t.lastChild.remove()}function na(a,t,e){const i=document.getElementById("dungeon-result-overlay");if(!i)return;const{archireveEarned:r,xpAmount:n,xpResults:o,itemEarned:d}=e,s=a.floor===5;return i.style.cssText="position:absolute;inset:0;z-index:100",i.innerHTML=`
    <div style="position:absolute;inset:0;
  ...
  `,setTimeout(()=>{const l=document.getElementById("vp");if(l)for(let c=0;c<65;c++){const p=document.createElement("div"),m=4+Math.random()*8,f=Math.random()*100,u=Math.random()*3.5,x=2.5+Math.random()*4,k=["#FFD700","#FFA500","#FFED4E","#fff","#FFC107"];p.style.cssText=`position:absolute;top:-20px;left:${f}%;width:${m}px;height:${m}px;border-radius:50%;
        background:${k[Math.floor(Math.random()*k.length)]};
        animation:goldRain ${x}s ${u}s linear infinite`,l.appendChild(p)}},300),document.getElementById("victory-btns")}function oa(a){const t=document.getElementById("dungeon-result-overlay");if(t)return t.style.cssText="position:absolute;inset:0;z-index:100",t.innerHTML=`
  ...
  `,document.getElementById("defeat-btns")}function sa(a){const t=document.getElementById("dungeon-particles");if(!t)return;const e=["ᚱ","ᚷ","ᛏ","ᚦ","ᛉ","☽","☿","⊕","❋","✦","⋆"];for(let i=0;i<28;i++){const r=document.createElement("div"),n=Math.random()*100,o=2+Math.random()*3.5,d=Math.random()*14,s=1.5+Math.random()*3;r.style.cssText=`position:absolute;left:${n}%;bottom:162px;width:${o}px;height:${o}px;
      background:${a.accentColor};border-radius:50%;opacity:0;
      animation:emberRise ${s}s ${d}s ease-out infinite;
      box-shadow:0 0 5px ${a.accentColor}`,t.appendChild(r)}for(let i=0;i<10;i++){const r=document.createElement("div"),n=5+Math.random()*90,o=12+Math.random()*10,d=Math.random()*18,s=10+Math.random()*14;r.style.cssText=`position:absolute;left:${n}%;bottom:0;font-size:${o}px;
      color:${a.accentColor};opacity:0;pointer-events:none;
      animation:floatRune ${s}s ${d}s linear infinite;
      text-shadow:0 0 10px ${a.accentColor}`,r.textContent=e[Math.floor(Math.random()*e.length)],t.appendChild(r)}}let L=null;function la(){L=null,Dt()}function Dt(){const a=document.getElementById("app"),t=g.getTeamInstances();a.innerHTML=`
    <div class="screen" style="background:linear-gradient(180deg,#0a0010,#050005)">
      ...
      <div class="content" style="display:flex;flex-direction:column;align-items:center;gap:var(--space-xl);padding:var(--space-xl) var(--space-lg)">
        ...
        <div style="background:rgba(255,34,68,0.08);border:1px solid rgba(255,34,68,0.3);border-radius:var(--radius-xl);padding:var(--space-lg);text-align:center;max-width:600px;width:100%">
          ...
          <div style="font-size:12px;color:#ff8899;line-height:1.6">${Yi.subtitle}</div>
  ...
  `,document.getElementById("back-btn").addEventListener("click",()=>$.navigate("home")),document.querySelectorAll(".floor-enter-btn").forEach(e=>{e.addEventListener("click",()=>{const i=parseInt(e.dataset.floor);ie(i)})})}function da(a){const t=g.getDungeonFloorProgress(a.floor),e=g.isDungeonFloorUnlocked(a.floor),i=a.floor===5,r=t.clears>0,n=t.bestTime?`${Math.floor(t.bestTime/60)}m${String(t.bestTime%60).padStart(2,"0")}s`:"——";return`
  ...
  `}function ie(a){const t=Zi(a);if(!t)return;const e=g.getTeamInstances();if(e.length===0){ca("Votre équipe est vide !","error");return}mt(),L&&(L.stop(),L=null),L=new Ki(e,t);let i=!1;L.onTick=n=>{ia(n,t,L),n.gameOver&&!i&&(i=!0,mt(),L?.stop(),setTimeout(()=>pa(n.winner,t,Math.floor(n.elapsedTime/1e3)),500))},L.onLog=n=>ra(n),L.onPhaseChange=n=>ee(n),L.onBossAbility=n=>ee(n);const r=document.getElementById("app");Qi(r,t,L,()=>{mt(),L?.stop(),L=null,Dt()}),L.start()}function pa(a,t,e){if(a==="player"){const i=g.recordDungeonClear(t.floor,e),r=i.isFirstClear?1:.3,n=Math.floor((t.boss.rewards?.archireve||300)*r);g.addArchireve(n);const o=Math.floor(Qe({isDungeon:!0,dungeonFloor:t.floor})*r),d=g.addTeamXp(o);let s=null;const l=t.boss.rewards?.items||[];if(i.isFirstClear&&l.length>0){const p=l[Math.floor(Math.random()*l.length)];j[p]&&(s=j[p],g.addItem(p))}g.recordBattle(!0);const c=na(t,i,{archireveEarned:n,xpAmount:o,xpResults:d,itemEarned:s});if(c){if(t.floor<5){const m=document.createElement("button");m.textContent=`→ ÉTAGE ${t.floor+1}`,m.style.cssText="padding:14px 32px;font-family:var(--font-title);font-size:13px;letter-spacing:3px;background:linear-gradient(135deg,rgba(255,200,0,0.3),rgba(255,100,0,0.2));border:1px solid rgba(255,200,0,0.4);border-radius:8px;color:#FFD700;cursor:pointer",m.addEventListener("click",()=>ie(t.floor+1)),c.appendChild(m)}const p=document.createElement("button");p.textContent="◀ RETOUR",p.style.cssText="padding:14px 32px;font-family:var(--font-title);font-size:13px;letter-spacing:3px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.12);border-radius:8px;color:rgba(255,255,255,0.6);cursor:pointer",p.addEventListener("click",()=>{L=null,Dt()}),c.appendChild(p)}}else{g.recordBattle(!1);const i=oa(t);if(i){const r=document.createElement("button");r.textContent="🔄 RÉESSAYER",r.style.cssText="padding:14px 32px;font-family:var(--font-title);font-size:13px;letter-spacing:3px;background:linear-gradient(135deg,rgba(180,0,20,0.35),rgba(80,0,0,0.45));border:1px solid rgba(180,0,20,0.45);border-radius:8px;color:#ff4444;cursor:pointer",r.addEventListener("click",()=>ie(t.floor)),i.appendChild(r);const n=document.createElement("button");n.textContent="◀ RETOUR",n.style.cssText="padding:14px 32px;font-family:var(--font-title);font-size:13px;letter-spacing:3px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.1);border-radius:8px;color:rgba(255,255,255,0.5);cursor:pointer",n.addEventListener("click",()=>{L=null,Dt()}),i.appendChild(n)}}}function ca(a,t="success"){const e=document.createElement("div");e.className=`toast toast--${t}`,e.textContent=a,document.body.appendChild(e),setTimeout(()=>e.remove(),3e3)}function ga(){const a=document.getElementById("app");try{dt(a,null)}catch(t){console.error("[InventoryScreen] Crash:",t),a.innerHTML=`
      ...
      </div>`,document.getElementById("err-back")?.addEventListener("click",()=>$.navigate("home"))}}function dt(a,t){const e=g.getOwnedInstances(),i=g.getInventoryItems(),r=t?e.find(n=>n.id===t):null;a.innerHTML=`
    <div class="screen">
      <div class="topbar">
        <button class="topbar__back" id="back-btn">◀</button>
        <div class="topbar__title">🎒 Inventaire</div>
  ...
  `,document.getElementById("back-btn").addEventListener("click",()=>$.navigate("home")),document.querySelectorAll(".char-picker-btn").forEach(n=>{n.addEventListener("click",()=>{dt(a,n.dataset.char)})}),document.querySelectorAll(".btn-equip").forEach(n=>{n.addEventListener("click",()=>{const{instanceId:o,charId:d}=n.dataset;g.equipItem(d,o)&&(Vt("Objet équipé !","success"),dt(a,d))})}),document.querySelectorAll(".btn-unequip").forEach(n=>{n.addEventListener("click",()=>{const{charId:o,slot:d}=n.dataset;g.unequipItem(o,d),Vt("Objet retiré","warning"),dt(a,o)})}),document.getElementById("dev-add-items")?.addEventListener("click",()=>{["epee_rouille","baton_mage","robe_arcane","anneau_rapidite","talisman_nature","dague_ombre"].forEach(o=>g.addItem(o)),Vt("Objets ajoutés !","success"),dt(a,t)})}function fa(a,t){const e=g.getCharacterEquipped(a.id),i=g.getCharacterBonusStats(a.id);return`
    <div class="glass" style="padding:var(--space-md);border-radius:var(--radius-xl)">
      ...
      ${Object.entries(at).map(([r,n])=>{const o=e[r],d=o?t.find(c=>c.instanceId===o):null,s=d?d.fusedData||j[d.itemId]||d:null,l=s?Y[s.rarity]||Y.rare:null;return`
          <div style="display:flex;align-items:center;gap:var(--space-sm);padding:8px 0;border-bottom:1px solid var(--border)">
            ...
            <div style="flex:1;min-width:0">
              ...
              ${s?`
                <div style="font-size:11px;color:${l?.color||"var(--text-primary)"};font-weight:600;white-space:nowrap;overflow:hidden;text-overflow:ellipsis">${s.name}</div>
                <div style="font-size:9px;color:var(--text-muted)">${Object.entries(s.stats||{}).map(([c,p])=>`+${p} ${c.toUpperCase()}`).join(" · ")}</div>
              `:'<div style="font-size:11px;color:var(--text-muted)">— Vide —</div>'}
            </div>
            ${s?`<button class="btn btn--danger btn--sm btn-unequip" data-char-id="${a.id}" data-slot="${r}" style="font-size:9px;padding:4px 8px">✕</button>`:""}
          </div>
        `}).join("")}
  ...
  `}function ma(a,t,e){const i=Y[a.rarity]||Y.rare,r=at[a.slot];let n=!1;if(e){const s=g.getCharacterEquipped(e.id);n=Object.values(s).includes(a.instanceId)}const d=(e?g.getCharacterEquipped(e.id):{})[a.slot];return`
    <div class="glass" style="padding:var(--space-sm);border-radius:var(--radius-lg);
      ...
      <div style="font-size:8px;color:var(--accent);margin-bottom:8px;text-align:center">
        ${Object.entries(a.stats||{}).map(([s,l])=>`+${l} ${s.toUpperCase()}`).join("<br>")}
      </div>
      ${t&&!n?`
  ...
  `}function Vt(a,t="success"){const e=document.createElement("div");e.className=`toast toast--${t}`,e.textContent=a,document.body.appendChild(e),setTimeout(()=>e.remove(),3e3)}let Q="characters",I=null,T=null;const ht={rare:"#4a9eff",epique:"#c44aff",legendaire:"#ffb84a",ultimate:"#ff4a4a",semi_ultimate:"#FF6B2C",supreme:"#FF1493"};function Ot(){I=null,T=null;const a=document.getElementById("app");a.innerHTML=je(),Ue()}function je(){const a=g.state,t=a.ownedCharacters.filter(s=>{const l=P.find(c=>c.id===s.id)||g.getFusedCharacterData(s.id);return l&&(l.rarity==="legendaire"||l.rarity==="ultimate")}),e=(a.inventory||[]).filter(s=>{const l=s.fusedData||j[s.itemId];return l&&(l.rarity==="legendaire"||l.rarity==="ultimate")}),i=ba(),r=ya(),n=i&&r&&i.rarity===r.rarity,o=Q==="characters",d=n?Fe():null;return'<div class="screen" style="background:var(--bg-primary);display:flex;flex-direction:column;height:100vh;overflow:hidden;background-image:radial-gradient(ellipse at 50% 80%,rgba(192,57,11,0.08),transparent 55%)"><div class="topbar" style="width:100%;position:relative;z-index:10;flex-shrink:0"><button class="topbar__back" id="forge-back">&#9664;</button><div class="topbar__title" style="letter-spacing:4px">⚒ FORGE DE FUSION</div><div></div></div><div style="display:flex;justify-content:center;gap:8px;padding:12px 20px 8px;flex-shrink:0"><button class="btn '+(o?"btn--primary":"btn--ghost")+'" id="tab-chars" style="padding:10px 28px;font-size:11px;letter-spacing:2px">⚔ PERSONNAGES</button><button class="btn '+(o?"btn--ghost":"btn--primary")+'" id="tab-items" style="padding:10px 28px;font-size:11px;letter-spacing:2px">📦 ITEMS</button></div><div style="display:flex;flex:1;overflow:hidden;gap:0"><div style="width:420px;flex-shrink:0;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:24px;border-right:1px solid rgba(200,155,60,0.06)"><div style="font-family:var(--font-title);font-size:10px;letter-spacing:4px;color:var(--text-muted);margin-bottom:20px">— FUSION —</div><div style="display:flex;align-items:center;gap:20px">'+$e(i,1)+'<div style="font-size:28px;color:var(--text-muted)">+</div>'+$e(r,2)+'</div><div style="margin:20px 0;font-size:24px;color:var(--accent)">⇣</div>'+(d?ua(d):'<div style="width:180px;height:100px;border:2px dashed rgba(200,155,60,0.08);border-radius:12px;display:flex;align-items:center;justify-content:center;color:var(--text-muted);font-size:12px;letter-spacing:1px">Résultat</div>')+'<div style="margin-top:20px;padding:14px 20px;background:rgba(0,0,0,0.3);border-radius:10px;border:1px solid rgba(200,155,60,0.06);max-width:350px"><div style="font-family:var(--font-stat);font-size:9px;color:var(--legendaire);letter-spacing:2px;margin-bottom:8px">RÈGLES DE FUSION</div><div style="font-size:10px;color:var(--text-secondary);line-height:1.8">⚔ Légendaire + Légendaire → <span style="color:#FF6B2C;font-weight:700">Semi-Ultimate</span> (stats ×2)<br>🔥 Ultimate + Ultimate → <span style="color:#FF1493;font-weight:700">Suprême Divin</span> (stats ×10)</div></div><button class="btn btn--star btn--large" id="fuse-btn" style="margin-top:24px;padding:16px 48px;font-size:14px;letter-spacing:3px" '+(n?"":"disabled")+'>⚒ FUSIONNER</button></div><div style="flex:1;overflow-y:auto;padding:20px"><div style="font-family:var(--font-title);font-size:10px;letter-spacing:3px;color:var(--text-muted);margin-bottom:12px">'+(o?"— PERSONNAGES ELIGIBLES ("+t.length+") —":"— ITEMS ÉLIGIBLES ("+e.length+") —")+'</div><div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(130px,1fr));gap:10px">'+(o?va(t):xa(e))+"</div></div></div></div>"}function $e(a,t){if(!a)return'<div class="forge-slot forge-slot--empty" data-slot="'+t+'" style="width:130px;height:150px;border:2px dashed rgba(200,155,60,0.15);border-radius:12px;display:flex;flex-direction:column;align-items:center;justify-content:center;cursor:pointer;background:rgba(0,0,0,0.2);transition:all 0.15s"><div style="font-size:32px;opacity:0.3;margin-bottom:8px">+</div><div style="font-size:9px;color:var(--text-muted);letter-spacing:1px">SLOT '+t+"</div></div>";const e=ht[a.rarity]||"#aaa",i=!!a.type&&!a.slot;return'<div class="forge-slot" data-slot="'+t+'" data-selected="true" style="width:130px;height:150px;border:2px solid '+e+'40;border-radius:12px;display:flex;flex-direction:column;align-items:center;justify-content:center;cursor:pointer;background:rgba(0,0,0,0.3);position:relative;transition:all 0.15s">'+(i?'<img src="'+B(a.type.split("/")[0])+'" style="width:48px;height:48px;filter:drop-shadow(0 0 8px '+e+'60)">':'<div style="font-size:36px;filter:drop-shadow(0 0 8px '+e+'60)">'+(a.icon||"📦")+"</div>")+'<div style="font-family:var(--font-ui);font-size:10px;font-weight:700;color:'+e+';margin-top:8px;text-align:center;padding:0 4px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:120px">'+a.name+'</div><div style="font-size:8px;color:var(--text-muted);letter-spacing:1px;margin-top:2px">'+a.rarity.toUpperCase()+'</div><button class="forge-slot-clear" data-clear="'+t+'" style="position:absolute;top:4px;right:4px;width:20px;height:20px;border:none;background:rgba(220,38,38,0.5);color:white;border-radius:50%;font-size:10px;cursor:pointer;display:flex;align-items:center;justify-content:center">✕</button></div>'}function ua(a){const t=ht[a.rarity]||"#FF6B2C",e=Object.entries(a.stats||{}).map(function(i){return'<span style="color:'+t+'">'+i[0].toUpperCase()+"</span> "+i[1]}).join(" · ");return'<div style="width:220px;padding:16px;border:2px solid '+t+'30;border-radius:12px;background:rgba(0,0,0,0.4);text-align:center"><div style="font-family:var(--font-stat);font-size:8px;color:'+t+';letter-spacing:3px;margin-bottom:6px">'+a.rarity.toUpperCase().replace("_","-")+'</div><div style="font-family:var(--font-title);font-size:14px;color:var(--text-bright);margin-bottom:8px">'+a.name+'</div><div style="font-size:9px;color:var(--text-secondary);line-height:1.6">'+e+"</div></div>"}function va(a){return a.map(t=>{const e=P.find(n=>n.id===t.id)||g.getFusedCharacterData(t.id);if(!e)return"";const i=ht[e.rarity]||"#aaa",r=I===t.id||T===t.id;return'<button class="forge-grid-item" data-char-id="'+t.id+'" style="padding:12px 8px;text-align:center;border-radius:8px;cursor:pointer;border:1px solid '+(r?i:"rgba(200,155,60,0.06)")+";background:"+(r?"rgba(192,57,11,0.15)":"rgba(10,6,3,0.6)")+';color:var(--text-primary);transition:all 0.15s"><img src="'+B(e.type.split("/")[0])+'" style="width:40px;height:40px;filter:drop-shadow(0 0 6px '+i+'40)"><div style="font-family:var(--font-ui);font-size:9px;font-weight:700;color:'+i+';margin-top:6px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis">'+e.name.split(" ")[0]+'</div><div style="font-size:8px;color:var(--text-muted);letter-spacing:1px">LV.'+t.level+'</div><div style="font-size:7px;color:'+i+';letter-spacing:1px;margin-top:2px">'+e.rarity.toUpperCase()+"</div></button>"}).join("")}function xa(a){return a.map(t=>{const e=t.fusedData||j[t.itemId];if(!e)return"";const i=ht[e.rarity]||"#aaa",r=I===t.instanceId||T===t.instanceId,n=at[e.slot]||{name:"",icon:""};return'<button class="forge-grid-item" data-item-id="'+t.instanceId+'" style="padding:12px 8px;text-align:center;border-radius:8px;cursor:pointer;border:1px solid '+(r?i:"rgba(200,155,60,0.06)")+";background:"+(r?"rgba(192,57,11,0.15)":"rgba(10,6,3,0.6)")+';color:var(--text-primary);transition:all 0.15s"><div style="font-size:28px;filter:drop-shadow(0 0 6px '+i+'40)">'+(e.icon||"📦")+'</div><div style="font-family:var(--font-ui);font-size:9px;font-weight:700;color:'+i+';margin-top:6px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis">'+e.name.split(" ").slice(0,2).join(" ")+'</div><div style="font-size:7px;color:var(--text-muted);letter-spacing:1px">'+n.icon+" "+n.name+'</div><div style="font-size:7px;color:'+i+';letter-spacing:1px;margin-top:2px">'+e.rarity.toUpperCase()+"</div></button>"}).join("")}function ba(){if(!I)return null;if(Q==="characters")return P.find(a=>a.id===I)||g.getFusedCharacterData(I);{const a=(g.state.inventory||[]).find(t=>t.instanceId===I);return a?a.fusedData||j[a.itemId]:null}}function ya(){if(!T)return null;if(Q==="characters")return P.find(a=>a.id===T)||g.getFusedCharacterData(T);{const a=(g.state.inventory||[]).find(t=>t.instanceId===T);return a?a.fusedData||j[a.itemId]:null}}function Fe(){if(Q==="characters"){const a=P.find(r=>r.id===I)||g.getFusedCharacterData(I),t=P.find(r=>r.id===T)||g.getFusedCharacterData(T);if(!a||!t)return null;const e=g.state.ownedCharacters.find(r=>r.id===I),i=g.state.ownedCharacters.find(r=>r.id===T);return ti(a,t,e?.level||1,i?.level||1)}else{const a=(g.state.inventory||[]).find(r=>r.instanceId===I),t=(g.state.inventory||[]).find(r=>r.instanceId===T);if(!a||!t)return null;const e=a.fusedData||j[a.itemId],i=t.fusedData||j[t.itemId];return ei(e,i)}}function Ue(){document.getElementById("forge-back")?.addEventListener("click",()=>$.navigate("home")),document.getElementById("tab-chars")?.addEventListener("click",()=>{Q="characters",I=null,T=null,Ot()}),document.getElementById("tab-items")?.addEventListener("click",()=>{Q="items",I=null,T=null,Ot()}),document.querySelectorAll(".forge-grid-item").forEach(a=>{a.addEventListener("click",()=>{const t=a.dataset.charId||a.dataset.itemId;t&&(t===I?I=null:t===T?T=null:I?T=t:I=t,ke())})}),document.querySelectorAll(".forge-slot-clear").forEach(a=>{a.addEventListener("click",t=>{t.stopPropagation();const e=a.dataset.clear;e==="1"&&(I=null),e==="2"&&(T=null),ke()})}),document.getElementById("fuse-btn")?.addEventListener("click",()=>{const a=Fe();a&&(Q==="characters"?(g.removeFusionIngredients(I,T),g.addFusedCharacter(a)):g.fuseItems(I,T,a),I=null,T=null,ha(a))})}function ke(){const a=document.getElementById("app");a.innerHTML=je(),Ue()}function ha(a){const t=ht[a.rarity]||"#FF6B2C",e=document.createElement("div");e.className="modal-overlay",e.style.cssText="flex-direction:column;gap:0;background:rgba(0,0,0,0.95);z-index:9999",e.innerHTML='<div style="display:flex;flex-direction:column;align-items:center;justify-content:center;width:100%;height:100%;position:relative"><div style="position:absolute;inset:0;background:radial-gradient(circle,rgba('+(a.rarity==="supreme"?"255,20,147":"255,107,44")+',0.15),transparent 60%);animation:gachaFlash 2s ease forwards"></div><div style="position:relative;width:160px;height:160px;display:flex;align-items:center;justify-content:center"><div style="position:absolute;inset:0;border-radius:50%;border:2px solid '+t+"88;animation:portalRotate 4s linear infinite;box-shadow:0 0 30px "+t+'40"></div><div style="font-size:72px;filter:drop-shadow(0 0 30px '+t+');animation:crystalGlow 1.5s ease infinite alternate">⚒</div></div><div style="margin-top:32px;font-family:var(--font-title);font-size:16px;color:'+t+";letter-spacing:5px;text-shadow:0 0 20px "+t+'60;animation:fadeIn 1s 1s ease forwards;opacity:0">'+a.rarity.toUpperCase().replace("_","-")+'</div><div style="margin-top:12px;font-family:var(--font-title);font-size:28px;color:var(--text-bright);letter-spacing:3px;text-shadow:0 2px 20px rgba(0,0,0,0.5);animation:fadeIn 1s 1.5s ease forwards;opacity:0">'+a.name+'</div><div style="margin-top:12px;font-size:11px;color:var(--text-secondary);animation:fadeIn 1s 2s ease forwards;opacity:0">'+a.desc+'</div><button class="btn btn--primary" id="fusion-done" style="margin-top:32px;padding:14px 36px;animation:fadeIn 1s 2.5s ease forwards;opacity:0">CONTINUER</button></div><style>@keyframes crystalGlow { from{filter:drop-shadow(0 0 20px '+t+") brightness(1)} to{filter:drop-shadow(0 0 50px "+t+") brightness(1.4)} }</style>",document.body.appendChild(e),setTimeout(()=>{document.getElementById("fusion-done")?.addEventListener("click",()=>{e.remove(),Ot()})},100)}const wa={guerrier:{hp:1.5,def:1.5,atk:1,magDef:.5,spd:.3,magAtk:0},mage:{hp:.8,def:.3,atk:0,magDef:1.2,spd:.5,magAtk:2},arche:{hp:.7,def:.4,atk:1.8,magDef:.3,spd:1.5,magAtk:0},assassin:{hp:.6,def:.3,atk:1.6,magDef:.2,spd:2,magAtk:0}},Ee=["commun","peucommun","rare","epique","legendaire","mythique","ultimate"],ce={rare:{color:"#3B82F6",label:"Rare"},epique:{color:"#9333EA",label:"Epique"},legendaire:{color:"#C89B3C",label:"Legendaire"},ultimate:{color:"#F5F0E8",label:"Ultimate"}},bt={guerrier:"#f87171",mage:"#c084fc",arche:"#86efac",assassin:"#ff6b9d"},_t={hp:"HP",atk:"ATK",def:"DEF",spd:"SPD",magAtk:"MAG",magDef:"RES"};let pt="overview",ut=null,Lt="all",ct="rarity",Mt="all",Bt="all";const $a=["overview","missions","team","characters","inventory","forge"];function He(){const a=document.getElementById("app");a.innerHTML=`
    <div class="screen" style="background:var(--bg-primary);overflow:hidden;display:flex;flex-direction:column;">
      ...
      <div id="dash-tabs" style="display:flex;background:rgba(10,6,3,0.97);border-bottom:1px solid var(--border-metal);flex-shrink:0;overflow-x:auto;">
        ${$a.map(t=>`
          <button class="dash-tab ${t===pt?"dash-tab--active":""}" data-tab="${t}" id="tab-${t}" style="
            flex:1;min-width:100px;padding:14px 8px;background:none;border:none;
            border-bottom:2px solid ${t===pt?"var(--accent)":"transparent"};
            color:${t===pt?"var(--accent-light)":"var(--text-muted)"};
  ...
  `,document.getElementById("dash-back").addEventListener("click",()=>$.navigate("home")),document.querySelectorAll(".dash-tab").forEach(t=>{t.addEventListener("click",()=>{pt=t.dataset.tab,He()})}),it()}function ka(a){return{overview:"Apercu",missions:"Missions",team:"Equipe",characters:"Personnages",inventory:"Inventaire",forge:"Forge"}[a]}function it(){const a=document.getElementById("dash-content");if(a)switch(pt){case"overview":a.innerHTML=za();break;case"missions":a.innerHTML=Ea();break;case"team":a.innerHTML=Ia(),Sa();return;case"characters":a.innerHTML=La(),Ma();return;case"inventory":a.innerHTML=Ba(),Ra();return;case"forge":a.innerHTML=Pa();break}}function Ea(){const a=g.getDailyMissions()||[],t=g.getWeeklyMissions()||[];function e(o,d=!1){const s=o.target>0?Math.min(100,Math.round(o.progress/o.target*100)):0,l=o.done?"var(--success)":d?"#FBBF24":"var(--accent)",c=o.done?"rgba(74,124,89,0.3)":d?"rgba(251,191,36,0.2)":"rgba(192,57,11,0.2)";return`
      <div style="
        display:grid;grid-template-columns:auto 1fr auto;align-items:center;gap:16px;
        padding:16px 20px;
        background:${o.done?"rgba(74,124,89,0.06)":"rgba(12,8,4,0.8)"};
        border:1px solid ${c};
        border-radius:8px;
        opacity:${o.done?.7:1};
        transition:all 0.2s;
      ">
        ...
        <div style="
          ...
          display:flex;align-items:center;justify-content:center;
          font-size:22px;filter:${o.done?"grayscale(0.3)":"none"};
        ">${o.icon}</div>
        ...
        <div>
          <div style="
            ...
            color:${o.done?"var(--text-muted)":"var(--text-primary)"};
            margin-bottom:3px;
          ">${o.done?"✓ ":""}${o.title}</div>
          <div style="font-size:11px;color:var(--text-muted);margin-bottom:8px">${o.desc}</div>
          <!-- Progress bar -->
          <div style="display:flex;align-items:center;gap:10px">
            <div style="flex:1;height:5px;background:rgba(0,0,0,0.5);border-radius:3px;overflow:hidden;max-width:200px">
              <div style="height:100%;width:${s}%;background:${o.done?"var(--success)":l};border-radius:3px;transition:width 0.5s ease;box-shadow:0 0 6px ${l}40"></div>
            </div>
            <span style="font-family:var(--font-stat);font-size:10px;color:var(--text-muted)">${o.progress}/${o.target}</span>
          </div>
        </div>

        <!-- Reward -->
        <div style="text-align:right">
          <div style="font-family:var(--font-stat);font-size:16px;font-weight:700;color:${o.done?"var(--text-muted)":"var(--star)"}">+${o.reward}</div>
          <div style="font-size:9px;color:var(--text-muted);letter-spacing:1px">⭐ ARCHIRÊVES</div>
          ${o.done?'<div style="font-size:9px;color:var(--success);margin-top:2px;letter-spacing:1px">RÉCLAMÉ</div>':""}
        </div>
      </div>
    `}const i=a.filter(o=>o.done).length,r=t.filter(o=>o.done).length,n=g.getWeekKey();return`
      ...
      <div class="glass" style="padding:var(--space-xl);border-radius:var(--radius-xl);border-color:rgba(251,191,36,0.15)">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:var(--space-lg)">
          <div>
            ...
            <div style="font-size:10px;color:var(--text-secondary);margin-top:4px">Semaine ${n} · Meilleures récompenses</div>
          </div>
          <div style="font-family:var(--font-stat);font-size:14px;font-weight:700;color:${r===t.length?"var(--success)":"#FBBF24"}">
            ${r}/${t.length}
          </div>
        </div>
        <div style="display:flex;flex-direction:column;gap:10px">
  ...
  `}function za(){const a=g.state,t=a.profile||{pseudo:"Forgeant",level:1,xp:0},e=a.totalBattles>0?Math.round(a.totalWins/a.totalBattles*100):0,i=a.ownedCharacters.length,r=t.level*100,n=Math.min(100,Math.round(t.xp/r*100)),o=["enchantement","osiris","supplice","maragorh","imotep"],d={enchantement:"Enchantement",osiris:"Osiris",supplice:"Supplice",maragorh:"Maragorh",imotep:"Imotep"},s=o.map(c=>{let p=0;for(let m=0;m<20;m++)g.getLevelFlames(c,m)>0&&p++;return{id:c,name:d[c],done:p,total:20,pct:Math.round(p/20*100)}}),l={rare:0,epique:0,legendaire:0,ultimate:0};return a.ownedCharacters.forEach(c=>{const p=P.find(m=>m.id===c.id);p&&l[p.rarity]!==void 0&&l[p.rarity]++}),Object.values(l).reduce((c,p)=>c+p,0),`
    <div style="padding:var(--space-xl);max-width:1100px;margin:0 auto">
      ...
      <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:var(--space-md);margin-bottom:var(--space-xl)">
        ${Xt("COMBATS",a.totalBattles,"#E8DCC8")}
        ${Xt("VICTOIRES",a.totalWins,"var(--success)")}
        ${Xt("TAUX VICTOIRE",e+"%",e>=50?"var(--legendaire)":"var(--danger)")}
      </div>
      ...
      <div class="glass" style="padding:var(--space-xl);border-radius:var(--radius-xl)">
        ...
        <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:var(--space-md)">
          ${Object.entries(l).map(([c,p])=>{const m=ce[c],f=Math.round(p/i*100)||0;return`
              <div style="text-align:center">
  ...
  `}function Ia(){const a=g.getTeamInstances(),t=Aa(a);return`
    <div style="padding:var(--space-xl);max-width:1100px;margin:0 auto">
      ...
      <div style="display:grid;grid-template-columns:repeat(${Math.min(a.length||1,4)},1fr);gap:var(--space-xl);margin-bottom:var(--space-xl)">
        ${a.length?a.map(e=>Ta(e)).join(""):`<div style="color:var(--text-muted);text-align:center;padding:var(--space-xxxl);grid-column:1/-1">Aucun personnage dans l'equipe</div>`}
      </div>
          ...
          <table style="width:100%;border-collapse:collapse;font-family:var(--font-ui)">
            <thead>
              <tr>
                ...
                ${Object.values(_t).map(e=>`<th style="text-align:center;padding:10px;font-size:10px;letter-spacing:2px;color:var(--text-muted);border-bottom:1px solid var(--border-metal)">${e}</th>`).join("")}
              </tr>
            </thead>
            <tbody>
              ${a.map((e,i)=>`
                <tr style="background:${i%2?"transparent":"rgba(200,155,60,0.02)"}">
                  <td style="padding:10px;border-bottom:1px solid rgba(200,155,60,0.04)">
                    ...
                    <div style="font-size:10px;color:${bt[e.type]};letter-spacing:1px">${e.type.toUpperCase()}</div>
                  </td>
                  ${Object.keys(_t).map(r=>{const n=Math.max(...a.map(s=>s.stats[r]||0)),o=e.stats[r]||0,d=n>0?Math.round(o/n*100):0;return`<td style="padding:10px;text-align:center;border-bottom:1px solid rgba(200,155,60,0.04)">
                      <div style="font-family:var(--font-stat);font-size:14px;font-weight:700;color:${o===n&&n>0?"var(--legendaire)":"var(--text-primary)"}">${o}</div>
                      <div style="width:40px;height:3px;background:rgba(0,0,0,0.4);border-radius:2px;margin:4px auto 0">
                        <div style="height:100%;width:${d}%;background:${bt[e.type]};border-radius:2px"></div>
                      </div>
                    </td>`}).join("")}
                </tr>
              `).join("")}
  ...
  `}function Ta(a){const t=ze(a.stats,90),e=bt[a.type]||"var(--accent)",i=ii[a.rarity?.toUpperCase()]?.color||"#aaa",r=g.getCharacterBonusStats(a.id),n=Object.values(r).some(o=>o>0);return`
    <div class="glass" style="padding:var(--space-lg);border-radius:var(--radius-xl);text-align:center;border-color:rgba(${Oa(e)},0.2);position:relative">
      ...
      <svg viewBox="0 0 200 200" style="width:140px;height:140px;margin:0 auto var(--space-md)">
        <!-- Grid hexagons -->
        ${[.33,.66,1].map(o=>`<polygon points="${ze({hp:1,atk:1,def:1,spd:1,magAtk:1,magDef:1},90*o)}" fill="none" stroke="rgba(200,155,60,0.12)" stroke-width="1"/>`).join("")}
        <!-- Axes -->
        ${_a(90).map(([o,d])=>`<line x1="100" y1="100" x2="${o}" y2="${d}" stroke="rgba(200,155,60,0.08)" stroke-width="1"/>`).join("")}
        <!-- Data -->
  ...
  `}function Sa(){document.getElementById("btn-optimize")?.addEventListener("click",()=>{const a=Ca();a&&(g.setTeam(a),it())})}function Aa(a){if(!a.length)return{label:"Equipe vide",bonus:""};const t={};a.forEach(r=>{t[r.type]=(t[r.type]||0)+1});const e=Object.entries(t).sort((r,n)=>n[1]-r[1])[0],i=e[0].charAt(0).toUpperCase()+e[0].slice(1);return e[1]===4?{label:`Meute ${i}`,bonus:`+15% toutes les stats (${i})`}:e[1]===3?{label:`Formation ${i}`,bonus:`+10% ATK +5% SPD (${i})`}:e[1]===2?{label:`Duo ${i}`,bonus:`+5% ATK (${i})`}:Object.keys(t).length===4?{label:"Composition Mixte",bonus:"+3% SPD globale (flexibilite)"}:{label:"Standard",bonus:""}}function Ca(){const a=g.state.ownedCharacters;return a.length<1?null:a.map(e=>{const i=P.find(n=>n.id===e.id);if(!i)return null;const r={rare:1,epique:1.3,legendaire:1.7,ultimate:2.2}[i.rarity]||1;return{id:e.id,score:e.level*r}}).filter(Boolean).sort((e,i)=>i.score-e.score).slice(0,4).map(e=>e.id)}function La(){let t=g.getOwnedInstances();return Lt!=="all"&&(t=t.filter(e=>e.type===Lt)),t.sort((e,i)=>ct==="rarity"?Ee.indexOf(i.rarity||"rare")-Ee.indexOf(e.rarity||"rare"):ct==="level"?i.level-e.level:ct==="atk"?i.stats.atk+i.stats.magAtk-(e.stats.atk+e.stats.magAtk):0),`
      ...
      <div style="flex:0 0 320px;border-right:1px solid var(--border-metal);overflow-y:auto;padding:var(--space-md);">
        ...
        <div style="display:flex;gap:6px;margin-bottom:var(--space-md);flex-wrap:wrap">
          ${["all","guerrier","mage","arche","assassin"].map(e=>`
            <button class="btn btn--sm ${e===Lt?"btn--primary":"btn--ghost"}" data-cfilter="${e}" style="flex:1;min-width:60px;padding:6px 4px;font-size:9px">${e==="all"?"TOUS":e.toUpperCase()}</button>
          `).join("")}
        </div>
        <div style="display:flex;gap:6px;margin-bottom:var(--space-md)">
          ${["rarity","level","atk"].map(e=>`
            <button class="btn btn--sm ${e===ct?"btn--primary":"btn--ghost"}" data-csort="${e}" style="flex:1;font-size:9px">${e==="atk"?"ATK":e.toUpperCase()}</button>
          `).join("")}
        </div>
        <!-- Char list -->
        <div style="display:flex;flex-direction:column;gap:8px">
          ${t.map(e=>{const i=e.id===ut,r=ce[e.rarity]||{color:"#aaa"};return`
  ...
  `}function ae(){return`<div style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;color:var(--text-muted);gap:var(--space-md)">
  ...
  </div>`}function Ne(a){const t=g.state.ownedCharacters.find(l=>l.id===a);if(!t)return ae();const e=vt(a,t.level);if(!e)return ae();const i=g.getCharacterBonusStats(a),r=bt[e.type]||"var(--accent)",n=ce[e.rarity]||{color:"#aaa"},o=e.skills.map(l=>{let c=0,p="",m="var(--text-secondary)";return l.type==="physical"?(c=Math.round(l.power/100*e.stats.atk),p=c+" DPS",m="#E85D20"):l.type==="magical"?(c=Math.round(l.power/100*e.stats.magAtk),p=c+" MAG",m="#c084fc"):l.type==="heal"?(c=Math.round(l.power/100*e.stats.magAtk),p=c+" SOIN",m="#4A7C59"):(p="Soutien",m="var(--text-muted)"),{...l,dps:c,dpsLabel:p,dpsColor:m}}),d=qe(e,a,3),s=g.getCharacterEquipped(a);return`
    <!-- Header -->
    ...
    <div class="glass" style="padding:var(--space-lg);border-radius:var(--radius-xl);margin-bottom:var(--space-lg)">
      ...
      <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:var(--space-md)">
        ${Object.entries(_t).map(([l,c])=>{const p=e.stats[l]||0,m=i[l]||0,f=p+m;return`
    ...
    <div class="glass" style="padding:var(--space-lg);border-radius:var(--radius-xl);margin-bottom:var(--space-lg)">
      ...
      <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:var(--space-md)">
        ${Object.entries(at).map(([l,c])=>{const p=s[l],m=p?g.state.inventory.find(x=>x.instanceId===p):null,f=m?j[m.itemId]:null,u=f?Y[f.rarity]?.color||"#aaa":"var(--text-muted)";return`
            <div style="text-align:center;padding:var(--space-md);background:rgba(0,0,0,0.3);border-radius:var(--radius-md);border:1px solid ${f?u+"40":"var(--border)"}">
              <div style="font-size:24px;margin-bottom:var(--space-xs)">${f?jt(f.id):"&#9711;"}</div>
              <div style="font-size:9px;color:${f?u:"var(--text-muted)"};letter-spacing:1px">${f?f.name:c.name.toUpperCase()}</div>
              ${f?`<div style="font-size:8px;color:var(--text-muted);margin-top:4px">${Object.entries(f.stats||{}).map(([x,k])=>"+"+k+" "+x.toUpperCase()).join(" ")}</div>`:""}
            </div>
          `}).join("")}
      </div>
    </div>
    ...
    <div class="glass" style="padding:var(--space-lg);border-radius:var(--radius-xl);border-color:rgba(200,155,60,0.2)">
      ...
      <div style="display:flex;flex-direction:column;gap:var(--space-sm)">
        ${d.map((l,c)=>{const p=Y[l.item.rarity]?.color||"#aaa";return`
            <div style="display:flex;align-items:center;gap:var(--space-md);padding:12px;background:rgba(0,0,0,0.3);border-radius:var(--radius-md);border:1px solid ${p}30">
              ...
              <div style="font-size:22px">${jt(l.item.id)}</div>
              <div style="flex:1">
                ...
                <div style="font-size:10px;color:var(--text-secondary);margin-top:2px">${Object.entries(l.item.stats||{}).map(([m,f])=>"+"+f+" "+m.toUpperCase()).join(", ")}</div>
              </div>
              <div style="text-align:right">
    ...
    `:""}
  `}function Ma(){document.querySelectorAll("[data-cfilter]").forEach(a=>{a.addEventListener("click",()=>{Lt=a.dataset.cfilter,it()})}),document.querySelectorAll("[data-csort]").forEach(a=>{a.addEventListener("click",()=>{ct=a.dataset.csort,it()})}),document.querySelectorAll("[data-charid]").forEach(a=>{a.addEventListener("click",()=>{ut=a.dataset.charid;const t=document.getElementById("char-detail-panel");t&&(t.innerHTML=Ne(ut))})})}function Ba(){let t=g.getInventoryItems();Mt!=="all"&&(t=t.filter(r=>r.slot===Mt)),Bt!=="all"&&(t=t.filter(r=>r.rarity===Bt));const i=g.getTeamInstances().map(r=>{const n=qe(r,r.id,2);return{char:r,recs:n}}).filter(r=>r.recs.length>0);return`
    <div style="padding:var(--space-xl);max-width:1100px;margin:0 auto">

      <!-- Filtres -->
      <div style="display:flex;gap:var(--space-sm);margin-bottom:var(--space-md);flex-wrap:wrap">
        ${["all","weapon","armor","accessory","amulet"].map(r=>`
          <button class="btn btn--sm ${r===Mt?"btn--primary":"btn--ghost"}" data-ifilter="${r}">${r==="all"?"TOUS":at[r]?.name.toUpperCase()||r.toUpperCase()}</button>
        `).join("")}
        <div style="width:1px;background:var(--border-metal);margin:0 4px"></div>
        ${["all","commun","peu_commun","rare","epique","legendaire"].map(r=>`
          <button class="btn btn--sm ${r===Bt?"btn--primary":"btn--ghost"}" data-irarity="${r}">${r==="all"?"ALL":r.toUpperCase()}</button>
        `).join("")}
      </div>
      ...
      <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(140px,1fr));gap:var(--space-md);margin-bottom:var(--space-xxl)">
        ${t.map(r=>{const n=Y[r.rarity]?.color||"#aaa",o=Object.values(g.state.equipped).some(d=>Object.values(d).includes(r.instanceId));return`
            <div class="glass" style="padding:var(--space-md);border-radius:var(--radius-lg);text-align:center;cursor:default;border-color:${n}30;position:relative;transition:transform 0.2s" title="${r.desc||""}">
              ...
              <div style="font-size:28px;margin-bottom:8px">${jt(r.id)}</div>
              ...
              <div style="font-size:9px;color:var(--text-secondary)">${Object.entries(r.stats||{}).map(([d,s])=>"+"+s+" "+d.toUpperCase()).join("<br>")}</div>
            </div>
          `}).join("")}
      </div>
      ...
      <div class="glass" style="padding:var(--space-xl);border-radius:var(--radius-xl);border-color:rgba(200,155,60,0.2)">
        ...
        <div style="display:flex;flex-direction:column;gap:var(--space-lg)">
          ${i.map(({char:r,recs:n})=>`
            <div>
              <div style="font-size:12px;font-weight:700;color:${bt[r.type]};letter-spacing:1px;margin-bottom:8px">${r.name.toUpperCase()}</div>
              <div style="display:flex;gap:var(--space-md);flex-wrap:wrap">
                ${n.map(o=>{const d=Y[o.item.rarity]?.color||"#aaa";return`
                    <div style="display:flex;align-items:center;gap:10px;padding:10px 14px;background:rgba(0,0,0,0.3);border-radius:var(--radius-md);border:1px solid ${d}30">
                      <span style="font-size:20px">${jt(o.item.id)}</span>
                      <div>
  ...
  `}function Ra(){document.querySelectorAll("[data-ifilter]").forEach(a=>{a.addEventListener("click",()=>{Mt=a.dataset.ifilter,it()})}),document.querySelectorAll("[data-irarity]").forEach(a=>{a.addEventListener("click",()=>{Bt=a.dataset.irarity,it()})})}function Pa(){return`
  ...
  `}function qe(a,t,e=3){const i=wa[a.type]||{},r=g.getCharacterEquipped(t),n=new Set(Object.values(r).filter(Boolean));return g.state.inventory.filter(o=>!n.has(o.instanceId)).map(o=>{const d=j[o.itemId];if(!d||!d.stats)return null;let s=0;for(const[l,c]of Object.entries(d.stats))s+=c*(i[l]||0);return{item:{...d,instanceId:o.instanceId},score:s}}).filter(Boolean).sort((o,d)=>d.score-o.score).slice(0,e)}function Da(a){return{guerrier:"&#9876;",mage:"&#9670;",arche:"&#8982;",assassin:"&#8693;"}[a]||"?"}function jt(a){return{epee_rouille:"&#9876;",lame_forestiere:"&#9876;",baton_mage:"&#9670;",arc_elfique:"&#8982;",dague_ombre:"&#8693;",sceptre_samael:"&#9760;",gambison_use:"&#9711;",cuirasse_ecailles:"&#9680;",robe_arcane:"&#9670;",armure_maragorh:"&#9680;",egide_samael:"&#9680;",amulette_vitalite:"&#9711;",ceinture_force:"&#9711;",anneau_rapidite:"&#9711;",orbe_enchantement:"&#9670;",pendentif_chance:"&#9670;",collier_precision:"&#9671;",talisman_nature:"&#9671;",phylactere_samael:"&#9760;"}[a]||"&#9671;"}function Oa(a){if(!a.startsWith("#"))return"192,57,11";const t=parseInt(a.slice(1,3),16),e=parseInt(a.slice(3,5),16),i=parseInt(a.slice(5,7),16);return`${t},${e},${i}`}const Ft=["hp","atk","def","spd","magAtk","magDef"],ge=a=>a*2*Math.PI/6-Math.PI/2;function ze(a,t){const r={hp:800,atk:200,def:200,spd:150,magAtk:220,magDef:200},n={};for(const o of Ft)n[o]=Math.max(r[o],(a[o]||0)*1.2);return Ft.map((o,d)=>{const c=Math.min(a[o]||0,n[o])/(n[o]||1)*t,p=ge(d),m=100+c*Math.cos(p),f=100+c*Math.sin(p);return`${m.toFixed(1)},${f.toFixed(1)}`}).join(" ")}function _a(a){return Ft.map((i,r)=>{const n=ge(r);return[100+a*Math.cos(n),100+a*Math.sin(n)]})}function ja(a,t){return Ft.map((r,n)=>{const o=ge(n),d=t+18,s=100+d*Math.cos(o),l=100+d*Math.sin(o);return`<text x="${s.toFixed(1)}" y="${l.toFixed(1)}" text-anchor="middle" dominant-baseline="middle" fill="rgba(255,107,157,0.7)" font-size="11" font-family="DM Sans">${_t[r]}</text>`}).join("")}function Fa(){const a=document.getElementById("app"),t=g.state,e=g.ACHIEVEMENTS,i=t.achievements||{},r=Object.keys(i).length,n=e.length,o=Math.round(r/n*100);g.checkAchievements(),a.innerHTML=`
    <div style="width:100vw;height:100vh;background:#0c0a12;display:flex;flex-direction:column;overflow:hidden;position:relative">
      ...
      <div style="background:rgba(10,8,18,0.95);border-bottom:1px solid rgba(192,132,252,0.06);
        ...
        <div style="max-width:700px;margin:0 auto">
          <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:10px">
            ...
            <div style="font-family:var(--font-stat);font-size:14px;font-weight:700;color:var(--text-bright)">${o}%</div>
          </div>
          <div style="height:8px;background:rgba(0,0,0,0.6);border-radius:4px;overflow:hidden;border:1px solid rgba(192,132,252,0.1)">
            <div style="height:100%;width:${o}%;border-radius:4px;
      ...
      <div style="flex:1;overflow-y:auto;padding:24px 32px;scrollbar-width:thin;scrollbar-color:rgba(192,132,252,0.15) transparent">
        <div style="max-width:900px;margin:0 auto;display:grid;grid-template-columns:repeat(auto-fill,minmax(260px,1fr));gap:16px">
          ${e.map(d=>{const s=!!i[d.id],l=i[d.id]?.unlockedAt,c=l?new Date(l).toLocaleDateString("fr-FR"):null;return`
              <div style="
                position:relative;overflow:hidden;
                ...
                <div style="display:flex;align-items:flex-start;gap:14px">
                  ...
                  <div style="flex:1;min-width:0">
                    ...
                    <div style="font-size:11px;color:${s?"var(--text-secondary)":"var(--text-muted)"};line-height:1.5">
                      ${s?d.desc:"Condition non remplie"}
                    </div>
                    ${d.reward>0?`
  ...
  `,document.getElementById("back-btn").addEventListener("click",()=>$.navigate("home"))}const Yt={gardien_enchante:{line:`"Vous osez fouler ces terres sacrées ?
...
...Vous osez ? Vous OSEZ défier la divinité ?"`,mood:"evil"}},Ie=['"Préparez-vous à votre fin !"','"Vous ne passerez pas !"','"Ces terres vous sont interdites !"','"Vous êtes trop faibles pour avancer !"'],Te={warn:{border:"rgba(252,211,77,0.5)",glow:"rgba(252,211,77,0.15)",text:"#fcd34d"},evil:{border:"rgba(239,68,68,0.5)",glow:"rgba(239,68,68,0.15)",text:"#fb7185"},beast:{border:"rgba(134,239,172,0.4)",glow:"rgba(134,239,172,0.1)",text:"#86efac"}};function Ua(a={}){const{zone:t,level:e}=a,i=parseInt(e||0),r=N.find(b=>b.id===t);if(!r){$.navigate("campaign");return}const n=i===(r.levels||20)-1,o=g.getTeamInstances(),d=document.getElementById("app");let s="",l="warn";n&&Yt[r.boss.id]?(s=Yt[r.boss.id].line,l=Yt[r.boss.id].mood):n||(s=Ie[Math.floor(Math.random()*Ie.length)],l="warn");const c=Te[l]||Te.warn,p=n?r.boss.name:r.enemyTypes[Math.floor(Math.random()*r.enemyTypes.length)].replace(/_/g," ").replace(/\b\w/g,b=>b.toUpperCase()),m=n?r.boss.icon:r.icon,f=n?re(!1):ne(),u=n?`BOSS — ${r.name}`:`Niveau ${i+1} — ${r.name}`;d.innerHTML=`
  ...
  `;const x=()=>{const b=document.getElementById("vs-screen");b?(b.style.transition="opacity 0.3s ease",b.style.opacity="0",setTimeout(()=>$.navigate("combat",{zone:t,level:i}),300)):$.navigate("combat",{zone:t,level:i})};document.getElementById("vs-fight-btn")?.addEventListener("click",x),document.getElementById("vs-back-btn")?.addEventListener("click",()=>$.navigate("campaign")),document.getElementById("vs-skip")?.addEventListener("click",x);const k=b=>{(b.code==="Space"||b.code==="Enter")&&(window.removeEventListener("keydown",k),x()),b.code==="Escape"&&(window.removeEventListener("keydown",k),$.navigate("campaign"))};window.addEventListener("keydown",k)}const ot=[{id:0,icon:"⚔️",title:"Bienvenue dans Rytiger",subtitle:"Le RPG gacha des abysses",content:`
    ...
    `,bg:"linear-gradient(135deg, rgba(220,38,38,0.08), rgba(10,6,16,0.99))",accent:"#EF4444"}];let O=0;function Ge(a=null){const t=document.getElementById("app");O=0,Rt(t,a)}function Rt(a,t){const e=ot[O],i=O===ot.length-1,r=(O+1)/ot.length*100;a.innerHTML=`
    <div style="
    ...
    ">
      ...
      ">
        ...
        <div style="display:flex;gap:8px;">
          ${ot.map((n,o)=>`
            <div style="
              width:${o===O?24:8}px;height:8px;border-radius:4px;
              background:${o===O?e.accent:"rgba(255,255,255,0.15)"};
  ...
  `,document.getElementById("tuto-next").addEventListener("click",()=>{i?(g.completeTutorial(),t?t():$.navigate("home")):(O++,Rt(a,t))}),document.getElementById("tuto-prev")?.addEventListener("click",()=>{O--,Rt(a,t)}),document.getElementById("tuto-skip")?.addEventListener("click",()=>{g.completeTutorial(),t?t():$.navigate("home")}),document.querySelectorAll("[data-dot]").forEach(n=>{n.addEventListener("click",()=>{O=parseInt(n.dataset.dot),Rt(a,t)})})}function Ha(){const a=document.getElementById("app"),t=g.state.combatHistory||[],e=t.reduce((o,d)=>o+(d.totalDamage||0),0),i=t.length>0?Math.round(t.reduce((o,d)=>o+(d.timeSeconds||0),0)/t.length):0,r=t.filter(o=>o.won).length,n=t.filter(o=>o.isBerserk).length;a.innerHTML=`
    <div style="width:100vw;height:100vh;background:#06050a;display:flex;flex-direction:column;overflow:hidden;position:relative">
      ...
      <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:0;flex-shrink:0;
        ...
        ${[{label:"VICTOIRES",val:r,color:"var(--accent)"},{label:"DMG TOTAL",val:e.toLocaleString(),color:"#E85D20"},{label:"TEMPS MOY.",val:`${Math.floor(i/60)}:${String(i%60).padStart(2,"0")}`,color:"var(--text-secondary)"},{label:"BERSERK",val:n,color:"#FBBF24"}].map((o,d)=>`
          <div style="padding:14px 24px;text-align:center;${d<3?"border-right:1px solid rgba(192,132,252,0.06)":""}">
            <div style="font-family:var(--font-stat);font-size:20px;font-weight:700;color:${o.color}">${o.val}</div>
            <div style="font-family:var(--font-ui);font-size:9px;color:var(--text-muted);letter-spacing:2px;margin-top:3px">${o.label}</div>
          </div>
        `).join("")}
      </div>
      `:""}
      ...
      <div style="flex:1;overflow-y:auto;padding:24px 32px;scrollbar-width:thin;scrollbar-color:rgba(192,132,252,0.15) transparent">
        <div style="max-width:800px;margin:0 auto;display:flex;flex-direction:column;gap:10px">
          ...
          `:t.map((o,d)=>{const s=new Date(o.date),l=s.toLocaleDateString("fr-FR",{day:"2-digit",month:"short"})+" à "+s.toLocaleTimeString("fr-FR",{hour:"2-digit",minute:"2-digit"}),c=o.timeSeconds?`${Math.floor(o.timeSeconds/60)}:${String(o.timeSeconds%60).padStart(2,"0")}`:"—",p=o.type==="dungeon"?`🏛️ Donjon — Étage ${o.floor||"?"}`:(()=>{const b=N.find(z=>z.id===o.zone);return b?`${b.icon} ${b.name}`:o.zone||"Zone inconnue"})(),m=o.flames>0?Array.from({length:3},(b,z)=>`<span style="opacity:${z<o.flames?1:.15}">🍃</span>`).join(""):"",f=o.won?"#4ADE80":"#EF4444",u=o.won?"✓ VICTOIRE":"✗ DÉFAITE",x=o.isBerserk?'<span style="font-size:8px;background:rgba(251,191,36,0.15);color:#FBBF24;border:1px solid rgba(251,191,36,0.3);padding:2px 6px;border-radius:3px;letter-spacing:1px">🔥 BERSERK</span>':"",k=o.type==="dungeon"?'<span style="font-size:8px;background:rgba(220,38,38,0.12);color:#EF4444;border:1px solid rgba(220,38,38,0.2);padding:2px 6px;border-radius:3px;letter-spacing:1px">⚰️ DONJON</span>':"";return`
              <div style="
                ...
                animation:slideIn 0.3s ease ${d*.03}s both;
              " class="history-row">

                <!-- Index + status -->
                <div style="text-align:center;width:40px">
                  <div style="font-family:var(--font-stat);font-size:18px;font-weight:700;color:${f};
                    filter:drop-shadow(0 0 6px ${f}40)">${o.won?"🏆":"💀"}</div>
                  <div style="font-size:8px;color:var(--text-muted);margin-top:2px">#${t.length-d}</div>
                </div>
                ...
                <div>
                  ...
                  <div style="display:flex;flex-wrap:wrap;gap:6px;align-items:center">
                    ...
                    ${x}
                    ${k}
                    <span style="font-size:9px;color:var(--text-muted)">${l}</span>
                  </div>
                ...
                <!-- Damage -->
                <div style="text-align:right">
                  <div style="font-family:var(--font-stat);font-size:16px;font-weight:700;color:#E85D20">${(o.totalDamage||0).toLocaleString()}</div>
                  <div style="font-size:9px;color:var(--text-muted);letter-spacing:1px">dégâts</div>
                </div>

                <!-- Time -->
                <div style="text-align:right;min-width:50px">
                  <div style="font-family:var(--font-stat);font-size:16px;font-weight:700;color:var(--text-secondary)">⏱ ${c}</div>
        ...
        <div style="max-width:800px;margin:24px auto 0;
          ...
          <div style="display:flex;align-items:flex-end;gap:6px;height:80px">
            ${[...t].reverse().slice(-10).map(o=>{const d=Math.max(...t.map(c=>c.totalDamage||0))||1,s=Math.max(5,Math.round((o.totalDamage||0)/d*100)),l=o.won?"#4ADE80":"#EF4444";return`
                <div style="flex:1;display:flex;flex-direction:column;align-items:center;gap:4px">
                  <div style="width:100%;background:${l}${o.won?"60":"40"};border-radius:3px 3px 0 0;height:${s}%;
                    box-shadow:0 0 8px ${l}20;transition:height 0.5s ease;min-height:4px"></div>
                </div>
              `}).join("")}
          </div>
    ...
    ">
      ...
      <div id="rune-circle" style="position:absolute;width:500px;height:500px;opacity:0;transition:opacity 1.5s ease">
        <svg viewBox="0 0 500 500" style="width:100%;height:100%">
          ...
          ${Array.from({length:16},(o,d)=>{const s=d/16*Math.PI*2-Math.PI/2,l=250+205*Math.cos(s),c=250+205*Math.sin(s),p=["☥","⛨","☦","⚳","♁","⛩","⯯","⛠","⬣","☥","⛨","⚳","☦","♁","⛩","⛠"];return`<text x="${l.toFixed(1)}" y="${c.toFixed(1)}" text-anchor="middle" dominant-baseline="middle"
  ...
  `;const e=[{t:300,fn:()=>{A("load-bg-glow").style.opacity="1"}},{t:1500,fn:()=>{A("rune-circle").style.opacity="1"}},{t:2500,fn:()=>{for(let o=0;o<16;o++){const d=A(`rune-${o}`);d&&(d.style.fill="rgba(255,107,157,0.6)")}}},{t:3500,fn:()=>{const o=A("forge-symbol");o.style.fontSize="72px",o.style.opacity="1",o.style.filter="drop-shadow(0 0 30px rgba(200,150,60,0.8))"}},{t:4e3,fn:()=>Ga(80)},{t:4500,fn:()=>{const o=A("epic-loading");o.style.animation="screenShake 0.4s cubic-bezier(0.36,0.07,0.19,0.97)",setTimeout(()=>o.style.animation="",400)}},{t:4700,fn:()=>{const o=A("golden-flash");o.style.opacity="0.6",setTimeout(()=>o.style.opacity="0",200)}},{t:5e3,fn:()=>{A("load-bg-gold").style.opacity="1"}},{t:5500,fn:()=>{const o=A("title-container");o.style.fontSize="52px",["R","Y","T","I","G","E","R"].forEach((d,s)=>{setTimeout(()=>{const l=A(`letter-${s}`);l&&(l.style.opacity="1",l.style.transform="translateY(0) scale(1)",l.style.filter="drop-shadow(0 0 20px rgba(200,150,60,0.6))",Va(l))},s*120)})}},{t:7500,fn:()=>{A("load-subtitle").style.color="rgba(200,150,60,0.5)"}},{t:8e3,fn:()=>{A("load-bar-wrap").style.opacity="1",A("load-text").style.color="rgba(200,150,60,0.55)",[{t:0,w:"15%"},{t:600,w:"35%"},{t:1200,w:"55%"},{t:2e3,w:"70%"},{t:2800,w:"85%"},{t:3500,w:"95%"},{t:4200,w:"100%"}].forEach(d=>{setTimeout(()=>{const s=A("load-bar-fill");s&&(s.style.width=d.w)},d.t)})}},{t:9e3,fn:()=>{Xa(40,3e3)}},{t:12500,fn:()=>{const o=A("golden-flash");o.style.opacity="0.4",setTimeout(()=>o.style.opacity="0",300)}},{t:13500,fn:()=>n()}],i=[];e.forEach(o=>{i.push(setTimeout(()=>{t||o.fn()},o.t))});function r(){t||(t=!0,i.forEach(clearTimeout),n())}A("epic-loading")?.addEventListener("click",r),window.addEventListener("keydown",function o(d){(d.code==="Space"||d.key==="Escape")&&(r(),window.removeEventListener("keydown",o))}),ri(ni());function n(){const o=A("epic-loading");o&&(o.style.transition="opacity 0.8s ease",o.style.opacity="0",setTimeout(()=>{o.remove(),$.start();const d=window.location.hash;(d===""||d==="#")&&(g.state.initialized&&!g.state.tutorialDone?Ge(()=>$.navigate("home")):$.navigate("home")),yt.start(),Ya()},800))}}function A(a){return document.getElementById(a)}function Ga(a){const t=A("load-particles");if(t)for(let e=0;e<a;e++)setTimeout(()=>{const i=document.createElement("div"),r=Math.random()*Math.PI*2,n=100+Math.random()*400,o=1+Math.random()*3,d=1+Math.random()*1.5,s=["#ff6b9d","#ff8db6","#c084fc","#fcd34d","#fda4af"],l=s[Math.floor(Math.random()*s.length)];i.style.cssText=`
        ...
        --dx:${Math.cos(r)*n}px;
        --dy:${Math.sin(r)*n}px;
      `,t.appendChild(i),setTimeout(()=>i.remove(),d*1e3+100)},e*15)}function Va(a){const t=A("load-particles");if(!t||!a)return;const e=a.getBoundingClientRect();for(let i=0;i<6;i++){const r=document.createElement("div"),n=1+Math.random()*2;r.style.cssText=`
      position:absolute;
      ...
      pointer-events:none;
    `,t.appendChild(r),setTimeout(()=>r.remove(),900)}}function Xa(a,t){const e=A("load-particles");if(!e)return;const i=t/a;for(let r=0;r<a;r++)setTimeout(()=>{const n=document.createElement("div"),o=Math.random()*100,d=1+Math.random()*2.5,s=3+Math.random()*4,l=(Math.random()-.5)*80,c=["rgba(255,107,157,0.8)","rgba(192,132,252,0.7)","rgba(252,211,77,0.5)"],p=c[Math.floor(Math.random()*c.length)];n.style.cssText=`
        ...
        --sway:${l}px;
      `,e.appendChild(n),setTimeout(()=>n.remove(),s*1e3+100)},r*i)}window.addEventListener("keydown",a=>{if(a.key==="Escape"&&window.location.hash!=="#home"&&window.location.hash!==""&&$.navigate("home"),a.key==="m"||a.key==="M"){const t=yt.toggleMute();Ve(t)}});function Ya(){if(document.getElementById("music-controls"))return;const a=document.createElement("div");a.id="music-controls",a.innerHTML=Xe(yt.muted),a.title="Musique (M pour mute)",a.style.cssText=`
  ...
  `,a.addEventListener("mouseenter",()=>{a.style.borderColor="rgba(200, 155, 60, 0.6)",a.style.boxShadow="0 2px 20px rgba(192,57,11,0.3), inset 0 1px 0 rgba(200,155,60,0.2)",a.style.transform="scale(1.1)"}),a.addEventListener("mouseleave",()=>{a.style.borderColor="rgba(200, 155, 60, 0.3)",a.style.boxShadow="0 2px 12px rgba(0,0,0,0.5), inset 0 1px 0 rgba(200,155,60,0.1)",a.style.transform="scale(1)"}),a.addEventListener("click",()=>{const t=yt.toggleMute();Ve(t)}),document.body.appendChild(a)}function Ve(a){const t=document.getElementById("music-controls");t&&(t.innerHTML=Xe(a))}function Xe(a){return a?`<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#C89B3C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
